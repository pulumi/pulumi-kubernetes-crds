...
func NewKogitoBuild(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:app.kiegroup.org/v1alpha1:KogitoBuild", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKogitoBuild(ctx *pulumi.Context,
	...
	var resource KogitoBuild
	err := ctx.ReadResource("kubernetes:app.kiegroup.org/v1alpha1:KogitoBuild", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
