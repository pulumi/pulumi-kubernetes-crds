...
export class KogitoBuildDefinition extends k8s.apiextensions.v1beta1.CustomResourceDefinition {
							...
							"status": {
								...
								"properties": {
									...
									"conditions": {
										...
										"items": {
											"description": "KogitoBuildConditions describes the conditions for this build instance according to Kubernetes status interface.",
											"properties": {
												"lastTransitionTime": {
