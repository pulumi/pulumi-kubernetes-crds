...
export class ApplicationConfigurationDefinition extends k8s.apiextensions.v1beta1.CustomResourceDefinition {
								...
								"properties": {
									"components": {
										...
										"items": {
											...
											"properties": {
												"componentName": {
													"description": "ComponentName specifies a component of which an ApplicationConfiguration should consist. The named component must exist.",
													"type": "string"
												},
												"parameterValues": {
										...
										"items": {
											...
											"properties": {
												...
												"traits": {
													...
													"items": {
														"description": "A WorkloadTrait represents a trait associated with a workload.",
														"properties": {
															"traitRef": {
