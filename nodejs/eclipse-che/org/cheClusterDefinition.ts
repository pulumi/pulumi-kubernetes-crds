...
export class CheClusterDefinition extends k8s.apiextensions.v1beta1.CustomResourceDefinition {
						...
						"properties": {
							...
							"status": {
								...
								"properties": {
									...
									"dbProvisioned": {
										"description": "Indicates if or not a Postgres instance has been correctly provisioned",
										"type": "boolean"
									},
									"devfileRegistryURL": {
									...
									"helpLink": {
										"description": "A URL that can point to some URL where to find help related to the current Operator status.",
										"type": "string"
									},
									"keycloakProvisioned": {
										"description": "Indicates whether an Identity Provider instance (Keycloak / RH SSO) has been provisioned with realm, client and user",
										"type": "boolean"
									},
									"keycloakURL": {
										"description": "Public URL to the Identity Provider server (Keycloak / RH SSO).",
										"type": "string"
									},
									"message": {
									...
									"openShiftoAuthProvisioned": {
										"description": "Indicates whether an Identity Provider instance (Keycloak / RH SSO) has been configured to integrate with the OpenShift OAuth.",
										"type": "boolean"
									},
									"pluginRegistryURL": {
