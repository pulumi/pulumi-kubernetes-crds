...
export class CSIIsilonDefinition extends k8s.apiextensions.v1beta1.CustomResourceDefinition {
				...
				"validation": {
					"openAPIV3Schema": {
						...
						"properties": {
							...
							"spec": {
								"description": "CSIIsilonSpec defines the desired state of CSIIsilon",
								"properties": {
									"driver": {
										"description": "Driver is the specification for the CSI Isilon Driver",
										"properties": {
											"authSecret": {
											...
											"forceUpdate": {
												"description": "ForceUpdate is the boolean flag used to force an update of the driver instance",
												"type": "boolean"
											},
											"node": {
												...
												"items": {
													...
													"properties": {
														"allowVolumeExpansion": {
															"description": "AllowVolumeExpansion is a boolean flag which indicates if volumes can be expanded",
															"type": "boolean"
														},
														"default": {
															"description": "DefaultSc is a boolean flag to indicate if the storage class is going to be marked as default",
															"type": "boolean"
														},
														"name": {
														...
														"parameters": {
															...
															"description": "Parameters is a map of driver specific storage class",
															"type": "object"
														},
														"reclaimPolicy": {
															"description": "ReclaimPolicy is the reclaim policy for the storage class",
															"type": "string"
														}
													},
													"required": [
