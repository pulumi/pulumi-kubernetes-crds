...
class CSIScaleOperatorSpecArgs:
    def __init__(__self__, *,
                 ...
                 attacher_node_selector: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecAttacherNodeSelectorArgs']]]] = None,
                 clusters: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecClustersArgs']]]] = None,
                 driver_registrar: Optional[pulumi.Input[str]] = None,
                 node_mapping: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecNodeMappingArgs']]]] = None,
                 plugin_node_selector: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecPluginNodeSelectorArgs']]]] = None,
                 provisioner: Optional[pulumi.Input[str]] = None,
                 provisioner_node_selector: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecProvisionerNodeSelectorArgs']]]] = None,
                 secret_counter: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecAttacherNodeSelectorArgs']]] attacher_node_selector: Node selector for attacher sidecar.
        :param pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecClustersArgs']]] clusters: A collection of gpfs cluster properties for the csi driver to mount.
        :param pulumi.Input[str] driver_registrar: Sidecar container image for the csi spectrum scale plugin pods.
        :param pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecNodeMappingArgs']]] node_mapping: Mapping of K8s node with SpectrumScale node.
        :param pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecPluginNodeSelectorArgs']]] plugin_node_selector: Node selector for SpectrumScale CSI Plugin.
        :param pulumi.Input[str] provisioner: Provisioner image for csi (actually issues provision requests).
        :param pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecProvisionerNodeSelectorArgs']]] provisioner_node_selector: Node selector for provisioner sidecar.
        :param pulumi.Input[float] secret_counter: An internal counter used by the operator to trigger reloads on secret change.
    ...
    def attacher_node_selector(self) -> Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecAttacherNodeSelectorArgs']]]]:
        """
    ...
    def attacher_node_selector(self, value: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecAttacherNodeSelectorArgs']]]]):
        pulumi.set(self, "attacher_node_selector", value)

    @property
    @pulumi.getter
    def clusters(self) -> Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecClustersArgs']]]]:
        """
    ...
    @clusters.setter
    def clusters(self, value: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecClustersArgs']]]]):
    ...
    def node_mapping(self) -> Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecNodeMappingArgs']]]]:
        """
    ...
    @node_mapping.setter
    def node_mapping(self, value: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecNodeMappingArgs']]]]):
        pulumi.set(self, "node_mapping", value)

    @property
    @pulumi.getter(name="pluginNodeSelector")
    def plugin_node_selector(self) -> Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecPluginNodeSelectorArgs']]]]:
        """
    ...
    def plugin_node_selector(self, value: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecPluginNodeSelectorArgs']]]]):
    ...
    def provisioner_node_selector(self) -> Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecProvisionerNodeSelectorArgs']]]]:
        """
    ...
    def provisioner_node_selector(self, value: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecProvisionerNodeSelectorArgs']]]]):
        pulumi.set(self, "provisioner_node_selector", value)

    @property
    @pulumi.getter(name="secretCounter")
    def secret_counter(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def secret_counter(self, value: Optional[pulumi.Input[float]]):
...
class CSIScaleOperatorSpecClustersArgs:
    def __init__(__self__, *,
                 ...
                 rest_api: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecClustersRestApiArgs']]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecClustersRestApiArgs']]] rest_api: A collection of targets for REST calls.
    ...
    def rest_api(self) -> Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecClustersRestApiArgs']]]]:
        """
    ...
    @rest_api.setter
    def rest_api(self, value: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorSpecClustersRestApiArgs']]]]):
...
class CSIScaleOperatorSpecClustersRestApiArgs:
    def __init__(__self__, *,
                 ...
                 gui_port: Optional[pulumi.Input[float]] = None):
        """
        :param pulumi.Input[str] gui_host: The hostname of the REST server.
        :param pulumi.Input[float] gui_port: The port number running the REST server.
        """
    ...
    def gui_port(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    @gui_port.setter
    def gui_port(self, value: Optional[pulumi.Input[float]]):
...
class CSIScaleOperatorStatusArgs:
    def __init__(__self__, *,
                 conditions: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorStatusConditionsArgs']]]] = None):
        """
        :param pulumi.Input[List[pulumi.Input['CSIScaleOperatorStatusConditionsArgs']]] conditions: The active status of the operator
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorStatusConditionsArgs']]]]:
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[List[pulumi.Input['CSIScaleOperatorStatusConditionsArgs']]]]):
