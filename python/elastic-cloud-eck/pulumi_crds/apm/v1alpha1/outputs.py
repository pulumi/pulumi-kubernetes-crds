...
class ApmServerSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 elasticsearch_ref: Optional['outputs.ApmServerSpecElasticsearchRef'] = None,
                 http: Optional['outputs.ApmServerSpecHttp'] = None,
                 image: Optional[str] = None,
                 kibana_ref: Optional['outputs.ApmServerSpecKibanaRef'] = None,
                 pod_template: Optional[Mapping[str, Any]] = None,
                 secure_settings: Optional[List['outputs.ApmServerSpecSecureSettings']] = None,
                 service_account_name: Optional[str] = None):
        """
        ApmServerSpec holds the specification of an APM Server.
        :param str version: Version of the APM Server.
        :param Mapping[str, Any] config: Config holds the APM Server configuration. See: https://www.elastic.co/guide/en/apm/server/current/configuring-howto-apm-server.html
        :param float count: Count of APM Server instances to deploy.
        :param 'ApmServerSpecElasticsearchRefArgs' elasticsearch_ref: ElasticsearchRef is a reference to the output Elasticsearch cluster running in the same Kubernetes cluster.
        :param 'ApmServerSpecHttpArgs' http: HTTP holds the HTTP layer configuration for the APM Server resource.
        :param str image: Image is the APM Server Docker image to deploy.
        :param 'ApmServerSpecKibanaRefArgs' kibana_ref: KibanaRef is a reference to a Kibana instance running in the same Kubernetes cluster. It allows APM agent central configuration management in Kibana.
        :param Mapping[str, Any] pod_template: PodTemplate provides customisation options (labels, annotations, affinity rules, resource requests, and so on) for the APM Server pods.
        :param List['ApmServerSpecSecureSettingsArgs'] secure_settings: SecureSettings is a list of references to Kubernetes secrets containing sensitive configuration options for APM Server.
    ...
    def elasticsearch_ref(self) -> Optional['outputs.ApmServerSpecElasticsearchRef']:
        """
    ...
    @property
    @pulumi.getter
    def http(self) -> Optional['outputs.ApmServerSpecHttp']:
        """
    ...
    def kibana_ref(self) -> Optional['outputs.ApmServerSpecKibanaRef']:
        """
    ...
    def secure_settings(self) -> Optional[List['outputs.ApmServerSpecSecureSettings']]:
        """
...
@pulumi.output_type
class ApmServerSpecElasticsearchRef(dict):
    """
    ElasticsearchRef is a reference to the output Elasticsearch cluster running in the same Kubernetes cluster.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class ApmServerSpecHttp(dict):
    """
    HTTP holds the HTTP layer configuration for the APM Server resource.
    """
    def __init__(__self__, *,
                 service: Optional['outputs.ApmServerSpecHttpService'] = None,
                 tls: Optional['outputs.ApmServerSpecHttpTls'] = None):
        """
        HTTP holds the HTTP layer configuration for the APM Server resource.
        :param 'ApmServerSpecHttpServiceArgs' service: Service defines the template for the associated Kubernetes Service object.
        :param 'ApmServerSpecHttpTlsArgs' tls: TLS defines options for configuring TLS for HTTP.
        """
    ...
    @property
    @pulumi.getter
    def service(self) -> Optional['outputs.ApmServerSpecHttpService']:
        """
    ...
    @property
    @pulumi.getter
    def tls(self) -> Optional['outputs.ApmServerSpecHttpTls']:
        """
...
@pulumi.output_type
class ApmServerSpecHttpService(dict):
    """
    Service defines the template for the associated Kubernetes Service object.
    """
    def __init__(__self__, *,
                 metadata: Optional[Mapping[str, Any]] = None,
                 spec: Optional['outputs.ApmServerSpecHttpServiceSpec'] = None):
        """
        Service defines the template for the associated Kubernetes Service object.
        ...
        :param 'ApmServerSpecHttpServiceSpecArgs' spec: Spec is the specification of the service.
        """
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional['outputs.ApmServerSpecHttpServiceSpec']:
        """
...
@pulumi.output_type
class ApmServerSpecHttpServiceSpec(dict):
    """
    Spec is the specification of the service.
    """
    def __init__(__self__, *,
                 ...
                 ports: Optional[List['outputs.ApmServerSpecHttpServiceSpecPorts']] = None,
                 publish_not_ready_addresses: Optional[bool] = None,
                 selector: Optional[Mapping[str, str]] = None,
                 session_affinity: Optional[str] = None,
                 session_affinity_config: Optional['outputs.ApmServerSpecHttpServiceSpecSessionAffinityConfig'] = None,
        ...
        :param List['ApmServerSpecHttpServiceSpecPortsArgs'] ports: The list of ports that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies
        ...
        :param 'ApmServerSpecHttpServiceSpecSessionAffinityConfigArgs' session_affinity_config: sessionAffinityConfig contains the configurations of session affinity.
    ...
    @property
    @pulumi.getter
    def ports(self) -> Optional[List['outputs.ApmServerSpecHttpServiceSpecPorts']]:
        """
    ...
    def session_affinity_config(self) -> Optional['outputs.ApmServerSpecHttpServiceSpecSessionAffinityConfig']:
        """
...
@pulumi.output_type
class ApmServerSpecHttpServiceSpecPorts(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 target_port: Optional['outputs.ApmServerSpecHttpServiceSpecPortsTargetPort'] = None):
        """
        ServicePort contains information on service's port.
        ...
        :param 'ApmServerSpecHttpServiceSpecPortsTargetPortArgs' target_port: Number or name of the port to access on the pods targeted by the service. Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME. If this is a string, it will be looked up as a named port in the target Pod's container ports. If this is not specified, the value of the 'port' field is used (an identity map). This field is ignored for services with clusterIP=None, and should be omitted or set equal to the 'port' field. More info: https://kubernetes.io/docs/concepts/services-networking/service/#defining-a-service
        """
    ...
    def target_port(self) -> Optional['outputs.ApmServerSpecHttpServiceSpecPortsTargetPort']:
        """
...
@pulumi.output_type
class ApmServerSpecHttpServiceSpecPortsTargetPort(dict):
    def __init__(__self__):
        pass
...
@pulumi.output_type
class ApmServerSpecHttpServiceSpecSessionAffinityConfig(dict):
    """
    sessionAffinityConfig contains the configurations of session affinity.
    """
    def __init__(__self__, *,
                 client_ip: Optional['outputs.ApmServerSpecHttpServiceSpecSessionAffinityConfigClientIP'] = None):
        """
        sessionAffinityConfig contains the configurations of session affinity.
        :param 'ApmServerSpecHttpServiceSpecSessionAffinityConfigClientIPArgs' client_ip: clientIP contains the configurations of Client IP based session affinity.
        """
    ...
    def client_ip(self) -> Optional['outputs.ApmServerSpecHttpServiceSpecSessionAffinityConfigClientIP']:
        """
...
@pulumi.output_type
class ApmServerSpecHttpServiceSpecSessionAffinityConfigClientIP(dict):
    """
    clientIP contains the configurations of Client IP based session affinity.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class ApmServerSpecHttpTls(dict):
    """
    TLS defines options for configuring TLS for HTTP.
    """
    def __init__(__self__, *,
                 certificate: Optional['outputs.ApmServerSpecHttpTlsCertificate'] = None,
                 self_signed_certificate: Optional['outputs.ApmServerSpecHttpTlsSelfSignedCertificate'] = None):
        """
        TLS defines options for configuring TLS for HTTP.
        :param 'ApmServerSpecHttpTlsCertificateArgs' certificate: Certificate is a reference to a Kubernetes secret that contains the certificate and private key for enabling TLS. The referenced secret should contain the following: 
                - `ca.crt`: The certificate authority (optional). - `tls.crt`: The certificate (or a chain). - `tls.key`: The private key to the first certificate in the certificate chain.
        :param 'ApmServerSpecHttpTlsSelfSignedCertificateArgs' self_signed_certificate: SelfSignedCertificate allows configuring the self-signed certificate generated by the operator.
        """
    ...
    @property
    @pulumi.getter
    def certificate(self) -> Optional['outputs.ApmServerSpecHttpTlsCertificate']:
        """
    ...
    def self_signed_certificate(self) -> Optional['outputs.ApmServerSpecHttpTlsSelfSignedCertificate']:
        """
...
@pulumi.output_type
class ApmServerSpecHttpTlsCertificate(dict):
    """
    Certificate is a reference to a Kubernetes secret that contains the certificate and private key for enabling TLS. The referenced secret should contain the following: 
     - `ca.crt`: The certificate authority (optional). - `tls.crt`: The certificate (or a chain). - `tls.key`: The private key to the first certificate in the certificate chain.
    """
...
@pulumi.output_type
class ApmServerSpecHttpTlsSelfSignedCertificate(dict):
    """
    SelfSignedCertificate allows configuring the self-signed certificate generated by the operator.
    """
    def __init__(__self__, *,
                 disabled: Optional[bool] = None,
                 subject_alt_names: Optional[List['outputs.ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNames']] = None):
        """
        SelfSignedCertificate allows configuring the self-signed certificate generated by the operator.
        :param bool disabled: Disabled indicates that the provisioning of the self-signed certifcate should be disabled.
        :param List['ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNamesArgs'] subject_alt_names: SubjectAlternativeNames is a list of SANs to include in the generated HTTP TLS certificate.
        """
    ...
    def subject_alt_names(self) -> Optional[List['outputs.ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNames']]:
        """
...
@pulumi.output_type
class ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNames(dict):
    """
...
@pulumi.output_type
class ApmServerSpecKibanaRef(dict):
    """
    KibanaRef is a reference to a Kibana instance running in the same Kubernetes cluster. It allows APM agent central configuration management in Kibana.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class ApmServerSpecSecureSettings(dict):
    """
    SecretSource defines a data source based on a Kubernetes Secret.
    """
    def __init__(__self__, *,
                 secret_name: str,
                 entries: Optional[List['outputs.ApmServerSpecSecureSettingsEntries']] = None):
        """
        SecretSource defines a data source based on a Kubernetes Secret.
        :param str secret_name: SecretName is the name of the secret.
        :param List['ApmServerSpecSecureSettingsEntriesArgs'] entries: Entries define how to project each key-value pair in the secret to filesystem paths. If not defined, all keys will be projected to similarly named paths in the filesystem. If defined, only the specified keys will be projected to the corresponding paths.
        """
        pulumi.set(__self__, "secret_name", secret_name)
    ...
    @property
    @pulumi.getter
    def entries(self) -> Optional[List['outputs.ApmServerSpecSecureSettingsEntries']]:
        """
...
@pulumi.output_type
class ApmServerSpecSecureSettingsEntries(dict):
    """
...
@pulumi.output_type
class ApmServerStatus(dict):
    """
    ApmServerStatus defines the observed state of ApmServer
    """
    def __init__(__self__, *,
                 available_nodes: Optional[float] = None,
                 elasticsearch_association_status: Optional[str] = None,
                 health: Optional[str] = None,
                 kibana_association_status: Optional[str] = None,
                 secret_token_secret: Optional[str] = None,
                 service: Optional[str] = None):
        """
        ApmServerStatus defines the observed state of ApmServer
        :param str elasticsearch_association_status: ElasticsearchAssociationStatus is the status of any auto-linking to Elasticsearch clusters.
        :param str health: ApmServerHealth expresses the status of the Apm Server instances.
        :param str kibana_association_status: KibanaAssociationStatus is the status of any auto-linking to Kibana.
        :param str secret_token_secret: SecretTokenSecretName is the name of the Secret that contains the secret token
        :param str service: ExternalService is the name of the service the agents should connect to.
        """
    ...
    def available_nodes(self) -> Optional[float]:
    ...
    def secret_token_secret(self) -> Optional[str]:
        """
