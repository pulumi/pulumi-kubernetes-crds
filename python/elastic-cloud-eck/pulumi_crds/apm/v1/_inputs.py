...
class ApmServerSpecArgs:
    def __init__(__self__, *,
                 ...
                 secure_settings: Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecSecureSettingsArgs']]]] = None,
        ...
        :param pulumi.Input[float] count: Count of APM Server instances to deploy.
        ...
        :param pulumi.Input[List[pulumi.Input['ApmServerSpecSecureSettingsArgs']]] secure_settings: SecureSettings is a list of references to Kubernetes secrets containing sensitive configuration options for APM Server.
    ...
    def secure_settings(self) -> Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecSecureSettingsArgs']]]]:
        """
    ...
    def secure_settings(self, value: Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecSecureSettingsArgs']]]]):
...
class ApmServerSpecHttpServiceSpecArgs:
    def __init__(__self__, *,
                 ...
                 ports: Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecHttpServiceSpecPortsArgs']]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input['ApmServerSpecHttpServiceSpecPortsArgs']]] ports: The list of ports that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies
    ...
    @property
    @pulumi.getter
    def ports(self) -> Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecHttpServiceSpecPortsArgs']]]]:
        """
    ...
    @ports.setter
    def ports(self, value: Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecHttpServiceSpecPortsArgs']]]]):
...
class ApmServerSpecHttpTlsSelfSignedCertificateArgs:
    def __init__(__self__, *,
                 ...
                 subject_alt_names: Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNamesArgs']]]] = None):
        """
        SelfSignedCertificate allows configuring the self-signed certificate generated by the operator.
        ...
        :param pulumi.Input[List[pulumi.Input['ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNamesArgs']]] subject_alt_names: SubjectAlternativeNames is a list of SANs to include in the generated HTTP TLS certificate.
        """
    ...
    def subject_alt_names(self) -> Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNamesArgs']]]]:
        """
    ...
    def subject_alt_names(self, value: Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNamesArgs']]]]):
...
class ApmServerSpecSecureSettingsArgs:
    ...
    @property
    @pulumi.getter
    def entries(self) -> Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecSecureSettingsEntriesArgs']]]]:
        """
    ...
    @entries.setter
    def entries(self, value: Optional[pulumi.Input[List[pulumi.Input['ApmServerSpecSecureSettingsEntriesArgs']]]]):
...
class ApmServerStatusArgs:
    def __init__(__self__, *,
                 available_nodes: Optional[pulumi.Input[float]] = None,
    ...
    def available_nodes(self) -> Optional[pulumi.Input[float]]:
        return pulumi.get(self, "available_nodes")

    @available_nodes.setter
    def available_nodes(self, value: Optional[pulumi.Input[float]]):
