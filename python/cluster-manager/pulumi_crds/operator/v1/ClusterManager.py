...
class ClusterManager(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['ClusterManagerSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['ClusterManagerStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['ClusterManagerSpecArgs']] spec: Spec represents a desired deployment configuration of controllers that govern registration and work distribution for attached Klusterlets.
        :param pulumi.Input[pulumi.InputType['ClusterManagerStatusArgs']] status: Status represents the current status of controllers that govern the lifecycle of managed clusters.
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'ClusterManager'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(ClusterManager, __self__).__init__(
            'kubernetes:operator.open-cluster-management.io/v1:ClusterManager',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.ClusterManagerSpec']]:
        """
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.ClusterManagerStatus']]:
        """
