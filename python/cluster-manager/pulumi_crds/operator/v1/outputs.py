...
class ClusterManagerStatus(dict):
    ...
    """
    def __init__(__self__, *,
                 conditions: Optional[List['outputs.ClusterManagerStatusConditions']] = None,
                 generations: Optional[List['outputs.ClusterManagerStatusGenerations']] = None,
                 observed_generation: Optional[float] = None,
                 related_resources: Optional[List['outputs.ClusterManagerStatusRelatedResources']] = None):
        """
        Status represents the current status of controllers that govern the lifecycle of managed clusters.
        :param List['ClusterManagerStatusConditionsArgs'] conditions: Conditions contain the different condition statuses for this ClusterManager. Valid condition types are: Applied: components in hub are applied. Available: components in hub are available and ready to serve. Progressing: components in hub are in a transitioning state. Degraded: components in hub do not match the desired configuration and only provide degraded service.
        :param List['ClusterManagerStatusGenerationsArgs'] generations: Generations are used to determine when an item needs to be reconciled or has changed in a way that needs a reaction.
        :param float observed_generation: ObservedGeneration is the last generation change you've dealt with
        :param List['ClusterManagerStatusRelatedResourcesArgs'] related_resources: RelatedResources are used to track the resources that are related to this ClusterManager
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[List['outputs.ClusterManagerStatusConditions']]:
        """
        Conditions contain the different condition statuses for this ClusterManager. Valid condition types are: Applied: components in hub are applied. Available: components in hub are available and ready to serve. Progressing: components in hub are in a transitioning state. Degraded: components in hub do not match the desired configuration and only provide degraded service.
        """
    ...
    @property
    @pulumi.getter
    def generations(self) -> Optional[List['outputs.ClusterManagerStatusGenerations']]:
        """
    ...
    def related_resources(self) -> Optional[List['outputs.ClusterManagerStatusRelatedResources']]:
        """
