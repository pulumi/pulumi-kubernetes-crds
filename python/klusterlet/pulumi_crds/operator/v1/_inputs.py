...
class KlusterletSpecArgs:
    def __init__(__self__, *,
                 ...
                 external_server_urls: Optional[pulumi.Input[List[pulumi.Input['KlusterletSpecExternalServerURLsArgs']]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input['KlusterletSpecExternalServerURLsArgs']]] external_server_urls: ExternalServerURLs represents the a list of apiserver urls and ca bundles that is accessible externally If it is set empty, managed cluster has no externally accessible url that hub cluster can visit.
    ...
    def external_server_urls(self) -> Optional[pulumi.Input[List[pulumi.Input['KlusterletSpecExternalServerURLsArgs']]]]:
        """
    ...
    def external_server_urls(self, value: Optional[pulumi.Input[List[pulumi.Input['KlusterletSpecExternalServerURLsArgs']]]]):
...
class KlusterletStatusArgs:
    def __init__(__self__, *,
                 conditions: Optional[pulumi.Input[List[pulumi.Input['KlusterletStatusConditionsArgs']]]] = None,
                 generations: Optional[pulumi.Input[List[pulumi.Input['KlusterletStatusGenerationsArgs']]]] = None,
                 observed_generation: Optional[pulumi.Input[float]] = None,
                 related_resources: Optional[pulumi.Input[List[pulumi.Input['KlusterletStatusRelatedResourcesArgs']]]] = None):
        """
        Status represents the current status of Klusterlet agent.
        :param pulumi.Input[List[pulumi.Input['KlusterletStatusConditionsArgs']]] conditions: Conditions contain the different condition statuses for this Klusterlet. Valid condition types are: Applied: components have been applied in the managed cluster. Available: components in the managed cluster are available and ready to serve. Progressing: components in the managed cluster are in a transitioning state. Degraded: components in the managed cluster do not match the desired configuration and only provide degraded service.
        :param pulumi.Input[List[pulumi.Input['KlusterletStatusGenerationsArgs']]] generations: Generations are used to determine when an item needs to be reconciled or has changed in a way that needs a reaction.
        :param pulumi.Input[float] observed_generation: ObservedGeneration is the last generation change you've dealt with
        :param pulumi.Input[List[pulumi.Input['KlusterletStatusRelatedResourcesArgs']]] related_resources: RelatedResources are used to track the resources that are related to this Klusterlet
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[List[pulumi.Input['KlusterletStatusConditionsArgs']]]]:
        """
        Conditions contain the different condition statuses for this Klusterlet. Valid condition types are: Applied: components have been applied in the managed cluster. Available: components in the managed cluster are available and ready to serve. Progressing: components in the managed cluster are in a transitioning state. Degraded: components in the managed cluster do not match the desired configuration and only provide degraded service.
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[List[pulumi.Input['KlusterletStatusConditionsArgs']]]]):
        pulumi.set(self, "conditions", value)

    @property
    @pulumi.getter
    def generations(self) -> Optional[pulumi.Input[List[pulumi.Input['KlusterletStatusGenerationsArgs']]]]:
        """
    ...
    @generations.setter
    def generations(self, value: Optional[pulumi.Input[List[pulumi.Input['KlusterletStatusGenerationsArgs']]]]):
    ...
    def related_resources(self) -> Optional[pulumi.Input[List[pulumi.Input['KlusterletStatusRelatedResourcesArgs']]]]:
        """
    ...
    def related_resources(self, value: Optional[pulumi.Input[List[pulumi.Input['KlusterletStatusRelatedResourcesArgs']]]]):
