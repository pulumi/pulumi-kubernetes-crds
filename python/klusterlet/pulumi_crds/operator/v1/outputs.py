...
class KlusterletSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 external_server_urls: Optional[List['outputs.KlusterletSpecExternalServerURLs']] = None,
        ...
        :param List['KlusterletSpecExternalServerURLsArgs'] external_server_urls: ExternalServerURLs represents the a list of apiserver urls and ca bundles that is accessible externally If it is set empty, managed cluster has no externally accessible url that hub cluster can visit.
    ...
    def external_server_urls(self) -> Optional[List['outputs.KlusterletSpecExternalServerURLs']]:
        """
...
class KlusterletStatus(dict):
    ...
    """
    def __init__(__self__, *,
                 conditions: Optional[List['outputs.KlusterletStatusConditions']] = None,
                 generations: Optional[List['outputs.KlusterletStatusGenerations']] = None,
                 observed_generation: Optional[float] = None,
                 related_resources: Optional[List['outputs.KlusterletStatusRelatedResources']] = None):
        """
        Status represents the current status of Klusterlet agent.
        :param List['KlusterletStatusConditionsArgs'] conditions: Conditions contain the different condition statuses for this Klusterlet. Valid condition types are: Applied: components have been applied in the managed cluster. Available: components in the managed cluster are available and ready to serve. Progressing: components in the managed cluster are in a transitioning state. Degraded: components in the managed cluster do not match the desired configuration and only provide degraded service.
        :param List['KlusterletStatusGenerationsArgs'] generations: Generations are used to determine when an item needs to be reconciled or has changed in a way that needs a reaction.
        :param float observed_generation: ObservedGeneration is the last generation change you've dealt with
        :param List['KlusterletStatusRelatedResourcesArgs'] related_resources: RelatedResources are used to track the resources that are related to this Klusterlet
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[List['outputs.KlusterletStatusConditions']]:
        """
        Conditions contain the different condition statuses for this Klusterlet. Valid condition types are: Applied: components have been applied in the managed cluster. Available: components in the managed cluster are available and ready to serve. Progressing: components in the managed cluster are in a transitioning state. Degraded: components in the managed cluster do not match the desired configuration and only provide degraded service.
        """
    ...
    @property
    @pulumi.getter
    def generations(self) -> Optional[List['outputs.KlusterletStatusGenerations']]:
        """
    ...
    def related_resources(self) -> Optional[List['outputs.KlusterletStatusRelatedResources']]:
        """
...
class KlusterletStatusGenerations(dict):
    ...
    def __init__(__self__, *,
                 ...
                 last_generation: Optional[float] = None,
        ...
        :param float last_generation: lastGeneration is the last generation of the thing that controller applies
    ...
    def last_generation(self) -> Optional[float]:
        """
