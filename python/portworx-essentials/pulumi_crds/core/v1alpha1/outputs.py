...
class StorageClusterSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 env: Optional[List['outputs.StorageClusterSpecEnv']] = None,
                 ...
                 nodes: Optional[List['outputs.StorageClusterSpecNodes']] = None,
        ...
        :param List['StorageClusterSpecEnvArgs'] env: List of environment variables used by the driver. This is an array of Kubernetes EnvVar where the value can be given directly or from a source like field, config map or secret.
        ...
        :param List['StorageClusterSpecNodesArgs'] nodes: Node level configurations that will override the configuration at cluster level. These configurations can be for individual nodes or can be grouped to override configuration of multiple nodes based on label selectors.
        :param 'StorageClusterSpecPlacementArgs' placement: Describes placement configuration for the storage cluster pods.
        :param float revision_history_limit: The number of old history to retain to allow rollback. This is a pointer to distinguish between an explicit zero and not specified. Defaults to 10.
        ...
        :param float start_port: Start port is the starting port in the range of ports used by the cluster.
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[List['outputs.StorageClusterSpecEnv']]:
        """
    ...
    @property
    @pulumi.getter
    def nodes(self) -> Optional[List['outputs.StorageClusterSpecNodes']]:
        """
    ...
    def start_port(self) -> Optional[float]:
        """
...
class StorageClusterSpecAutopilot(dict):
    ...
    def __init__(__self__, *,
                 ...
                 env: Optional[List['outputs.StorageClusterSpecAutopilotEnv']] = None,
                 image: Optional[str] = None,
                 lock_image: Optional[bool] = None,
                 providers: Optional[List['outputs.StorageClusterSpecAutopilotProviders']] = None):
        """
        Contains spec of autopilot component for storage driver.
        ...
        :param List['StorageClusterSpecAutopilotEnvArgs'] env: List of environment variables used by autopilot. This is an array of Kubernetes EnvVar where the value can be given directly or from a source like field, config map or secret.
        ...
        :param List['StorageClusterSpecAutopilotProvidersArgs'] providers: List of input data providers to autopilot.
        """
        if args is not None:
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[List['outputs.StorageClusterSpecAutopilotEnv']]:
        """
    ...
    @property
    @pulumi.getter
    def providers(self) -> Optional[List['outputs.StorageClusterSpecAutopilotProviders']]:
        """
...
class StorageClusterSpecCloudStorage(dict):
    ...
    def __init__(__self__, *,
        ...
        :param float max_storage_nodes: Maximum nodes that will have storage in the cluster.
        :param float max_storage_nodes_per_zone: Maximum nodes in every zone that will have storage in the cluster.
    ...
    def capacity_specs(self) -> Optional[List['outputs.StorageClusterSpecCloudStorageCapacitySpecs']]:
        """
    ...
    def device_specs(self) -> Optional[List[str]]:
        """
    ...
    def max_storage_nodes(self) -> Optional[float]:
        """
    ...
    def max_storage_nodes_per_zone(self) -> Optional[float]:
        """
...
class StorageClusterSpecCloudStorageCapacitySpecs(dict):
    def __init__(__self__, *,
                 max_capacity_in_gi_b: Optional[float] = None,
                 min_capacity_in_gi_b: Optional[float] = None,
                 min_iops: Optional[float] = None,
                 options: Optional[Mapping[str, Any]] = None):
        """
        :param float max_capacity_in_gi_b: Maximum capacity for this storage cluster. The total capacity of devices created by this capacity spec should not be greater than this number for the entire cluster.
        :param float min_capacity_in_gi_b: Minimum capacity for this storage cluster. The total capacity of devices created by this capacity spec should not be less than this number for the entire cluster.
        :param float min_iops: Minimum IOPS expected from the cloud drive.
    ...
    def max_capacity_in_gi_b(self) -> Optional[float]:
        """
    ...
    def min_capacity_in_gi_b(self) -> Optional[float]:
        """
    ...
    def min_iops(self) -> Optional[float]:
        """
...
class StorageClusterSpecKvdb(dict):
    ...
    def __init__(__self__, *,
        ...
        :param List[str] endpoints: If using external KVDB, this is the list of KVDB endpoints.
...
class StorageClusterSpecNodes(dict):
    def __init__(__self__, *,
                 env: Optional[List['outputs.StorageClusterSpecNodesEnv']] = None,
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[List['outputs.StorageClusterSpecNodesEnv']]:
        """
...
class StorageClusterSpecNodesSelectorLabelSelector(dict):
    ...
    """
    def __init__(__self__, *,
                 match_expressions: Optional[List['outputs.StorageClusterSpecNodesSelectorLabelSelectorMatchExpressions']] = None,
                 match_labels: Optional[Mapping[str, Any]] = None):
        """
        It is a label query over all the nodes. The result of matchLabels and matchExpressions is ANDed. An empty label selector matches all nodes. A null label selector matches no objects.
        :param List['StorageClusterSpecNodesSelectorLabelSelectorMatchExpressionsArgs'] match_expressions: It is a list of label selector requirements. The requirements are ANDed.
    ...
    def match_expressions(self) -> Optional[List['outputs.StorageClusterSpecNodesSelectorLabelSelectorMatchExpressions']]:
        """
...
class StorageClusterSpecNodesSelectorLabelSelectorMatchExpressions(dict):
    def __init__(__self__, *,
        ...
        :param List[str] values: It is an array of string values. If the operator is In or NotIn, the values array must be non-empty. If the operator is Exists or DoesNotExist, the values array must be empty.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
...
class StorageClusterSpecNodesStorage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details of the storage used by the storage driver.
        :param List[str] devices: List of devices to be used by the storage driver.
...
class StorageClusterSpecPlacement(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tolerations: Optional[List['outputs.StorageClusterSpecPlacementTolerations']] = None):
        """
        Describes placement configuration for the storage cluster pods.
        ...
        :param List['StorageClusterSpecPlacementTolerationsArgs'] tolerations: Tolerations for all the pods deployed by the StorageCluster controller. The pod with this toleration attached will tolerate any taint that matches the triple <key,value,effect> using the matching operator <operator>.
        """
    ...
    @property
    @pulumi.getter
    def tolerations(self) -> Optional[List['outputs.StorageClusterSpecPlacementTolerations']]:
        """
...
class StorageClusterSpecPlacementNodeAffinity(dict):
    ...
    """
    def __init__(__self__, *,
                 preferred_during_scheduling_ignored_during_execution: Optional[List['outputs.StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution']] = None,
    ...
    def preferred_during_scheduling_ignored_during_execution(self) -> Optional[List['outputs.StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution']]:
...
class StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference(dict):
    def __init__(__self__, *,
                 match_expressions: Optional[List['outputs.StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressions']] = None,
                 match_fields: Optional[List['outputs.StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFields']] = None):
        if match_expressions is not None:
            pulumi.set(__self__, "match_expressions", match_expressions)
    ...
    @property
    @pulumi.getter(name="matchExpressions")
    def match_expressions(self) -> Optional[List['outputs.StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressions']]:
        return pulumi.get(self, "match_expressions")

    @property
    @pulumi.getter(name="matchFields")
    def match_fields(self) -> Optional[List['outputs.StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFields']]:
...
class StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecution(dict):
    def __init__(__self__, *,
                 node_selector_terms: List['outputs.StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTerms']):
        pulumi.set(__self__, "node_selector_terms", node_selector_terms)

    @property
    @pulumi.getter(name="nodeSelectorTerms")
    def node_selector_terms(self) -> List['outputs.StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTerms']:
...
class StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTerms(dict):
    def __init__(__self__, *,
                 match_expressions: Optional[List['outputs.StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressions']] = None,
                 match_fields: Optional[List['outputs.StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFields']] = None):
        if match_expressions is not None:
            pulumi.set(__self__, "match_expressions", match_expressions)
        if match_fields is not None:
            pulumi.set(__self__, "match_fields", match_fields)
    ...
    @property
    @pulumi.getter(name="matchExpressions")
    def match_expressions(self) -> Optional[List['outputs.StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressions']]:
        return pulumi.get(self, "match_expressions")

    @property
    @pulumi.getter(name="matchFields")
    def match_fields(self) -> Optional[List['outputs.StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFields']]:
        return pulumi.get(self, "match_fields")
...
class StorageClusterSpecStork(dict):
    ...
    def __init__(__self__, *,
                 args: Optional[Mapping[str, Any]] = None,
                 enabled: Optional[bool] = None,
                 env: Optional[List['outputs.StorageClusterSpecStorkEnv']] = None,
                 image: Optional[str] = None,
                 lock_image: Optional[bool] = None):
        """
        Contains STORK related spec.
        ...
        :param List['StorageClusterSpecStorkEnvArgs'] env: List of environment variables used by STORK. This is an array of Kubernetes EnvVar where the value can be given directly or from a source like field, config map or secret.
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[List['outputs.StorageClusterSpecStorkEnv']]:
        """
...
class StorageClusterSpecUserInterface(dict):
    ...
    def __init__(__self__, *,
                 enabled: Optional[bool] = None,
                 env: Optional[List['outputs.StorageClusterSpecUserInterfaceEnv']] = None,
                 image: Optional[str] = None,
                 lock_image: Optional[bool] = None):
        """
        Contains spec of a user interface for the storage driver.
        :param bool enabled: Flag indicating whether the user interface needs to be enabled.
        :param List['StorageClusterSpecUserInterfaceEnvArgs'] env: List of environment variables used by the UI components. This is an array of Kubernetes EnvVar where the value can be given directly or from a source like field, config map or secret.
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[List['outputs.StorageClusterSpecUserInterfaceEnv']]:
        """
...
class StorageClusterStatus(dict):
    ...
    def __init__(__self__, *,
                 ...
                 conditions: Optional[List['outputs.StorageClusterStatusConditions']] = None,
        ...
        :param float collision_count: Count of hash collisions for the StorageCluster. The StorageCluster controller uses this field as a collision avoidance mechanism when it needs to create the name of the newest ControllerRevision.
        :param List['StorageClusterStatusConditionsArgs'] conditions: Contains details for the current condition of this cluster.
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[List['outputs.StorageClusterStatusConditions']]:
        """
...
class StorageClusterStatusStorage(dict):
    ...
    """
    def __init__(__self__, *,
                 storage_nodes_per_zone: Optional[float] = None):
        """
        Contains details of storage in the cluster.
        :param float storage_nodes_per_zone: The number of storage nodes per zone in the cluster.
        """
    ...
    def storage_nodes_per_zone(self) -> Optional[float]:
        """
