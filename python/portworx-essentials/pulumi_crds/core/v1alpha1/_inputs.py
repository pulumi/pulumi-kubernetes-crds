...
class StorageClusterSpecArgs:
    def __init__(__self__, *,
                 ...
                 env: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecEnvArgs']]]] = None,
                 ...
                 nodes: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesArgs']]]] = None,
                 ...
                 start_port: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input['StorageClusterSpecEnvArgs']]] env: List of environment variables used by the driver. This is an array of Kubernetes EnvVar where the value can be given directly or from a source like field, config map or secret.
        ...
        :param pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesArgs']]] nodes: Node level configurations that will override the configuration at cluster level. These configurations can be for individual nodes or can be grouped to override configuration of multiple nodes based on label selectors.
        ...
        :param pulumi.Input[float] revision_history_limit: The number of old history to retain to allow rollback. This is a pointer to distinguish between an explicit zero and not specified. Defaults to 10.
        ...
        :param pulumi.Input[float] start_port: Start port is the starting port in the range of ports used by the cluster.
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecEnvArgs']]]]:
        """
    ...
    @env.setter
    def env(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecEnvArgs']]]]):
    ...
    @property
    @pulumi.getter
    def nodes(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesArgs']]]]:
        """
    ...
    @nodes.setter
    def nodes(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesArgs']]]]):
    ...
    def start_port(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    @start_port.setter
    def start_port(self, value: Optional[pulumi.Input[float]]):
...
class StorageClusterSpecAutopilotArgs:
    def __init__(__self__, *,
                 ...
                 env: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecAutopilotEnvArgs']]]] = None,
                 image: Optional[pulumi.Input[str]] = None,
                 lock_image: Optional[pulumi.Input[bool]] = None,
                 providers: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecAutopilotProvidersArgs']]]] = None):
        """
        Contains spec of autopilot component for storage driver.
        ...
        :param pulumi.Input[List[pulumi.Input['StorageClusterSpecAutopilotEnvArgs']]] env: List of environment variables used by autopilot. This is an array of Kubernetes EnvVar where the value can be given directly or from a source like field, config map or secret.
        ...
        :param pulumi.Input[List[pulumi.Input['StorageClusterSpecAutopilotProvidersArgs']]] providers: List of input data providers to autopilot.
        """
        if args is not None:
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecAutopilotEnvArgs']]]]:
        """
    ...
    @env.setter
    def env(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecAutopilotEnvArgs']]]]):
        pulumi.set(self, "env", value)
    ...
    @property
    @pulumi.getter
    def providers(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecAutopilotProvidersArgs']]]]:
        """
    ...
    @providers.setter
    def providers(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecAutopilotProvidersArgs']]]]):
...
class StorageClusterSpecCloudStorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] max_storage_nodes: Maximum nodes that will have storage in the cluster.
        :param pulumi.Input[float] max_storage_nodes_per_zone: Maximum nodes in every zone that will have storage in the cluster.
    ...
    def capacity_specs(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecCloudStorageCapacitySpecsArgs']]]]:
        """
    ...
    def capacity_specs(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecCloudStorageCapacitySpecsArgs']]]]):
        pulumi.set(self, "capacity_specs", value)

    @property
    @pulumi.getter(name="deviceSpecs")
    def device_specs(self) -> Optional[pulumi.Input[List[pulumi.Input[str]]]]:
        """
    ...
    @device_specs.setter
    def device_specs(self, value: Optional[pulumi.Input[List[pulumi.Input[str]]]]):
    ...
    def max_storage_nodes(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def max_storage_nodes(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "max_storage_nodes", value)

    @property
    @pulumi.getter(name="maxStorageNodesPerZone")
    def max_storage_nodes_per_zone(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def max_storage_nodes_per_zone(self, value: Optional[pulumi.Input[float]]):
...
class StorageClusterSpecCloudStorageCapacitySpecsArgs:
    def __init__(__self__, *,
                 max_capacity_in_gi_b: Optional[pulumi.Input[float]] = None,
                 min_capacity_in_gi_b: Optional[pulumi.Input[float]] = None,
                 min_iops: Optional[pulumi.Input[float]] = None,
                 options: Optional[pulumi.Input[Mapping[str, Any]]] = None):
        """
        :param pulumi.Input[float] max_capacity_in_gi_b: Maximum capacity for this storage cluster. The total capacity of devices created by this capacity spec should not be greater than this number for the entire cluster.
        :param pulumi.Input[float] min_capacity_in_gi_b: Minimum capacity for this storage cluster. The total capacity of devices created by this capacity spec should not be less than this number for the entire cluster.
        :param pulumi.Input[float] min_iops: Minimum IOPS expected from the cloud drive.
    ...
    def max_capacity_in_gi_b(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def max_capacity_in_gi_b(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "max_capacity_in_gi_b", value)

    @property
    @pulumi.getter(name="minCapacityInGiB")
    def min_capacity_in_gi_b(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def min_capacity_in_gi_b(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "min_capacity_in_gi_b", value)

    @property
    @pulumi.getter(name="minIOPS")
    def min_iops(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    @min_iops.setter
    def min_iops(self, value: Optional[pulumi.Input[float]]):
...
class StorageClusterSpecKvdbArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] endpoints: If using external KVDB, this is the list of KVDB endpoints.
...
class StorageClusterSpecNodesArgs:
    def __init__(__self__, *,
                 env: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesEnvArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesEnvArgs']]]]:
        """
    ...
    @env.setter
    def env(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesEnvArgs']]]]):
        pulumi.set(self, "env", value)
...
class StorageClusterSpecNodesSelectorLabelSelectorArgs:
    def __init__(__self__, *,
                 match_expressions: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesSelectorLabelSelectorMatchExpressionsArgs']]]] = None,
                 match_labels: Optional[pulumi.Input[Mapping[str, Any]]] = None):
        """
        It is a label query over all the nodes. The result of matchLabels and matchExpressions is ANDed. An empty label selector matches all nodes. A null label selector matches no objects.
        :param pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesSelectorLabelSelectorMatchExpressionsArgs']]] match_expressions: It is a list of label selector requirements. The requirements are ANDed.
    ...
    def match_expressions(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesSelectorLabelSelectorMatchExpressionsArgs']]]]:
        """
    ...
    def match_expressions(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecNodesSelectorLabelSelectorMatchExpressionsArgs']]]]):
...
class StorageClusterSpecNodesSelectorLabelSelectorMatchExpressionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] values: It is an array of string values. If the operator is In or NotIn, the values array must be non-empty. If the operator is Exists or DoesNotExist, the values array must be empty.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
...
class StorageClusterSpecNodesStorageArgs:
    def __init__(__self__, *,
                 devices: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None,
        ...
        """
        Details of the storage used by the storage driver.
        :param pulumi.Input[List[pulumi.Input[str]]] devices: List of devices to be used by the storage driver.
    ...
    @property
    @pulumi.getter
    def devices(self) -> Optional[pulumi.Input[List[pulumi.Input[str]]]]:
        """
    ...
    @devices.setter
    def devices(self, value: Optional[pulumi.Input[List[pulumi.Input[str]]]]):
...
class StorageClusterSpecPlacementArgs:
    def __init__(__self__, *,
                 ...
                 tolerations: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementTolerationsArgs']]]] = None):
        """
        Describes placement configuration for the storage cluster pods.
        ...
        :param pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementTolerationsArgs']]] tolerations: Tolerations for all the pods deployed by the StorageCluster controller. The pod with this toleration attached will tolerate any taint that matches the triple <key,value,effect> using the matching operator <operator>.
        """
    ...
    @property
    @pulumi.getter
    def tolerations(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementTolerationsArgs']]]]:
        """
    ...
    @tolerations.setter
    def tolerations(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementTolerationsArgs']]]]):
...
class StorageClusterSpecPlacementNodeAffinityArgs:
    def __init__(__self__, *,
                 preferred_during_scheduling_ignored_during_execution: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionArgs']]]] = None,
    ...
    def preferred_during_scheduling_ignored_during_execution(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionArgs']]]]:
        return pulumi.get(self, "preferred_during_scheduling_ignored_during_execution")

    @preferred_during_scheduling_ignored_during_execution.setter
    def preferred_during_scheduling_ignored_during_execution(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionArgs']]]]):
...
class StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceArgs:
    def __init__(__self__, *,
                 match_expressions: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressionsArgs']]]] = None,
                 match_fields: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFieldsArgs']]]] = None):
        if match_expressions is not None:
            pulumi.set(__self__, "match_expressions", match_expressions)
    ...
    @property
    @pulumi.getter(name="matchExpressions")
    def match_expressions(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressionsArgs']]]]:
        return pulumi.get(self, "match_expressions")

    @match_expressions.setter
    def match_expressions(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressionsArgs']]]]):
        pulumi.set(self, "match_expressions", value)

    @property
    @pulumi.getter(name="matchFields")
    def match_fields(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFieldsArgs']]]]:
        return pulumi.get(self, "match_fields")

    @match_fields.setter
    def match_fields(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFieldsArgs']]]]):
...
class StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionArgs:
    def __init__(__self__, *,
                 node_selector_terms: pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsArgs']]]):
        pulumi.set(__self__, "node_selector_terms", node_selector_terms)

    @property
    @pulumi.getter(name="nodeSelectorTerms")
    def node_selector_terms(self) -> pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsArgs']]]:
        return pulumi.get(self, "node_selector_terms")

    @node_selector_terms.setter
    def node_selector_terms(self, value: pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsArgs']]]):
...
class StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsArgs:
    def __init__(__self__, *,
                 match_expressions: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressionsArgs']]]] = None,
                 match_fields: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFieldsArgs']]]] = None):
        if match_expressions is not None:
            pulumi.set(__self__, "match_expressions", match_expressions)
        if match_fields is not None:
            pulumi.set(__self__, "match_fields", match_fields)
    ...
    @property
    @pulumi.getter(name="matchExpressions")
    def match_expressions(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressionsArgs']]]]:
        return pulumi.get(self, "match_expressions")

    @match_expressions.setter
    def match_expressions(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressionsArgs']]]]):
        pulumi.set(self, "match_expressions", value)

    @property
    @pulumi.getter(name="matchFields")
    def match_fields(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFieldsArgs']]]]:
        return pulumi.get(self, "match_fields")

    @match_fields.setter
    def match_fields(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFieldsArgs']]]]):
        pulumi.set(self, "match_fields", value)
...
class StorageClusterSpecStorkArgs:
    def __init__(__self__, *,
                 args: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 env: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecStorkEnvArgs']]]] = None,
                 image: Optional[pulumi.Input[str]] = None,
                 lock_image: Optional[pulumi.Input[bool]] = None):
        """
        Contains STORK related spec.
        ...
        :param pulumi.Input[List[pulumi.Input['StorageClusterSpecStorkEnvArgs']]] env: List of environment variables used by STORK. This is an array of Kubernetes EnvVar where the value can be given directly or from a source like field, config map or secret.
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecStorkEnvArgs']]]]:
        """
    ...
    @env.setter
    def env(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecStorkEnvArgs']]]]):
        pulumi.set(self, "env", value)
...
class StorageClusterSpecUserInterfaceArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 env: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecUserInterfaceEnvArgs']]]] = None,
                 image: Optional[pulumi.Input[str]] = None,
                 lock_image: Optional[pulumi.Input[bool]] = None):
        """
        Contains spec of a user interface for the storage driver.
        :param pulumi.Input[bool] enabled: Flag indicating whether the user interface needs to be enabled.
        :param pulumi.Input[List[pulumi.Input['StorageClusterSpecUserInterfaceEnvArgs']]] env: List of environment variables used by the UI components. This is an array of Kubernetes EnvVar where the value can be given directly or from a source like field, config map or secret.
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecUserInterfaceEnvArgs']]]]:
        """
    ...
    @env.setter
    def env(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterSpecUserInterfaceEnvArgs']]]]):
        pulumi.set(self, "env", value)
...
class StorageClusterStatusArgs:
    def __init__(__self__, *,
                 ...
                 conditions: Optional[pulumi.Input[List[pulumi.Input['StorageClusterStatusConditionsArgs']]]] = None,
        ...
        :param pulumi.Input[float] collision_count: Count of hash collisions for the StorageCluster. The StorageCluster controller uses this field as a collision avoidance mechanism when it needs to create the name of the newest ControllerRevision.
        :param pulumi.Input[List[pulumi.Input['StorageClusterStatusConditionsArgs']]] conditions: Contains details for the current condition of this cluster.
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[List[pulumi.Input['StorageClusterStatusConditionsArgs']]]]:
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[List[pulumi.Input['StorageClusterStatusConditionsArgs']]]]):
...
class StorageClusterStatusStorageArgs:
    def __init__(__self__, *,
                 storage_nodes_per_zone: Optional[pulumi.Input[float]] = None):
        """
        Contains details of storage in the cluster.
        :param pulumi.Input[float] storage_nodes_per_zone: The number of storage nodes per zone in the cluster.
        """
    ...
    def storage_nodes_per_zone(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def storage_nodes_per_zone(self, value: Optional[pulumi.Input[float]]):
