...
class KnativeEventingKafkaStatus(dict):
    def __init__(__self__, *,
                 conditions: Optional[List['outputs.KnativeEventingKafkaStatusConditions']] = None,
                 version: Optional[str] = None):
        """
        :param List['KnativeEventingKafkaStatusConditionsArgs'] conditions: The latest available observations of a resource's current state. +patchMergeKey=type +patchStrategy=merge
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[List['outputs.KnativeEventingKafkaStatusConditions']]:
        """
