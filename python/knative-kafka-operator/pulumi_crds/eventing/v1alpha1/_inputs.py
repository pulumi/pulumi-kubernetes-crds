...
class KnativeEventingKafkaStatusArgs:
    def __init__(__self__, *,
                 conditions: Optional[pulumi.Input[List[pulumi.Input['KnativeEventingKafkaStatusConditionsArgs']]]] = None,
                 version: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[List[pulumi.Input['KnativeEventingKafkaStatusConditionsArgs']]] conditions: The latest available observations of a resource's current state. +patchMergeKey=type +patchStrategy=merge
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[List[pulumi.Input['KnativeEventingKafkaStatusConditionsArgs']]]]:
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[List[pulumi.Input['KnativeEventingKafkaStatusConditionsArgs']]]]):
