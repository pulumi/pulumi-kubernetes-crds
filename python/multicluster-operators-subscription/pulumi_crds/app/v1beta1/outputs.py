...
class ApplicationSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 component_kinds: Optional[List['outputs.ApplicationSpecComponentKinds']] = None,
                 descriptor: Optional['outputs.ApplicationSpecDescriptor'] = None,
                 info: Optional[List['outputs.ApplicationSpecInfo']] = None,
        ...
        :param List['ApplicationSpecComponentKindsArgs'] component_kinds: ComponentGroupKinds is a list of Kinds for Application's components (e.g. Deployments, Pods, Services, CRDs). It can be used in conjunction with the Application's Selector to list or watch the Applications components.
        :param 'ApplicationSpecDescriptorArgs' descriptor: Descriptor regroups information and metadata about an application.
        :param List['ApplicationSpecInfoArgs'] info: Info contains human readable key,value pairs for the Application.
    ...
    def component_kinds(self) -> Optional[List['outputs.ApplicationSpecComponentKinds']]:
        """
    ...
    @property
    @pulumi.getter
    def info(self) -> Optional[List['outputs.ApplicationSpecInfo']]:
        """
...
class ApplicationSpecDescriptor(dict):
    ...
    def __init__(__self__, *,
                 ...
                 icons: Optional[List['outputs.ApplicationSpecDescriptorIcons']] = None,
                 keywords: Optional[List[str]] = None,
                 links: Optional[List['outputs.ApplicationSpecDescriptorLinks']] = None,
                 maintainers: Optional[List['outputs.ApplicationSpecDescriptorMaintainers']] = None,
                 notes: Optional[str] = None,
                 owners: Optional[List['outputs.ApplicationSpecDescriptorOwners']] = None,
                 type: Optional[str] = None,
                 version: Optional[str] = None):
        """
        Descriptor regroups information and metadata about an application.
        :param str description: Description is a brief string description of the Application.
        :param List['ApplicationSpecDescriptorIconsArgs'] icons: Icons is an optional list of icons for an application. Icon information includes the source, size, and mime type.
        :param List[str] keywords: Keywords is an optional list of key words associated with the application (e.g. MySQL, RDBMS, database).
        :param List['ApplicationSpecDescriptorLinksArgs'] links: Links are a list of descriptive URLs intended to be used to surface additional documentation, dashboards, etc.
        :param List['ApplicationSpecDescriptorMaintainersArgs'] maintainers: Maintainers is an optional list of maintainers of the application. The maintainers in this list maintain the the source code, images, and package for the application.
        ...
        :param List['ApplicationSpecDescriptorOwnersArgs'] owners: Owners is an optional list of the owners of the installed application. The owners of the application should be contacted in the event of a planned or unplanned disruption affecting the application.
    ...
    @property
    @pulumi.getter
    def icons(self) -> Optional[List['outputs.ApplicationSpecDescriptorIcons']]:
        """
    ...
    @property
    @pulumi.getter
    def links(self) -> Optional[List['outputs.ApplicationSpecDescriptorLinks']]:
        """
    ...
    @property
    @pulumi.getter
    def maintainers(self) -> Optional[List['outputs.ApplicationSpecDescriptorMaintainers']]:
        """
    ...
    @property
    @pulumi.getter
    def owners(self) -> Optional[List['outputs.ApplicationSpecDescriptorOwners']]:
        """
...
class ApplicationSpecInfoValueFromServiceRef(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str namespace: Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/
        :param str path: The optional HTTP path.
        :param float port: The optional port to select.
...
class ApplicationSpecSelector(dict):
    ...
    """
    def __init__(__self__, *,
                 match_expressions: Optional[List['outputs.ApplicationSpecSelectorMatchExpressions']] = None,
                 match_labels: Optional[Mapping[str, str]] = None):
        """
        Selector is a label query over kinds that created by the application. It must match the component objects' labels. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
        :param List['ApplicationSpecSelectorMatchExpressionsArgs'] match_expressions: matchExpressions is a list of label selector requirements. The requirements are ANDed.
    ...
    def match_expressions(self) -> Optional[List['outputs.ApplicationSpecSelectorMatchExpressions']]:
        """
...
class ApplicationStatus(dict):
    ...
    """
    def __init__(__self__, *,
                 components: Optional[List['outputs.ApplicationStatusComponents']] = None,
                 components_ready: Optional[str] = None,
                 conditions: Optional[List['outputs.ApplicationStatusConditions']] = None,
                 observed_generation: Optional[float] = None):
        """
        ApplicationStatus defines controller's the observed state of Application
        :param List['ApplicationStatusComponentsArgs'] components: Object status array for all matching objects
        :param str components_ready: ComponentsReady: status of the components in the format ready/total
        :param List['ApplicationStatusConditionsArgs'] conditions: Conditions represents the latest state of the object
        :param float observed_generation: ObservedGeneration is the most recent generation observed. It corresponds to the Object's generation, which is updated on mutation by the API Server.
        """
    ...
    @property
    @pulumi.getter
    def components(self) -> Optional[List['outputs.ApplicationStatusComponents']]:
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[List['outputs.ApplicationStatusConditions']]:
        """
