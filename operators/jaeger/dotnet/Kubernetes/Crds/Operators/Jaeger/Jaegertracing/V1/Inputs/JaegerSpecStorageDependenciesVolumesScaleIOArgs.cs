...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecStorageDependenciesVolumesScaleIOArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecStorageDependenciesVolumesScaleIOSecretRefArgs> SecretRef { get; set; } = null!;
        ...
        public JaegerSpecStorageDependenciesVolumesScaleIOArgs()
        {
        }
    }
}
