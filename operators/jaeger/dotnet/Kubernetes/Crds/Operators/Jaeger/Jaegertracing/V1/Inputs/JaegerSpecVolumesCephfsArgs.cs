...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecVolumesCephfsArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecVolumesCephfsSecretRefArgs>? SecretRef { get; set; }

        [Input("user")]
        public Input<string>? User { get; set; }

        public JaegerSpecVolumesCephfsArgs()
        {
        }
    }
}
