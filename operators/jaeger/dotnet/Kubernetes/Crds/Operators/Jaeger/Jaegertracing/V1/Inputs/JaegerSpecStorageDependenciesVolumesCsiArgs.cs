...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecStorageDependenciesVolumesCsiArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecStorageDependenciesVolumesCsiNodePublishSecretRefArgs>? NodePublishSecretRef { get; set; }
        ...
        public JaegerSpecStorageDependenciesVolumesCsiArgs()
        {
        }
    }
}
