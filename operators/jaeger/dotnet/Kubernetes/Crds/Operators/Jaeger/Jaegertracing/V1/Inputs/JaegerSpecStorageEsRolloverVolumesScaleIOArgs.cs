...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecStorageEsRolloverVolumesScaleIOArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecStorageEsRolloverVolumesScaleIOSecretRefArgs> SecretRef { get; set; } = null!;
        ...
        public JaegerSpecStorageEsRolloverVolumesScaleIOArgs()
        {
        }
    }
}
