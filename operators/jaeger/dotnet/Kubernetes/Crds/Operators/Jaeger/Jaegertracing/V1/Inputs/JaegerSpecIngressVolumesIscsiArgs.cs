...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecIngressVolumesIscsiArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecIngressVolumesIscsiSecretRefArgs>? SecretRef { get; set; }

        [Input("targetPortal", required: true)]
        public Input<string> TargetPortal { get; set; } = null!;

        public JaegerSpecIngressVolumesIscsiArgs()
        {
        }
    }
}
