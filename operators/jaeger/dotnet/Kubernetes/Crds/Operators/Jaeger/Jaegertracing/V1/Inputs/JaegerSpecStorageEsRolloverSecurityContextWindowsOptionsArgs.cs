...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecStorageEsRolloverSecurityContextWindowsOptionsArgs : Pulumi.ResourceArgs
    {
        ...
        public JaegerSpecStorageEsRolloverSecurityContextWindowsOptionsArgs()
        {
        }
    }
}
