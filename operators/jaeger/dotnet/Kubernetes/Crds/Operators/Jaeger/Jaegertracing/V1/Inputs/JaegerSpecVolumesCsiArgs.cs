...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecVolumesCsiArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecVolumesCsiNodePublishSecretRefArgs>? NodePublishSecretRef { get; set; }
        ...
        public JaegerSpecVolumesCsiArgs()
        {
        }
    }
}
