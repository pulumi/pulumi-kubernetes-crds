...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecAllInOneVolumesCsiArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecAllInOneVolumesCsiNodePublishSecretRefArgs>? NodePublishSecretRef { get; set; }
        ...
        public JaegerSpecAllInOneVolumesCsiArgs()
        {
        }
    }
}
