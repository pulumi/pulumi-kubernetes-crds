...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecQueryVolumesCephfsArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecQueryVolumesCephfsSecretRefArgs>? SecretRef { get; set; }

        [Input("user")]
        public Input<string>? User { get; set; }

        public JaegerSpecQueryVolumesCephfsArgs()
        {
        }
    }
}
