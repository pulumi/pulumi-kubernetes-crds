...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecVolumesScaleIOArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecVolumesScaleIOSecretRefArgs> SecretRef { get; set; } = null!;
        ...
        public JaegerSpecVolumesScaleIOArgs()
        {
        }
    }
}
