...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecStorageEsIndexCleanerVolumesScaleIOArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecStorageEsIndexCleanerVolumesScaleIOSecretRefArgs> SecretRef { get; set; } = null!;
        ...
        public JaegerSpecStorageEsIndexCleanerVolumesScaleIOArgs()
        {
        }
    }
}
