...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecStorageDependenciesVolumesGcePersistentDiskArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public JaegerSpecStorageDependenciesVolumesGcePersistentDiskArgs()
        {
        }
    }
}
