...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecStorageEsRolloverVolumesGcePersistentDiskArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public JaegerSpecStorageEsRolloverVolumesGcePersistentDiskArgs()
        {
        }
    }
}
