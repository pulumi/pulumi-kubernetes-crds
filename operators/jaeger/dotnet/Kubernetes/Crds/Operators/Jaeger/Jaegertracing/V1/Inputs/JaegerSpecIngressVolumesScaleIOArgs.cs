...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecIngressVolumesScaleIOArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecIngressVolumesScaleIOSecretRefArgs> SecretRef { get; set; } = null!;
        ...
        public JaegerSpecIngressVolumesScaleIOArgs()
        {
        }
    }
}
