...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecAllInOneVolumesRbdArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecAllInOneVolumesRbdSecretRefArgs>? SecretRef { get; set; }

        [Input("user")]
        public Input<string>? User { get; set; }

        public JaegerSpecAllInOneVolumesRbdArgs()
        {
        }
    }
}
