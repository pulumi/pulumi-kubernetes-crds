...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecAgentVolumesCsiArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1.JaegerSpecAgentVolumesCsiNodePublishSecretRefArgs>? NodePublishSecretRef { get; set; }
        ...
        public JaegerSpecAgentVolumesCsiArgs()
        {
        }
    }
}
