...
namespace Pulumi.Kubernetes.Types.Inputs.Jaegertracing.V1
{
    ...
    public class JaegerSpecStorageEsIndexCleanerVolumesVsphereVolumeArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public JaegerSpecStorageEsIndexCleanerVolumesVsphereVolumeArgs()
        {
        }
    }
}
