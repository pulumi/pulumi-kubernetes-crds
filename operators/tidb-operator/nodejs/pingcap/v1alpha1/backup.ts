...
export class Backup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:pingcap.com/v1alpha1:Backup';
    ...
    public readonly spec!: pulumi.Output<outputs.pingcap.v1alpha1.BackupSpec | undefined>;
...
export interface BackupArgs {
    ...
    readonly spec?: pulumi.Input<inputs.pingcap.v1alpha1.BackupSpec>;
}
