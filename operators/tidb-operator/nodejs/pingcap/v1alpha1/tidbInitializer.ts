...
export class TidbInitializer extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TidbInitializer {
        return new TidbInitializer(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:pingcap.com/v1alpha1:TidbInitializer';
    ...
    public readonly spec!: pulumi.Output<outputs.pingcap.v1alpha1.TidbInitializerSpec | undefined>;
     ...
     */
    constructor(name: string, args?: TidbInitializerArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            inputs["apiVersion"] = "pingcap.com/v1alpha1";
            inputs["kind"] = "TidbInitializer";
        ...
        super(TidbInitializer.__pulumiType, name, inputs, opts);
    }
}
...
export interface TidbInitializerArgs {
    ...
    readonly kind?: pulumi.Input<"TidbInitializer">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    readonly spec?: pulumi.Input<inputs.pingcap.v1alpha1.TidbInitializerSpec>;
}
