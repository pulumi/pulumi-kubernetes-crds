...
export class TidbCluster extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.pingcap.v1alpha1.TidbClusterSpec | undefined>;
    ...
    constructor(name: string, args?: TidbClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TidbCluster.__pulumiType, name, inputs, opts);
    }
}
...
export interface TidbClusterArgs {
    ...
    readonly kind?: pulumi.Input<"TidbCluster">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    readonly spec?: pulumi.Input<inputs.pingcap.v1alpha1.TidbClusterSpec>;
}
