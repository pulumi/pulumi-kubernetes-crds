...
export class BackupSchedule extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.pingcap.v1alpha1.BackupScheduleSpec | undefined>;
...
export interface BackupScheduleArgs {
    ...
    readonly kind?: pulumi.Input<"BackupSchedule">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    readonly spec?: pulumi.Input<inputs.pingcap.v1alpha1.BackupScheduleSpec>;
}
