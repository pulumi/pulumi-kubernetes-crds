...
namespace Pulumi.Kubernetes.Types.Inputs.Pingcap.V1Alpha1
{
    ...
    public class TidbClusterSpecTikvConfigRaftdbArgs : Pulumi.ResourceArgs
    {
        [Input("allow-concurrent-memtable-write")]
        public Input<bool>? Allow-concurrent-memtable-write { get; set; }
        ...
        [Input("defaultcf")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Pingcap.V1Alpha1.TidbClusterSpecTikvConfigRaftdbDefaultcfArgs>? Defaultcf { get; set; }
        ...
        [Input("wal-dir")]
        public Input<string>? Wal-dir { get; set; }

        [Input("wal-recovery-mode")]
        public Input<string>? Wal-recovery-mode { get; set; }
        ...
        public TidbClusterSpecTikvConfigRaftdbArgs()
        {
        }
    }
}
