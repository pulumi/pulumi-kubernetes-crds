...
namespace Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1
{
    ...
    /// </summary>
    public class FioSpecPodConfigArgs : Pulumi.ResourceArgs
    {
        [Input("podLabels")]
        ...
        /// </summary>
        [Input("podScheduling")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1.FioSpecPodConfigPodSchedulingArgs>? PodScheduling { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1.FioSpecPodConfigResourcesArgs>? Resources { get; set; }

        public FioSpecPodConfigArgs()
        {
        }
    }
}
