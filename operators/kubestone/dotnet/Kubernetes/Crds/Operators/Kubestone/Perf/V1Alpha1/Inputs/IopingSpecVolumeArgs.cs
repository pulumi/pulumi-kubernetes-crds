...
namespace Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1
{
    ...
    /// </summary>
    public class IopingSpecVolumeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1.IopingSpecVolumePersistentVolumeClaimSpecArgs>? PersistentVolumeClaimSpec { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1.IopingSpecVolumeVolumeSourceArgs> VolumeSource { get; set; } = null!;

        public IopingSpecVolumeArgs()
        {
        }
    }
}
