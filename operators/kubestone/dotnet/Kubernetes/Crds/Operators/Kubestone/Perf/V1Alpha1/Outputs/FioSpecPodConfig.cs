...
namespace Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1
{
    ...
    [OutputType]
    public sealed class FioSpecPodConfig
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.FioSpecPodConfigPodScheduling PodScheduling;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.FioSpecPodConfigResources Resources;

        [OutputConstructor]
        private FioSpecPodConfig(
            ImmutableDictionary<string, string> podLabels,

            Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.FioSpecPodConfigPodScheduling podScheduling,

            Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.FioSpecPodConfigResources resources)
        {
            PodLabels = podLabels;
