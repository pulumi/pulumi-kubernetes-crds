...
namespace Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1
{
    ...
    /// </summary>
    public class FioSpecVolumeVolumeSourceCephfsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1.FioSpecVolumeVolumeSourceCephfsSecretRefArgs>? SecretRef { get; set; }
        ...
        public FioSpecVolumeVolumeSourceCephfsArgs()
        {
        }
    }
}
