...
namespace Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1
{
    ...
    /// </summary>
    public class FioSpecVolumeVolumeSourceRbdArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1.FioSpecVolumeVolumeSourceRbdSecretRefArgs>? SecretRef { get; set; }
        ...
        public FioSpecVolumeVolumeSourceRbdArgs()
        {
        }
    }
}
