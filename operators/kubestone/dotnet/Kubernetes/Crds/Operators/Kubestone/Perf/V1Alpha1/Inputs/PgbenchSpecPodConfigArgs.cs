...
namespace Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1
{
    ...
    /// </summary>
    public class PgbenchSpecPodConfigArgs : Pulumi.ResourceArgs
    {
        [Input("podLabels")]
        ...
        /// </summary>
        [Input("podScheduling")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1.PgbenchSpecPodConfigPodSchedulingArgs>? PodScheduling { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1.PgbenchSpecPodConfigResourcesArgs>? Resources { get; set; }

        public PgbenchSpecPodConfigArgs()
        {
        }
    }
}
