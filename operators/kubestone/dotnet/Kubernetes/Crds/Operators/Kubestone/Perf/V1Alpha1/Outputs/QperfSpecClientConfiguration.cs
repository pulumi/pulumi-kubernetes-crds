...
namespace Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1
{
    ...
    [OutputType]
    public sealed class QperfSpecClientConfiguration
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.QperfSpecClientConfigurationPodScheduling PodScheduling;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.QperfSpecClientConfigurationResources Resources;

        [OutputConstructor]
        private QperfSpecClientConfiguration(
            bool hostNetwork,

            ImmutableDictionary<string, string> podLabels,

            Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.QperfSpecClientConfigurationPodScheduling podScheduling,

            Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.QperfSpecClientConfigurationResources resources)
        {
