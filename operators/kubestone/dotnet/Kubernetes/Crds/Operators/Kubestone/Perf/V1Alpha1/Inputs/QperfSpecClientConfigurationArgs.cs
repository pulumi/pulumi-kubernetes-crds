...
namespace Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1
{
    ...
    /// </summary>
    public class QperfSpecClientConfigurationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("podScheduling")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1.QperfSpecClientConfigurationPodSchedulingArgs>? PodScheduling { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Perf.V1Alpha1.QperfSpecClientConfigurationResourcesArgs>? Resources { get; set; }

        public QperfSpecClientConfigurationArgs()
        {
        }
    }
}
