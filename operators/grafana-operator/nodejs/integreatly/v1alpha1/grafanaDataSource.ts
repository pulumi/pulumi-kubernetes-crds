...
export class GrafanaDataSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:integreatly.org/v1alpha1:GrafanaDataSource';
    ...
    constructor(name: string, args?: GrafanaDataSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GrafanaDataSource.__pulumiType, name, inputs, opts);
    }
}
...
export interface GrafanaDataSourceArgs {
    ...
    readonly kind?: pulumi.Input<"GrafanaDataSource">;
