...
export class BlobContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1alpha2:BlobContainer';
    ...
    public readonly kind!: pulumi.Output<"BlobContainer" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * BlobContainerSpec defines the desired state of BlobContainer
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1alpha2.BlobContainerSpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1alpha2.BlobContainerStatus | undefined>;
...
export interface BlobContainerArgs {
    ...
    readonly kind?: pulumi.Input<"BlobContainer">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * BlobContainerSpec defines the desired state of BlobContainer
     */
    readonly spec?: pulumi.Input<inputs.azure.v1alpha2.BlobContainerSpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1alpha2.BlobContainerStatus>;
}
