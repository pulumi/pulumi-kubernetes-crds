...
export class AzureSqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1beta1:AzureSqlDatabase';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1beta1.AzureSqlDatabaseSpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1beta1.AzureSqlDatabaseStatus | undefined>;
...
export interface AzureSqlDatabaseArgs {
     ...
     * AzureSqlDatabaseSpec defines the desired state of AzureSqlDatabase
     */
    readonly spec?: pulumi.Input<inputs.azure.v1beta1.AzureSqlDatabaseSpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1beta1.AzureSqlDatabaseStatus>;
}
