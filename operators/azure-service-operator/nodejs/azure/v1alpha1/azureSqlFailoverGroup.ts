...
export class AzureSqlFailoverGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1alpha1:AzureSqlFailoverGroup';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1alpha1.AzureSqlFailoverGroupSpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1alpha1.AzureSqlFailoverGroupStatus | undefined>;
...
export interface AzureSqlFailoverGroupArgs {
     ...
     * AzureSqlFailoverGroupSpec defines the desired state of AzureSqlFailoverGroup
     */
    readonly spec?: pulumi.Input<inputs.azure.v1alpha1.AzureSqlFailoverGroupSpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1alpha1.AzureSqlFailoverGroupStatus>;
}
