...
export class KeyVault extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KeyVault {
        return new KeyVault(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1alpha1:KeyVault';
    ...
    public readonly kind!: pulumi.Output<"KeyVault" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * KeyVaultSpec defines the desired state of KeyVault
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1alpha1.KeyVaultSpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1alpha1.KeyVaultStatus | undefined>;
...
export interface KeyVaultArgs {
    ...
    readonly kind?: pulumi.Input<"KeyVault">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * KeyVaultSpec defines the desired state of KeyVault
     */
    readonly spec?: pulumi.Input<inputs.azure.v1alpha1.KeyVaultSpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1alpha1.KeyVaultStatus>;
}
