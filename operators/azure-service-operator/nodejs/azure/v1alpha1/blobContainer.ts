...
export class BlobContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1alpha1:BlobContainer';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1alpha1.BlobContainerSpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1alpha1.BlobContainerStatus | undefined>;
...
export interface BlobContainerArgs {
     ...
     * BlobContainerSpec defines the desired state of BlobContainer
     */
    readonly spec?: pulumi.Input<inputs.azure.v1alpha1.BlobContainerSpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1alpha1.BlobContainerStatus>;
}
