...
export class ConsumerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1alpha1:ConsumerGroup';
    ...
    public readonly kind!: pulumi.Output<"ConsumerGroup" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * ConsumerGroupSpec defines the desired state of ConsumerGroup
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1alpha1.ConsumerGroupSpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1alpha1.ConsumerGroupStatus | undefined>;
...
export interface ConsumerGroupArgs {
    ...
    readonly kind?: pulumi.Input<"ConsumerGroup">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * ConsumerGroupSpec defines the desired state of ConsumerGroup
     */
    readonly spec?: pulumi.Input<inputs.azure.v1alpha1.ConsumerGroupSpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1alpha1.ConsumerGroupStatus>;
}
