...
export class MySQLUser extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MySQLUser {
        return new MySQLUser(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1alpha1:MySQLUser';
    ...
    public readonly kind!: pulumi.Output<"MySQLUser" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * MySQLUserSpec defines the desired state of MySqlUser
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1alpha1.MySQLUserSpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1alpha1.MySQLUserStatus | undefined>;
    ...
    constructor(name: string, args?: MySQLUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MySQLUser.__pulumiType, name, inputs, opts);
    }
}
...
export interface MySQLUserArgs {
    ...
    readonly kind?: pulumi.Input<"MySQLUser">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * MySQLUserSpec defines the desired state of MySqlUser
     */
    readonly spec?: pulumi.Input<inputs.azure.v1alpha1.MySQLUserSpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1alpha1.MySQLUserStatus>;
}
