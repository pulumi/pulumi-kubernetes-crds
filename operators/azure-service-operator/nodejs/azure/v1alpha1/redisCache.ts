...
export class RedisCache extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RedisCache {
        return new RedisCache(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1alpha1:RedisCache';
    ...
    public readonly kind!: pulumi.Output<"RedisCache" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * RedisCacheSpec defines the desired state of RedisCache
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1alpha1.RedisCacheSpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1alpha1.RedisCacheStatus | undefined>;
...
export interface RedisCacheArgs {
    ...
    readonly kind?: pulumi.Input<"RedisCache">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * RedisCacheSpec defines the desired state of RedisCache
     */
    readonly spec?: pulumi.Input<inputs.azure.v1alpha1.RedisCacheSpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1alpha1.RedisCacheStatus>;
}
