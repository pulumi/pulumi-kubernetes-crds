...
export class PostgreSQLFirewallRule extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PostgreSQLFirewallRule {
        return new PostgreSQLFirewallRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1alpha1:PostgreSQLFirewallRule';
    ...
    public readonly kind!: pulumi.Output<"PostgreSQLFirewallRule" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * PostgreSQLFirewallRuleSpec defines the desired state of PostgreSQLFirewallRule
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1alpha1.PostgreSQLFirewallRuleSpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1alpha1.PostgreSQLFirewallRuleStatus | undefined>;
    ...
    constructor(name: string, args?: PostgreSQLFirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            inputs["kind"] = "PostgreSQLFirewallRule";
        ...
        super(PostgreSQLFirewallRule.__pulumiType, name, inputs, opts);
    }
}
...
export interface PostgreSQLFirewallRuleArgs {
    ...
    readonly kind?: pulumi.Input<"PostgreSQLFirewallRule">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * PostgreSQLFirewallRuleSpec defines the desired state of PostgreSQLFirewallRule
     */
    readonly spec?: pulumi.Input<inputs.azure.v1alpha1.PostgreSQLFirewallRuleSpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1alpha1.PostgreSQLFirewallRuleStatus>;
}
