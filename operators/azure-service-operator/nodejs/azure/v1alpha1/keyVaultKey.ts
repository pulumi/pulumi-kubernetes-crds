...
export class KeyVaultKey extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KeyVaultKey {
        return new KeyVaultKey(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1alpha1:KeyVaultKey';
    ...
    public readonly kind!: pulumi.Output<"KeyVaultKey" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * KeyVaultKeySpec defines the desired state of KeyVaultKey
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1alpha1.KeyVaultKeySpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1alpha1.KeyVaultKeyStatus | undefined>;
    ...
    constructor(name: string, args?: KeyVaultKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KeyVaultKey.__pulumiType, name, inputs, opts);
    }
}
...
export interface KeyVaultKeyArgs {
    ...
    readonly kind?: pulumi.Input<"KeyVaultKey">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * KeyVaultKeySpec defines the desired state of KeyVaultKey
     */
    readonly spec?: pulumi.Input<inputs.azure.v1alpha1.KeyVaultKeySpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1alpha1.KeyVaultKeyStatus>;
}
