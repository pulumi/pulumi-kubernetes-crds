...
export class PostgreSQLServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:azure.microsoft.com/v1alpha1:PostgreSQLServer';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.azure.v1alpha1.PostgreSQLServerSpec | undefined>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    public readonly status!: pulumi.Output<outputs.azure.v1alpha1.PostgreSQLServerStatus | undefined>;
...
export interface PostgreSQLServerArgs {
     ...
     * PostgreSQLServerSpec defines the desired state of PostgreSQLServer
     */
    readonly spec?: pulumi.Input<inputs.azure.v1alpha1.PostgreSQLServerSpec>;
    /**
     * ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
     */
    readonly status?: pulumi.Input<inputs.azure.v1alpha1.PostgreSQLServerStatus>;
}
