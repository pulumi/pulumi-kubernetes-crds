...
func NewMySQLServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:azure.microsoft.com/v1alpha2:MySQLServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMySQLServer(ctx *pulumi.Context,
	...
	var resource MySQLServer
	err := ctx.ReadResource("kubernetes:azure.microsoft.com/v1alpha2:MySQLServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
