...
func NewAzureSqlFirewallRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:azure.microsoft.com/v1beta1:AzureSqlFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureSqlFirewallRule(ctx *pulumi.Context,
	...
	var resource AzureSqlFirewallRule
	err := ctx.ReadResource("kubernetes:azure.microsoft.com/v1beta1:AzureSqlFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
