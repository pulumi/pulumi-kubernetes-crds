...
namespace Pulumi.Kubernetes.Types.Inputs.Azure.V1Alpha2
{
    ...
    public class MySQLServerSpecArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Azure.V1Alpha2.MySQLServerSpecReplicaPropertiesArgs>? ReplicaProperties { get; set; }
        ...
        [Input("sku")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Azure.V1Alpha2.MySQLServerSpecSkuArgs>? Sku { get; set; }

        [Input("sslEnforcement")]
        public Input<string>? SslEnforcement { get; set; }

        [Input("storageProfile")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Azure.V1Alpha2.MySQLServerSpecStorageProfileArgs>? StorageProfile { get; set; }
