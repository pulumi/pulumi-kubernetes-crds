...
class Eventhub(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['EventhubSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['EventhubStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['EventhubSpecArgs']] spec: EventhubSpec defines the desired state of Eventhub
        :param pulumi.Input[pulumi.InputType['EventhubStatusArgs']] status: ASOStatus (AzureServiceOperatorsStatus) defines the observed state of resource actions
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'Eventhub'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(Eventhub, __self__).__init__(
            'kubernetes:azure.microsoft.com/v1alpha1:Eventhub',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.EventhubSpec']]:
        """
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.EventhubStatus']]:
        """
