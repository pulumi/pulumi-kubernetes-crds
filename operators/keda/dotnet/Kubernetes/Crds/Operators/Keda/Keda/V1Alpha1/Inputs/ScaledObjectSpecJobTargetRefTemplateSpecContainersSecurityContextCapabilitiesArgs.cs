...
namespace Pulumi.Kubernetes.Types.Inputs.Keda.V1Alpha1
{
    ...
    /// </summary>
    public class ScaledObjectSpecJobTargetRefTemplateSpecContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public ScaledObjectSpecJobTargetRefTemplateSpecContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
