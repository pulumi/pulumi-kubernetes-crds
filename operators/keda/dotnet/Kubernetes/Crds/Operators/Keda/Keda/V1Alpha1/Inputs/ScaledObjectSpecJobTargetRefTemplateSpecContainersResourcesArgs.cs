...
namespace Pulumi.Kubernetes.Types.Inputs.Keda.V1Alpha1
{
    ...
    /// </summary>
    public class ScaledObjectSpecJobTargetRefTemplateSpecContainersResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public ScaledObjectSpecJobTargetRefTemplateSpecContainersResourcesArgs()
        {
        }
    }
}
