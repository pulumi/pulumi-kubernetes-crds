...
namespace Pulumi.Kubernetes.Types.Inputs.Keda.V1Alpha1
{
    ...
    /// </summary>
    public class ScaledObjectSpecJobTargetRefTemplateSpecInitContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public ScaledObjectSpecJobTargetRefTemplateSpecInitContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
