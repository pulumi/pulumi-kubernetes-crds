...
namespace Pulumi.Kubernetes.Types.Outputs.Keda.V1Alpha1
{
    ...
    [OutputType]
    public sealed class ScaledObjectSpecJobTargetRefTemplateSpecInitContainersResources
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ScaledObjectSpecJobTargetRefTemplateSpecInitContainersResources(
