...
namespace Pulumi.Kubernetes.Types.Outputs.Keda.V1Alpha1
{
    ...
    [OutputType]
    public sealed class ScaledObjectSpecJobTargetRefTemplateSpecContainersVolumeMounts
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ScaledObjectSpecJobTargetRefTemplateSpecContainersVolumeMounts(
            string mountPath,
