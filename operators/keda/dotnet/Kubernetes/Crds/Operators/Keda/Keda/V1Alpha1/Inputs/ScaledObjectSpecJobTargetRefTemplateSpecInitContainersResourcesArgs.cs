...
namespace Pulumi.Kubernetes.Types.Inputs.Keda.V1Alpha1
{
    ...
    /// </summary>
    public class ScaledObjectSpecJobTargetRefTemplateSpecInitContainersResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public ScaledObjectSpecJobTargetRefTemplateSpecInitContainersResourcesArgs()
        {
        }
    }
}
