...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Alpha1
{
    ...
    public class KafkaMirrorMaker2SpecTemplateConnectContainerSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public KafkaMirrorMaker2SpecTemplateConnectContainerSecurityContextCapabilitiesArgs()
        {
        }
    }
}
