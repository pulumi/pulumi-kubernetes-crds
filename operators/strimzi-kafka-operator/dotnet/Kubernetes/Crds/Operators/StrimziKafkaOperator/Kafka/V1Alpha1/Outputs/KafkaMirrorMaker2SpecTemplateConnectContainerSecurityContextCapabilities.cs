...
namespace Pulumi.Kubernetes.Types.Outputs.Kafka.V1Alpha1
{
    ...
    [OutputType]
    public sealed class KafkaMirrorMaker2SpecTemplateConnectContainerSecurityContextCapabilities
    {
        public readonly ImmutableArray<string> Add;
        public readonly ImmutableArray<string> Drop;

        [OutputConstructor]
        private KafkaMirrorMaker2SpecTemplateConnectContainerSecurityContextCapabilities(
