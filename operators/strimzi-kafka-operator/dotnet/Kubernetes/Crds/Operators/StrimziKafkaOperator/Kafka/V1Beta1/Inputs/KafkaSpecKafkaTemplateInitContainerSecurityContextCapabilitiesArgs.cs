...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    public class KafkaSpecKafkaTemplateInitContainerSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public KafkaSpecKafkaTemplateInitContainerSecurityContextCapabilitiesArgs()
        {
        }
    }
}
