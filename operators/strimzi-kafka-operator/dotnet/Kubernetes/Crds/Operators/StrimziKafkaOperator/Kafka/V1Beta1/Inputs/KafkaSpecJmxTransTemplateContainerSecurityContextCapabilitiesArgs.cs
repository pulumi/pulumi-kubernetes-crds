...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    public class KafkaSpecJmxTransTemplateContainerSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public KafkaSpecJmxTransTemplateContainerSecurityContextCapabilitiesArgs()
        {
        }
    }
}
