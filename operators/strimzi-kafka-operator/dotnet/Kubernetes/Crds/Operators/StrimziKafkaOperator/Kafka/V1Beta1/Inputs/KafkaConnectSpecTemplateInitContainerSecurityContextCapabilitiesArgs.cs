...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    public class KafkaConnectSpecTemplateInitContainerSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public KafkaConnectSpecTemplateInitContainerSecurityContextCapabilitiesArgs()
        {
        }
    }
}
