...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Alpha1
{
    ...
    public class KafkaBridgeSpecTemplateBridgeContainerSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public KafkaBridgeSpecTemplateBridgeContainerSecurityContextCapabilitiesArgs()
        {
        }
    }
}
