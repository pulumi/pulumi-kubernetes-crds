...
namespace Pulumi.Kubernetes.Types.Outputs.Kafka.V1Alpha1
{
    ...
    [OutputType]
    public sealed class KafkaMirrorMaker2SpecTemplatePodSecurityContextWindowsOptions
    {
        ...
        [OutputConstructor]
        private KafkaMirrorMaker2SpecTemplatePodSecurityContextWindowsOptions(
