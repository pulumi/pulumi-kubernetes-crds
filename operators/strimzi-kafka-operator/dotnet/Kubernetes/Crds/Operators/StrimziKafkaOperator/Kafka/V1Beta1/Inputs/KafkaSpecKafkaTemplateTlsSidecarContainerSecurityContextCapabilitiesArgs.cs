...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    public class KafkaSpecKafkaTemplateTlsSidecarContainerSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public KafkaSpecKafkaTemplateTlsSidecarContainerSecurityContextCapabilitiesArgs()
        {
        }
    }
}
