...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    /// </summary>
    public class KafkaSpecKafkaTemplatePerPodServiceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("metadata")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1.KafkaSpecKafkaTemplatePerPodServiceMetadataArgs>? Metadata { get; set; }

        public KafkaSpecKafkaTemplatePerPodServiceArgs()
        {
        }
    }
}
