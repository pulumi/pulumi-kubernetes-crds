...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    public class KafkaConnectSpecExternalConfigurationEnvArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1.KafkaConnectSpecExternalConfigurationEnvValueFromArgs> ValueFrom { get; set; } = null!;

        public KafkaConnectSpecExternalConfigurationEnvArgs()
        {
        }
    }
}
