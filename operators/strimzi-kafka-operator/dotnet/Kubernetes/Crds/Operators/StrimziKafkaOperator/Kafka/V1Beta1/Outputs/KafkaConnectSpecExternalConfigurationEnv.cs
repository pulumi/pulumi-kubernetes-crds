...
namespace Pulumi.Kubernetes.Types.Outputs.Kafka.V1Beta1
{
    ...
    [OutputType]
    public sealed class KafkaConnectSpecExternalConfigurationEnv
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Kafka.V1Beta1.KafkaConnectSpecExternalConfigurationEnvValueFrom ValueFrom;

        [OutputConstructor]
        private KafkaConnectSpecExternalConfigurationEnv(
            string name,

            Pulumi.Kubernetes.Types.Outputs.Kafka.V1Beta1.KafkaConnectSpecExternalConfigurationEnvValueFrom valueFrom)
        {
            Name = name;
            ValueFrom = valueFrom;
        }
