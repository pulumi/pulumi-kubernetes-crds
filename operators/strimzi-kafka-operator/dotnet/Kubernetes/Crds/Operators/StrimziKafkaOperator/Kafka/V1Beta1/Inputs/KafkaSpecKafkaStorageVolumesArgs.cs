...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    public class KafkaSpecKafkaStorageVolumesArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("overrides")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1.KafkaSpecKafkaStorageVolumesOverridesArgs>? _overrides;

        /// <summary>
        /// Overrides for individual brokers. The `overrides` field allows to specify a different configuration for different brokers.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1.KafkaSpecKafkaStorageVolumesOverridesArgs> Overrides
        {
            get => _overrides ?? (_overrides = new InputList<Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1.KafkaSpecKafkaStorageVolumesOverridesArgs>());
        ...
        public KafkaSpecKafkaStorageVolumesArgs()
        {
        }
    }
}
