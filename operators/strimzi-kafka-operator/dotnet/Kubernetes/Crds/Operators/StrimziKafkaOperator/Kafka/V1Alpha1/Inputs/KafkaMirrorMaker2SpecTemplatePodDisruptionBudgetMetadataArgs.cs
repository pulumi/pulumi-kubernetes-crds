...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Alpha1
{
    ...
    /// </summary>
    public class KafkaMirrorMaker2SpecTemplatePodDisruptionBudgetMetadataArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public KafkaMirrorMaker2SpecTemplatePodDisruptionBudgetMetadataArgs()
        {
        }
    }
}
