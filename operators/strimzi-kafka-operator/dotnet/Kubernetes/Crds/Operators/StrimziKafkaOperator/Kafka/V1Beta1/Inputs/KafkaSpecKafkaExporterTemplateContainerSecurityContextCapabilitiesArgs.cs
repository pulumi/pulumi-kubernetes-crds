...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    public class KafkaSpecKafkaExporterTemplateContainerSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public KafkaSpecKafkaExporterTemplateContainerSecurityContextCapabilitiesArgs()
        {
        }
    }
}
