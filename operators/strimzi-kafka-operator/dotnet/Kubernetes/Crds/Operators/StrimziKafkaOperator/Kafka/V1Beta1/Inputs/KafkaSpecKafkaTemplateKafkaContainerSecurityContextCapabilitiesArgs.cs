...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    public class KafkaSpecKafkaTemplateKafkaContainerSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public KafkaSpecKafkaTemplateKafkaContainerSecurityContextCapabilitiesArgs()
        {
        }
    }
}
