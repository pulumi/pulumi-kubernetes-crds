...
namespace Pulumi.Kubernetes.Types.Outputs.Kafka.V1Beta1
{
    ...
    [OutputType]
    public sealed class KafkaSpecEntityOperatorTemplatePodSecurityContextWindowsOptions
    {
        public readonly string GmsaCredentialSpec;
        public readonly string GmsaCredentialSpecName;

        [OutputConstructor]
        private KafkaSpecEntityOperatorTemplatePodSecurityContextWindowsOptions(
