...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    public class KafkaConnectS2ISpecTemplateInitContainerSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public KafkaConnectS2ISpecTemplateInitContainerSecurityContextCapabilitiesArgs()
        {
        }
    }
}
