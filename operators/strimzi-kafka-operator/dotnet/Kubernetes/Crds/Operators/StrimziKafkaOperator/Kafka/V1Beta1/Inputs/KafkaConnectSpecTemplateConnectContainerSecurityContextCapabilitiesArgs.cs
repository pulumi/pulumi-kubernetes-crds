...
namespace Pulumi.Kubernetes.Types.Inputs.Kafka.V1Beta1
{
    ...
    public class KafkaConnectSpecTemplateConnectContainerSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public KafkaConnectSpecTemplateConnectContainerSecurityContextCapabilitiesArgs()
        {
        }
    }
}
