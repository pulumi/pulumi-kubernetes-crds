...
export class KafkaConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:kafka.strimzi.io/v1alpha1:KafkaConnector';
    ...
    public readonly kind!: pulumi.Output<"KafkaConnector" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * The specification of the Kafka Connector.
     */
    public readonly spec!: pulumi.Output<outputs.kafka.v1alpha1.KafkaConnectorSpec | undefined>;
    /**
     * The status of the Kafka Connector.
     */
    public readonly status!: pulumi.Output<outputs.kafka.v1alpha1.KafkaConnectorStatus | undefined>;
...
export interface KafkaConnectorArgs {
    ...
    readonly kind?: pulumi.Input<"KafkaConnector">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * The specification of the Kafka Connector.
     */
    readonly spec?: pulumi.Input<inputs.kafka.v1alpha1.KafkaConnectorSpec>;
    /**
     * The status of the Kafka Connector.
     */
    readonly status?: pulumi.Input<inputs.kafka.v1alpha1.KafkaConnectorStatus>;
}
