...
class KafkaMirrorMaker(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['KafkaMirrorMakerSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['KafkaMirrorMakerStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['KafkaMirrorMakerSpecArgs']] spec: The specification of Kafka MirrorMaker.
        :param pulumi.Input[pulumi.InputType['KafkaMirrorMakerStatusArgs']] status: The status of Kafka MirrorMaker.
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'KafkaMirrorMaker'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(KafkaMirrorMaker, __self__).__init__(
            'kubernetes:kafka.strimzi.io/v1beta1:KafkaMirrorMaker',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'KafkaMirrorMaker':
        """
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.KafkaMirrorMakerSpec']]:
        """
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.KafkaMirrorMakerStatus']]:
        """
