...
class Kafka(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['KafkaSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['KafkaStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['KafkaSpecArgs']] spec: The specification of the Kafka and ZooKeeper clusters, and Topic Operator.
        :param pulumi.Input[pulumi.InputType['KafkaStatusArgs']] status: The status of the Kafka and ZooKeeper clusters, and Topic Operator.
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'Kafka'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(Kafka, __self__).__init__(
            'kubernetes:kafka.strimzi.io/v1beta1:Kafka',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Kafka':
        """
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.KafkaSpec']]:
        """
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.KafkaStatus']]:
        """
