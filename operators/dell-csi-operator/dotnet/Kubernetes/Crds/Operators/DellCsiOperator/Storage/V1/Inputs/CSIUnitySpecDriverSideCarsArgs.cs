...
namespace Pulumi.Kubernetes.Types.Inputs.Storage.V1
{
    ...
    /// </summary>
    public class CSIUnitySpecDriverSideCarsArgs : Pulumi.ResourceArgs
    {
        [Input("args")]
        ...
        [Input("envs")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIUnitySpecDriverSideCarsEnvsArgs>? _envs;

        /// <summary>
        /// Envs is the set of environment variables for the container
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIUnitySpecDriverSideCarsEnvsArgs> Envs
        {
            get => _envs ?? (_envs = new InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIUnitySpecDriverSideCarsEnvsArgs>());
            set => _envs = value;
        }
