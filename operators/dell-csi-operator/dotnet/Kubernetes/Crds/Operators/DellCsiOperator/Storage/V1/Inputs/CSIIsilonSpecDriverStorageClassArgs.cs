...
namespace Pulumi.Kubernetes.Types.Inputs.Storage.V1
{
    ...
    /// </summary>
    public class CSIIsilonSpecDriverStorageClassArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIIsilonSpecDriverStorageClassAllowedTopologiesArgs>? _allowedTopologies;

        /// <summary>
        /// Restrict the node topologies where volumes can be dynamically provisioned.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIIsilonSpecDriverStorageClassAllowedTopologiesArgs> AllowedTopologies
        {
            get => _allowedTopologies ?? (_allowedTopologies = new InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIIsilonSpecDriverStorageClassAllowedTopologiesArgs>());
        ...
        public CSIIsilonSpecDriverStorageClassArgs()
        {
        }
    }
}
