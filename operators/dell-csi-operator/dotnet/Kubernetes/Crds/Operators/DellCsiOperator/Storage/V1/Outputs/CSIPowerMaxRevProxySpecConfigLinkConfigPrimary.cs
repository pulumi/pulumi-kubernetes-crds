...
namespace Pulumi.Kubernetes.Types.Outputs.Storage.V1
{
    ...
    [OutputType]
    public sealed class CSIPowerMaxRevProxySpecConfigLinkConfigPrimary
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Storage.V1.CSIPowerMaxRevProxySpecConfigLinkConfigPrimaryLimits Limits;
        public readonly bool SkipCertificateValidation;
        public readonly string Url;

        [OutputConstructor]
        private CSIPowerMaxRevProxySpecConfigLinkConfigPrimary(
            string arrayCredentialSecret,

            string certSecret,

            Pulumi.Kubernetes.Types.Outputs.Storage.V1.CSIPowerMaxRevProxySpecConfigLinkConfigPrimaryLimits limits,
