...
namespace Pulumi.Kubernetes.Types.Inputs.Storage.V1
{
    ...
    public class CSIIsilonSpecDriverSideCarsArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("tolerations")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIIsilonSpecDriverSideCarsTolerationsArgs>? _tolerations;

        /// <summary>
        /// Tolerations is the list of tolerations for the driver pods
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIIsilonSpecDriverSideCarsTolerationsArgs> Tolerations
        {
            get => _tolerations ?? (_tolerations = new InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIIsilonSpecDriverSideCarsTolerationsArgs>());
