...
namespace Pulumi.Kubernetes.Types.Inputs.Storage.V1
{
    ...
    /// </summary>
    public class CSIUnityStatusArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// ControllerStatus is the status of Controller pods
        /// </summary>
        [Input("controllerStatus")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIUnityStatusControllerStatusArgs>? ControllerStatus { get; set; }
        ...
        /// </summary>
        [Input("lastUpdate")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIUnityStatusLastUpdateArgs>? LastUpdate { get; set; }

        /// <summary>
        /// NodeStatus is the status of Controller pods
        /// </summary>
        [Input("nodeStatus")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIUnityStatusNodeStatusArgs>? NodeStatus { get; set; }
