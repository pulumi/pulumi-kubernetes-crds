...
namespace Pulumi.Kubernetes.Types.Inputs.Storage.V1
{
    ...
    /// </summary>
    public class CSIPowerMaxSpecDriverStorageClassArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIPowerMaxSpecDriverStorageClassAllowedTopologiesArgs>? _allowedTopologies;

        /// <summary>
        /// Restrict the node topologies where volumes can be dynamically provisioned.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIPowerMaxSpecDriverStorageClassAllowedTopologiesArgs> AllowedTopologies
        {
            get => _allowedTopologies ?? (_allowedTopologies = new InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSIPowerMaxSpecDriverStorageClassAllowedTopologiesArgs>());
        ...
        public CSIPowerMaxSpecDriverStorageClassArgs()
        {
        }
    }
}
