...
namespace Pulumi.Kubernetes.Types.Outputs.Datadoghq.V1Alpha1
{
    ...
    [OutputType]
    public sealed class DatadogAgentSpecAgentSystemProbeSecurityContextWindowsOptions
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DatadogAgentSpecAgentSystemProbeSecurityContextWindowsOptions(
