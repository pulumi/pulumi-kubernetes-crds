...
namespace Pulumi.Kubernetes.Types.Outputs.Datadoghq.V1Alpha1
{
    ...
    [OutputType]
    public sealed class DatadogAgentSpecClusterAgentImage
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Datadoghq.V1Alpha1.DatadogAgentSpecClusterAgentImagePullSecrets> PullSecrets;

        [OutputConstructor]
        private DatadogAgentSpecClusterAgentImage(
            string name,

            string pullPolicy,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Datadoghq.V1Alpha1.DatadogAgentSpecClusterAgentImagePullSecrets> pullSecrets)
        {
            Name = name;
