...
namespace Pulumi.Kubernetes.Types.Inputs.Datadoghq.V1Alpha1
{
    ...
    /// </summary>
    public class DatadogAgentSpecAgentImageArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("pullSecrets")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Datadoghq.V1Alpha1.DatadogAgentSpecAgentImagePullSecretsArgs>? _pullSecrets;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Datadoghq.V1Alpha1.DatadogAgentSpecAgentImagePullSecretsArgs> PullSecrets
        {
            get => _pullSecrets ?? (_pullSecrets = new InputList<Pulumi.Kubernetes.Types.Inputs.Datadoghq.V1Alpha1.DatadogAgentSpecAgentImagePullSecretsArgs>());
            set => _pullSecrets = value;
        }

        public DatadogAgentSpecAgentImageArgs()
        {
        }
    }
}
