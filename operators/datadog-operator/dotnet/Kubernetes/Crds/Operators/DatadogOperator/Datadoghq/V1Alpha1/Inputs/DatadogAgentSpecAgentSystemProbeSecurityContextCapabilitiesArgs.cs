...
namespace Pulumi.Kubernetes.Types.Inputs.Datadoghq.V1Alpha1
{
    ...
    /// </summary>
    public class DatadogAgentSpecAgentSystemProbeSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public DatadogAgentSpecAgentSystemProbeSecurityContextCapabilitiesArgs()
        {
        }
    }
}
