...
namespace Pulumi.Kubernetes.Types.Outputs.Datadoghq.V1Alpha1
{
    ...
    [OutputType]
    public sealed class DatadogAgentSpecClusterChecksRunnerConfigVolumesVsphereVolume
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DatadogAgentSpecClusterChecksRunnerConfigVolumesVsphereVolume(
            string fsType,
