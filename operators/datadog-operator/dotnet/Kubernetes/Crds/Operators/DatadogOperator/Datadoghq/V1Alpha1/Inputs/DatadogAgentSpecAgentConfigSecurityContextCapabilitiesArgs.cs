...
namespace Pulumi.Kubernetes.Types.Inputs.Datadoghq.V1Alpha1
{
    ...
    /// </summary>
    public class DatadogAgentSpecAgentConfigSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public DatadogAgentSpecAgentConfigSecurityContextCapabilitiesArgs()
        {
        }
    }
}
