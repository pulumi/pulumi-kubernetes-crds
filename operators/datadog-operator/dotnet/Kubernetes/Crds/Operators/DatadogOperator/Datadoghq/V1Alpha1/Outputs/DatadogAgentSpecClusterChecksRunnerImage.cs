...
namespace Pulumi.Kubernetes.Types.Outputs.Datadoghq.V1Alpha1
{
    ...
    [OutputType]
    public sealed class DatadogAgentSpecClusterChecksRunnerImage
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Datadoghq.V1Alpha1.DatadogAgentSpecClusterChecksRunnerImagePullSecrets> PullSecrets;

        [OutputConstructor]
        private DatadogAgentSpecClusterChecksRunnerImage(
            string name,

            string pullPolicy,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Datadoghq.V1Alpha1.DatadogAgentSpecClusterChecksRunnerImagePullSecrets> pullSecrets)
        {
            Name = name;
