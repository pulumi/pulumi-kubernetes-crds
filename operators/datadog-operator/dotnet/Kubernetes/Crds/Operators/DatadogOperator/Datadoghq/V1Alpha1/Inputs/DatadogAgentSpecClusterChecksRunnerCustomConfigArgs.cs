...
namespace Pulumi.Kubernetes.Types.Inputs.Datadoghq.V1Alpha1
{
    ...
    /// </summary>
    public class DatadogAgentSpecClusterChecksRunnerCustomConfigArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("configMap")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Datadoghq.V1Alpha1.DatadogAgentSpecClusterChecksRunnerCustomConfigConfigMapArgs>? ConfigMap { get; set; }

        public DatadogAgentSpecClusterChecksRunnerCustomConfigArgs()
        {
        }
    }
}
