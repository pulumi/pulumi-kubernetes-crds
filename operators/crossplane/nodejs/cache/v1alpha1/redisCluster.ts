...
export class RedisCluster extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RedisCluster {
        return new RedisCluster(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cache.crossplane.io/v1alpha1:RedisCluster';
    ...
    public readonly apiVersion!: pulumi.Output<"cache.crossplane.io/v1alpha1" | undefined>;
    public readonly kind!: pulumi.Output<"RedisCluster" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * RedisClusterSpec specifies the desired state of a RedisCluster.
     */
    public readonly spec!: pulumi.Output<outputs.cache.v1alpha1.RedisClusterSpec | undefined>;
    /**
     * A ResourceClaimStatus represents the observed status of a resource claim.
     */
    public readonly status!: pulumi.Output<outputs.cache.v1alpha1.RedisClusterStatus | undefined>;
    ...
    constructor(name: string, args?: RedisClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            inputs["apiVersion"] = "cache.crossplane.io/v1alpha1";
            inputs["kind"] = "RedisCluster";
        ...
        super(RedisCluster.__pulumiType, name, inputs, opts);
    }
}
...
export interface RedisClusterArgs {
    readonly apiVersion?: pulumi.Input<"cache.crossplane.io/v1alpha1">;
    readonly kind?: pulumi.Input<"RedisCluster">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * RedisClusterSpec specifies the desired state of a RedisCluster.
     */
    readonly spec?: pulumi.Input<inputs.cache.v1alpha1.RedisClusterSpec>;
    /**
     * A ResourceClaimStatus represents the observed status of a resource claim.
     */
    readonly status?: pulumi.Input<inputs.cache.v1alpha1.RedisClusterStatus>;
}
