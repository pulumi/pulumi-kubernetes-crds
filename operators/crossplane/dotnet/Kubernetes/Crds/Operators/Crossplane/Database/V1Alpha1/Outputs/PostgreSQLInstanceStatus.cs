...
namespace Pulumi.Kubernetes.Types.Outputs.Database.V1Alpha1
{
    ...
    [OutputType]
    public sealed class PostgreSQLInstanceStatus
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Database.V1Alpha1.PostgreSQLInstanceStatusConditions> Conditions;

        [OutputConstructor]
        private PostgreSQLInstanceStatus(
            string bindingPhase,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Database.V1Alpha1.PostgreSQLInstanceStatusConditions> conditions)
        {
