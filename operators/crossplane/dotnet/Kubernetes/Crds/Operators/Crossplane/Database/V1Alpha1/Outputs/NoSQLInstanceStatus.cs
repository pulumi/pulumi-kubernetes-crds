...
namespace Pulumi.Kubernetes.Types.Outputs.Database.V1Alpha1
{
    ...
    [OutputType]
    public sealed class NoSQLInstanceStatus
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Database.V1Alpha1.NoSQLInstanceStatusConditions> Conditions;

        [OutputConstructor]
        private NoSQLInstanceStatus(
            string bindingPhase,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Database.V1Alpha1.NoSQLInstanceStatusConditions> conditions)
        {
