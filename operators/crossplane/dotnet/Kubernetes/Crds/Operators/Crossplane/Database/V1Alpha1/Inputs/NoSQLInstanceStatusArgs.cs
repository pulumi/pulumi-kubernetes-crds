...
namespace Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1
{
    ...
    /// </summary>
    public class NoSQLInstanceStatusArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.NoSQLInstanceStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Conditions of the resource.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.NoSQLInstanceStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.NoSQLInstanceStatusConditionsArgs>());
            set => _conditions = value;
        }

        public NoSQLInstanceStatusArgs()
        {
        }
    }
}
