...
namespace Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1
{
    ...
    /// </summary>
    public class NoSQLInstanceSpecArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("classRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.NoSQLInstanceSpecClassRefArgs>? ClassRef { get; set; }
        ...
        /// </summary>
        [Input("classSelector")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.NoSQLInstanceSpecClassSelectorArgs>? ClassSelector { get; set; }
        ...
        /// </summary>
        [Input("resourceRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.NoSQLInstanceSpecResourceRefArgs>? ResourceRef { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.NoSQLInstanceSpecWriteConnectionSecretToRefArgs>? WriteConnectionSecretToRef { get; set; }

        public NoSQLInstanceSpecArgs()
        {
        }
    }
}
