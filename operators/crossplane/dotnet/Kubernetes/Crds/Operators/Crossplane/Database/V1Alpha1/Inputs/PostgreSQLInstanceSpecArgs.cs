...
namespace Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1
{
    ...
    /// </summary>
    public class PostgreSQLInstanceSpecArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("classRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.PostgreSQLInstanceSpecClassRefArgs>? ClassRef { get; set; }
        ...
        /// </summary>
        [Input("classSelector")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.PostgreSQLInstanceSpecClassSelectorArgs>? ClassSelector { get; set; }
        ...
        /// </summary>
        [Input("resourceRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.PostgreSQLInstanceSpecResourceRefArgs>? ResourceRef { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Database.V1Alpha1.PostgreSQLInstanceSpecWriteConnectionSecretToRefArgs>? WriteConnectionSecretToRef { get; set; }

        public PostgreSQLInstanceSpecArgs()
        {
        }
    }
}
