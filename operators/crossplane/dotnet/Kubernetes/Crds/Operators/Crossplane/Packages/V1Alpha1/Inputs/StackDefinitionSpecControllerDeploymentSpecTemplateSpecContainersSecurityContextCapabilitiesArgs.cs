...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class StackDefinitionSpecControllerDeploymentSpecTemplateSpecContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public StackDefinitionSpecControllerDeploymentSpecTemplateSpecContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
