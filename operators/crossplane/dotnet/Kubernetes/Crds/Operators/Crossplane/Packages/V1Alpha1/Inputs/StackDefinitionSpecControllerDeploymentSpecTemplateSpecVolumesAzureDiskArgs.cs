...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesAzureDiskArgs : Pulumi.ResourceArgs
    {
        [Input("cachingMode")]
        ...
        public StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesAzureDiskArgs()
        {
        }
    }
}
