...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class StackDefinitionSpecControllerDeploymentSpecTemplateSpecEphemeralContainersResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public StackDefinitionSpecControllerDeploymentSpecTemplateSpecEphemeralContainersResourcesArgs()
        {
        }
    }
}
