...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class PackageSpecControllerDeploymentSpecTemplateSpecVolumesFcArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public PackageSpecControllerDeploymentSpecTemplateSpecVolumesFcArgs()
        {
        }
    }
}
