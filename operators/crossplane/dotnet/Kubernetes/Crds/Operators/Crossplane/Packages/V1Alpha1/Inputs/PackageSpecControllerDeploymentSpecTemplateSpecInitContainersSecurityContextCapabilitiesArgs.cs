...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class PackageSpecControllerDeploymentSpecTemplateSpecInitContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public PackageSpecControllerDeploymentSpecTemplateSpecInitContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
