...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class PackageSpecControllerDeploymentSpecTemplateSpecVolumesAzureDiskArgs : Pulumi.ResourceArgs
    {
        [Input("cachingMode")]
        ...
        public PackageSpecControllerDeploymentSpecTemplateSpecVolumesAzureDiskArgs()
        {
        }
    }
}
