...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class PackageSpecControllerDeploymentSpecTemplateSpecEphemeralContainersResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public PackageSpecControllerDeploymentSpecTemplateSpecEphemeralContainersResourcesArgs()
        {
        }
    }
}
