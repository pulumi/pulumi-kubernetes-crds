...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesVsphereVolumeArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesVsphereVolumeArgs()
        {
        }
    }
}
