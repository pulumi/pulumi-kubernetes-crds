...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class PackageSpecControllerDeploymentSpecTemplateSpecVolumesScaleIOArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1.PackageSpecControllerDeploymentSpecTemplateSpecVolumesScaleIOSecretRefArgs> SecretRef { get; set; } = null!;
        ...
        public PackageSpecControllerDeploymentSpecTemplateSpecVolumesScaleIOArgs()
        {
        }
    }
}
