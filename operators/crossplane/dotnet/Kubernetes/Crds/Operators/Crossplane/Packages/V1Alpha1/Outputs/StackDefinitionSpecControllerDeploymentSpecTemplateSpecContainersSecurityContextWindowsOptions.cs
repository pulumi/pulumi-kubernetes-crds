...
namespace Pulumi.Kubernetes.Types.Outputs.Packages.V1Alpha1
{
    ...
    [OutputType]
    public sealed class StackDefinitionSpecControllerDeploymentSpecTemplateSpecContainersSecurityContextWindowsOptions
    {
        ...
        [OutputConstructor]
        private StackDefinitionSpecControllerDeploymentSpecTemplateSpecContainersSecurityContextWindowsOptions(
