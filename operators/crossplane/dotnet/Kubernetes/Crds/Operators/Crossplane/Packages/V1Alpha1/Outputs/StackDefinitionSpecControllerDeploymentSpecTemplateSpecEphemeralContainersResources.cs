...
namespace Pulumi.Kubernetes.Types.Outputs.Packages.V1Alpha1
{
    ...
    [OutputType]
    public sealed class StackDefinitionSpecControllerDeploymentSpecTemplateSpecEphemeralContainersResources
    {
        public readonly ImmutableDictionary<string, string> Limits;
        public readonly ImmutableDictionary<string, string> Requests;

        [OutputConstructor]
        private StackDefinitionSpecControllerDeploymentSpecTemplateSpecEphemeralContainersResources(
