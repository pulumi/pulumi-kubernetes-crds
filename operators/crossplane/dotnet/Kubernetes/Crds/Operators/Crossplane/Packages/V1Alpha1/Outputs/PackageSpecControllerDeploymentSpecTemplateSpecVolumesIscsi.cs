...
namespace Pulumi.Kubernetes.Types.Outputs.Packages.V1Alpha1
{
    ...
    [OutputType]
    public sealed class PackageSpecControllerDeploymentSpecTemplateSpecVolumesIscsi
    {
        ...
        public readonly Pulumi.Kubernetes.Types.Outputs.Packages.V1Alpha1.PackageSpecControllerDeploymentSpecTemplateSpecVolumesIscsiSecretRef SecretRef;
        public readonly string TargetPortal;

        [OutputConstructor]
        private PackageSpecControllerDeploymentSpecTemplateSpecVolumesIscsi(
            ...
            Pulumi.Kubernetes.Types.Outputs.Packages.V1Alpha1.PackageSpecControllerDeploymentSpecTemplateSpecVolumesIscsiSecretRef secretRef,
