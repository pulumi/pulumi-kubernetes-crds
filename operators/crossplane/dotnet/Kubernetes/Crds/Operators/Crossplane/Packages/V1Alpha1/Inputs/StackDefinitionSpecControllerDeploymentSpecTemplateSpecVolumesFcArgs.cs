...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesFcArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesFcArgs()
        {
        }
    }
}
