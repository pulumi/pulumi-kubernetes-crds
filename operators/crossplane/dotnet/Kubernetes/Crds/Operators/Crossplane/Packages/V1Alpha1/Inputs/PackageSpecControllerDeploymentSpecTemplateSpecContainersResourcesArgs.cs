...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class PackageSpecControllerDeploymentSpecTemplateSpecContainersResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public PackageSpecControllerDeploymentSpecTemplateSpecContainersResourcesArgs()
        {
        }
    }
}
