...
namespace Pulumi.Kubernetes.Types.Outputs.Packages.V1Alpha1
{
    ...
    [OutputType]
    public sealed class PackageSpecControllerDeploymentSpecTemplateSpecVolumesVsphereVolume
    {
        ...
        [OutputConstructor]
        private PackageSpecControllerDeploymentSpecTemplateSpecVolumesVsphereVolume(
            string fsType,
