...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class PackageSpecControllerDeploymentSpecTemplateSpecVolumesQuobyteArgs : Pulumi.ResourceArgs
    {
        [Input("group")]
        ...
        public PackageSpecControllerDeploymentSpecTemplateSpecVolumesQuobyteArgs()
        {
        }
    }
}
