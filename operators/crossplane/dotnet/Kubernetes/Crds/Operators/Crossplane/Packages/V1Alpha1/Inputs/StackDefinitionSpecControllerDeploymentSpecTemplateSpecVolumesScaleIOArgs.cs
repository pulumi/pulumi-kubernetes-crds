...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesScaleIOArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1.StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesScaleIOSecretRefArgs> SecretRef { get; set; } = null!;
        ...
        public StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesScaleIOArgs()
        {
        }
    }
}
