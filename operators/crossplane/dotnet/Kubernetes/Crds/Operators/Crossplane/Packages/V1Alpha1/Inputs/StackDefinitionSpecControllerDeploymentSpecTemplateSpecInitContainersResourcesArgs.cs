...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class StackDefinitionSpecControllerDeploymentSpecTemplateSpecInitContainersResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public StackDefinitionSpecControllerDeploymentSpecTemplateSpecInitContainersResourcesArgs()
        {
        }
    }
}
