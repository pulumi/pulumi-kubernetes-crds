...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class PackageSpecControllerDeploymentSpecTemplateSpecVolumesVsphereVolumeArgs : Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public PackageSpecControllerDeploymentSpecTemplateSpecVolumesVsphereVolumeArgs()
        {
        }
    }
}
