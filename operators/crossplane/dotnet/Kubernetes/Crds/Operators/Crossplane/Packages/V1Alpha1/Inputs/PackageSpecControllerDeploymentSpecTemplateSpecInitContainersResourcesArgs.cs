...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class PackageSpecControllerDeploymentSpecTemplateSpecInitContainersResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public PackageSpecControllerDeploymentSpecTemplateSpecInitContainersResourcesArgs()
        {
        }
    }
}
