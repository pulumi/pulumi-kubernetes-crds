...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesQuobyteArgs : Pulumi.ResourceArgs
    {
        [Input("group")]
        ...
        public StackDefinitionSpecControllerDeploymentSpecTemplateSpecVolumesQuobyteArgs()
        {
        }
    }
}
