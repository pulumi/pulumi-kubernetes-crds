...
namespace Pulumi.Kubernetes.Types.Inputs.Packages.V1Alpha1
{
    ...
    public class PackageSpecControllerDeploymentSpecTemplateSpecContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public PackageSpecControllerDeploymentSpecTemplateSpecContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
