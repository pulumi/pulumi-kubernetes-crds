...
namespace Pulumi.Kubernetes.Types.Outputs.Workload.V1Alpha1
{
    ...
    [OutputType]
    public sealed class KubernetesApplicationSpecResourceTemplatesSpec
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Workload.V1Alpha1.KubernetesApplicationSpecResourceTemplatesSpecSecrets> Secrets;
        /// <summary>
        /// Target to which this application has been scheduled.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Workload.V1Alpha1.KubernetesApplicationSpecResourceTemplatesSpecTargetRef TargetRef;
        /// <summary>
        ...
        [OutputConstructor]
        private KubernetesApplicationSpecResourceTemplatesSpec(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Workload.V1Alpha1.KubernetesApplicationSpecResourceTemplatesSpecSecrets> secrets,

            Pulumi.Kubernetes.Types.Outputs.Workload.V1Alpha1.KubernetesApplicationSpecResourceTemplatesSpecTargetRef targetRef,
