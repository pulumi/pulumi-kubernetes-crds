...
namespace Pulumi.Kubernetes.Types.Inputs.Workload.V1Alpha1
{
    ...
    /// </summary>
    public class KubernetesApplicationSpecResourceTemplatesSpecArgs : Pulumi.ResourceArgs
    {
        [Input("secrets")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Workload.V1Alpha1.KubernetesApplicationSpecResourceTemplatesSpecSecretsArgs>? _secrets;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Workload.V1Alpha1.KubernetesApplicationSpecResourceTemplatesSpecSecretsArgs> Secrets
        {
            get => _secrets ?? (_secrets = new InputList<Pulumi.Kubernetes.Types.Inputs.Workload.V1Alpha1.KubernetesApplicationSpecResourceTemplatesSpecSecretsArgs>());
            set => _secrets = value;
        }
        ...
        /// </summary>
        [Input("targetRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Workload.V1Alpha1.KubernetesApplicationSpecResourceTemplatesSpecTargetRefArgs>? TargetRef { get; set; }
        ...
        public KubernetesApplicationSpecResourceTemplatesSpecArgs()
        {
        }
    }
}
