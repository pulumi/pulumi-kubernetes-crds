...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha2
{
    ...
    /// </summary>
    public class ContainerizedWorkloadSpecContainersEnvArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// FromSecret is a secret key reference which can be used to assign a value to the environment variable.
        /// </summary>
        [Input("fromSecret")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha2.ContainerizedWorkloadSpecContainersEnvFromSecretArgs>? FromSecret { get; set; }
        ...
        public ContainerizedWorkloadSpecContainersEnvArgs()
        {
        }
    }
}
