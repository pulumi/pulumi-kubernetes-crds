...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha2
{
    ...
    /// </summary>
    public class ContainerizedWorkloadSpecContainersLivenessProbeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Exec probes a container's health by executing a command.
        /// </summary>
        [Input("exec")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha2.ContainerizedWorkloadSpecContainersLivenessProbeExecArgs>? Exec { get; set; }
        ...
        /// </summary>
        [Input("httpGet")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha2.ContainerizedWorkloadSpecContainersLivenessProbeHttpGetArgs>? HttpGet { get; set; }
        ...
        /// </summary>
        [Input("tcpSocket")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha2.ContainerizedWorkloadSpecContainersLivenessProbeTcpSocketArgs>? TcpSocket { get; set; }
        ...
        public ContainerizedWorkloadSpecContainersLivenessProbeArgs()
        {
        }
    }
}
