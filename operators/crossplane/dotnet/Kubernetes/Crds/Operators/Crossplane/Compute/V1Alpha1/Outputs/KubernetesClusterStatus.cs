...
namespace Pulumi.Kubernetes.Types.Outputs.Compute.V1Alpha1
{
    ...
    public sealed class KubernetesClusterStatus
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Compute.V1Alpha1.KubernetesClusterStatusConditions> Conditions;

        [OutputConstructor]
        private KubernetesClusterStatus(
            string bindingPhase,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Compute.V1Alpha1.KubernetesClusterStatusConditions> conditions)
        {
