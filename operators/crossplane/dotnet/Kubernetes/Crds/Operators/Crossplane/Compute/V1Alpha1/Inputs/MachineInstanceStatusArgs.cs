...
namespace Pulumi.Kubernetes.Types.Inputs.Compute.V1Alpha1
{
    ...
    /// </summary>
    public class MachineInstanceStatusArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Compute.V1Alpha1.MachineInstanceStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Conditions of the resource.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Compute.V1Alpha1.MachineInstanceStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Compute.V1Alpha1.MachineInstanceStatusConditionsArgs>());
            set => _conditions = value;
        }

        public MachineInstanceStatusArgs()
        {
        }
    }
}
