...
namespace Pulumi.Kubernetes.Types.Outputs.Compute.V1Alpha1
{
    ...
    [OutputType]
    public sealed class MachineInstanceStatus
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Compute.V1Alpha1.MachineInstanceStatusConditions> Conditions;

        [OutputConstructor]
        private MachineInstanceStatus(
            string bindingPhase,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Compute.V1Alpha1.MachineInstanceStatusConditions> conditions)
        {
