...
namespace Pulumi.Kubernetes.Types.Inputs.Compute.V1Alpha1
{
    ...
    /// </summary>
    public class MachineInstanceSpecArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("classRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Compute.V1Alpha1.MachineInstanceSpecClassRefArgs>? ClassRef { get; set; }
        ...
        /// </summary>
        [Input("classSelector")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Compute.V1Alpha1.MachineInstanceSpecClassSelectorArgs>? ClassSelector { get; set; }
        ...
        /// </summary>
        [Input("resourceRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Compute.V1Alpha1.MachineInstanceSpecResourceRefArgs>? ResourceRef { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Compute.V1Alpha1.MachineInstanceSpecWriteConnectionSecretToRefArgs>? WriteConnectionSecretToRef { get; set; }

        public MachineInstanceSpecArgs()
        {
        }
    }
}
