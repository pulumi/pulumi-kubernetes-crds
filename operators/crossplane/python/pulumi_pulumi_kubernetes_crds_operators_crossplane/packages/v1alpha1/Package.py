...
class Package(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['PackageSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['PackageStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'Package'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(Package, __self__).__init__(
            'kubernetes:packages.crossplane.io/v1alpha1:Package',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.PackageSpec']]:
        return pulumi.get(self, "spec")

    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.PackageStatus']]:
