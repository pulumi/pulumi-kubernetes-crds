...
class KubernetesClusterSpecArgs:
    def __init__(__self__, *,
                 class_ref: Optional[pulumi.Input['KubernetesClusterSpecClassRefArgs']] = None,
                 class_selector: Optional[pulumi.Input['KubernetesClusterSpecClassSelectorArgs']] = None,
                 cluster_version: Optional[pulumi.Input[str]] = None,
                 resource_ref: Optional[pulumi.Input['KubernetesClusterSpecResourceRefArgs']] = None,
                 write_connection_secret_to_ref: Optional[pulumi.Input['KubernetesClusterSpecWriteConnectionSecretToRefArgs']] = None):
        """
        KubernetesClusterSpec specifies the desired state of a KubernetesCluster.
        :param pulumi.Input['KubernetesClusterSpecClassRefArgs'] class_ref: A ClassReference specifies a resource class that will be used to dynamically provision a managed resource when the resource claim is created.
        :param pulumi.Input['KubernetesClusterSpecClassSelectorArgs'] class_selector: A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param pulumi.Input[str] cluster_version: ClusterVersion specifies the desired Kubernetes version, e.g. 1.15.
        :param pulumi.Input['KubernetesClusterSpecResourceRefArgs'] resource_ref: A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
        :param pulumi.Input['KubernetesClusterSpecWriteConnectionSecretToRefArgs'] write_connection_secret_to_ref: WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
        """
    ...
    def class_ref(self) -> Optional[pulumi.Input['KubernetesClusterSpecClassRefArgs']]:
        """
    ...
    @class_ref.setter
    def class_ref(self, value: Optional[pulumi.Input['KubernetesClusterSpecClassRefArgs']]):
        pulumi.set(self, "class_ref", value)

    @property
    @pulumi.getter(name="classSelector")
    def class_selector(self) -> Optional[pulumi.Input['KubernetesClusterSpecClassSelectorArgs']]:
        """
    ...
    def class_selector(self, value: Optional[pulumi.Input['KubernetesClusterSpecClassSelectorArgs']]):
    ...
    def resource_ref(self) -> Optional[pulumi.Input['KubernetesClusterSpecResourceRefArgs']]:
        """
    ...
    @resource_ref.setter
    def resource_ref(self, value: Optional[pulumi.Input['KubernetesClusterSpecResourceRefArgs']]):
        pulumi.set(self, "resource_ref", value)

    @property
    @pulumi.getter(name="writeConnectionSecretToRef")
    def write_connection_secret_to_ref(self) -> Optional[pulumi.Input['KubernetesClusterSpecWriteConnectionSecretToRefArgs']]:
        """
    ...
    def write_connection_secret_to_ref(self, value: Optional[pulumi.Input['KubernetesClusterSpecWriteConnectionSecretToRefArgs']]):
        pulumi.set(self, "write_connection_secret_to_ref", value)


@pulumi.input_type
class KubernetesClusterSpecClassRefArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class KubernetesClusterSpecClassSelectorArgs:
    def __init__(__self__, *,
                 match_expressions: Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesClusterSpecClassSelectorMatchExpressionsArgs']]]] = None,
                 match_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None):
        """
        A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param pulumi.Input[Sequence[pulumi.Input['KubernetesClusterSpecClassSelectorMatchExpressionsArgs']]] match_expressions: matchExpressions is a list of label selector requirements. The requirements are ANDed.
    ...
    def match_expressions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesClusterSpecClassSelectorMatchExpressionsArgs']]]]:
        """
    ...
    def match_expressions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesClusterSpecClassSelectorMatchExpressionsArgs']]]]):
...
@pulumi.input_type
class KubernetesClusterSpecClassSelectorMatchExpressionsArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class KubernetesClusterSpecResourceRefArgs:
    def __init__(__self__, *,
                 api_version: Optional[pulumi.Input[str]] = None,
                 field_path: Optional[pulumi.Input[str]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
...
@pulumi.input_type
class KubernetesClusterSpecWriteConnectionSecretToRefArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class KubernetesClusterStatusArgs:
    def __init__(__self__, *,
                 binding_phase: Optional[pulumi.Input[str]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesClusterStatusConditionsArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['KubernetesClusterStatusConditionsArgs']]] conditions: Conditions of the resource.
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesClusterStatusConditionsArgs']]]]:
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesClusterStatusConditionsArgs']]]]):
        pulumi.set(self, "conditions", value)


@pulumi.input_type
class KubernetesClusterStatusConditionsArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class MachineInstanceSpecArgs:
    def __init__(__self__, *,
                 class_ref: Optional[pulumi.Input['MachineInstanceSpecClassRefArgs']] = None,
                 class_selector: Optional[pulumi.Input['MachineInstanceSpecClassSelectorArgs']] = None,
                 resource_ref: Optional[pulumi.Input['MachineInstanceSpecResourceRefArgs']] = None,
                 write_connection_secret_to_ref: Optional[pulumi.Input['MachineInstanceSpecWriteConnectionSecretToRefArgs']] = None):
        """
        MachineInstanceSpec specifies the desired state of a MachineInstance.
        :param pulumi.Input['MachineInstanceSpecClassRefArgs'] class_ref: A ClassReference specifies a resource class that will be used to dynamically provision a managed resource when the resource claim is created.
        :param pulumi.Input['MachineInstanceSpecClassSelectorArgs'] class_selector: A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param pulumi.Input['MachineInstanceSpecResourceRefArgs'] resource_ref: A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
        :param pulumi.Input['MachineInstanceSpecWriteConnectionSecretToRefArgs'] write_connection_secret_to_ref: WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
        """
        if class_ref is not None:
            pulumi.set(__self__, "class_ref", class_ref)
        if class_selector is not None:
    ...
    @property
    @pulumi.getter(name="classRef")
    def class_ref(self) -> Optional[pulumi.Input['MachineInstanceSpecClassRefArgs']]:
        """
        A ClassReference specifies a resource class that will be used to dynamically provision a managed resource when the resource claim is created.
        """
        return pulumi.get(self, "class_ref")
    ...
    @class_ref.setter
    def class_ref(self, value: Optional[pulumi.Input['MachineInstanceSpecClassRefArgs']]):
        pulumi.set(self, "class_ref", value)

    @property
    @pulumi.getter(name="classSelector")
    def class_selector(self) -> Optional[pulumi.Input['MachineInstanceSpecClassSelectorArgs']]:
        """
        A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        """
        return pulumi.get(self, "class_selector")
    ...
    @class_selector.setter
    def class_selector(self, value: Optional[pulumi.Input['MachineInstanceSpecClassSelectorArgs']]):
        pulumi.set(self, "class_selector", value)

    @property
    @pulumi.getter(name="resourceRef")
    def resource_ref(self) -> Optional[pulumi.Input['MachineInstanceSpecResourceRefArgs']]:
        """
        A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
        """
        return pulumi.get(self, "resource_ref")
    ...
    @resource_ref.setter
    def resource_ref(self, value: Optional[pulumi.Input['MachineInstanceSpecResourceRefArgs']]):
        pulumi.set(self, "resource_ref", value)

    @property
    @pulumi.getter(name="writeConnectionSecretToRef")
    def write_connection_secret_to_ref(self) -> Optional[pulumi.Input['MachineInstanceSpecWriteConnectionSecretToRefArgs']]:
        """
        WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
        """
        return pulumi.get(self, "write_connection_secret_to_ref")
    ...
    @write_connection_secret_to_ref.setter
    def write_connection_secret_to_ref(self, value: Optional[pulumi.Input['MachineInstanceSpecWriteConnectionSecretToRefArgs']]):
        pulumi.set(self, "write_connection_secret_to_ref", value)


@pulumi.input_type
class MachineInstanceSpecClassRefArgs:
    def __init__(__self__, *,
                 api_version: Optional[pulumi.Input[str]] = None,
                 field_path: Optional[pulumi.Input[str]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
...
@pulumi.input_type
class MachineInstanceSpecClassSelectorArgs:
    def __init__(__self__, *,
                 match_expressions: Optional[pulumi.Input[Sequence[pulumi.Input['MachineInstanceSpecClassSelectorMatchExpressionsArgs']]]] = None,
                 match_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None):
        """
        A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param pulumi.Input[Sequence[pulumi.Input['MachineInstanceSpecClassSelectorMatchExpressionsArgs']]] match_expressions: matchExpressions is a list of label selector requirements. The requirements are ANDed.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] match_labels: matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
        """
        if match_expressions is not None:
            pulumi.set(__self__, "match_expressions", match_expressions)
    ...
    @property
    @pulumi.getter(name="matchExpressions")
    def match_expressions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MachineInstanceSpecClassSelectorMatchExpressionsArgs']]]]:
        """
        matchExpressions is a list of label selector requirements. The requirements are ANDed.
        """
        return pulumi.get(self, "match_expressions")
    ...
    @match_expressions.setter
    def match_expressions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MachineInstanceSpecClassSelectorMatchExpressionsArgs']]]]):
        pulumi.set(self, "match_expressions", value)
...
@pulumi.input_type
class MachineInstanceSpecClassSelectorMatchExpressionsArgs:
    def __init__(__self__, *,
                 key: pulumi.Input[str],
                 operator: pulumi.Input[str],
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
...
@pulumi.input_type
class MachineInstanceSpecResourceRefArgs:
    def __init__(__self__, *,
                 api_version: Optional[pulumi.Input[str]] = None,
                 field_path: Optional[pulumi.Input[str]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
...
@pulumi.input_type
class MachineInstanceSpecWriteConnectionSecretToRefArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[str]):
        """
        WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
...
@pulumi.input_type
class MachineInstanceStatusArgs:
    def __init__(__self__, *,
                 binding_phase: Optional[pulumi.Input[str]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input['MachineInstanceStatusConditionsArgs']]]] = None):
        """
        A ResourceClaimStatus represents the observed status of a resource claim.
        :param pulumi.Input[str] binding_phase: Phase represents the binding phase of a managed resource or claim. Unbindable resources cannot be bound, typically because they are currently unavailable, or still being created. Unbound resource are available for binding, and Bound resources have successfully bound to another resource.
        :param pulumi.Input[Sequence[pulumi.Input['MachineInstanceStatusConditionsArgs']]] conditions: Conditions of the resource.
        """
        if binding_phase is not None:
            pulumi.set(__self__, "binding_phase", binding_phase)
        if conditions is not None:
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MachineInstanceStatusConditionsArgs']]]]:
        """
        Conditions of the resource.
        """
        return pulumi.get(self, "conditions")
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MachineInstanceStatusConditionsArgs']]]]):
        pulumi.set(self, "conditions", value)


@pulumi.input_type
class MachineInstanceStatusConditionsArgs:
    def __init__(__self__, *,
                 last_transition_time: pulumi.Input[str],
                 reason: pulumi.Input[str],
                 status: pulumi.Input[str],
