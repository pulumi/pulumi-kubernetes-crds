...
__all__ = [
    ...
    'KubernetesClusterSpecClassRef',
    'KubernetesClusterSpecClassSelector',
    'KubernetesClusterSpecClassSelectorMatchExpressions',
    'KubernetesClusterSpecResourceRef',
    'KubernetesClusterSpecWriteConnectionSecretToRef',
    'KubernetesClusterStatus',
    'KubernetesClusterStatusConditions',
    'MachineInstanceSpec',
    'MachineInstanceSpecClassRef',
    'MachineInstanceSpecClassSelector',
    'MachineInstanceSpecClassSelectorMatchExpressions',
    'MachineInstanceSpecResourceRef',
    'MachineInstanceSpecWriteConnectionSecretToRef',
    'MachineInstanceStatus',
    'MachineInstanceStatusConditions',
]
...
class KubernetesClusterSpec(dict):
    ...
    def __init__(__self__, *,
                 class_ref: Optional['outputs.KubernetesClusterSpecClassRef'] = None,
                 class_selector: Optional['outputs.KubernetesClusterSpecClassSelector'] = None,
                 cluster_version: Optional[str] = None,
                 resource_ref: Optional['outputs.KubernetesClusterSpecResourceRef'] = None,
                 write_connection_secret_to_ref: Optional['outputs.KubernetesClusterSpecWriteConnectionSecretToRef'] = None):
        """
        KubernetesClusterSpec specifies the desired state of a KubernetesCluster.
        :param 'KubernetesClusterSpecClassRefArgs' class_ref: A ClassReference specifies a resource class that will be used to dynamically provision a managed resource when the resource claim is created.
        :param 'KubernetesClusterSpecClassSelectorArgs' class_selector: A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param str cluster_version: ClusterVersion specifies the desired Kubernetes version, e.g. 1.15.
        :param 'KubernetesClusterSpecResourceRefArgs' resource_ref: A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
        :param 'KubernetesClusterSpecWriteConnectionSecretToRefArgs' write_connection_secret_to_ref: WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
        """
    ...
    def class_ref(self) -> Optional['outputs.KubernetesClusterSpecClassRef']:
        """
    ...
    def class_selector(self) -> Optional['outputs.KubernetesClusterSpecClassSelector']:
        """
    ...
    def resource_ref(self) -> Optional['outputs.KubernetesClusterSpecResourceRef']:
        """
    ...
    def write_connection_secret_to_ref(self) -> Optional['outputs.KubernetesClusterSpecWriteConnectionSecretToRef']:
        """
...
@pulumi.output_type
class KubernetesClusterSpecClassRef(dict):
    """
    A ClassReference specifies a resource class that will be used to dynamically provision a managed resource when the resource claim is created.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class KubernetesClusterSpecClassSelector(dict):
    """
    A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
    """
    def __init__(__self__, *,
                 match_expressions: Optional[Sequence['outputs.KubernetesClusterSpecClassSelectorMatchExpressions']] = None,
                 match_labels: Optional[Mapping[str, str]] = None):
        """
        A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param Sequence['KubernetesClusterSpecClassSelectorMatchExpressionsArgs'] match_expressions: matchExpressions is a list of label selector requirements. The requirements are ANDed.
    ...
    def match_expressions(self) -> Optional[Sequence['outputs.KubernetesClusterSpecClassSelectorMatchExpressions']]:
        """
...
@pulumi.output_type
class KubernetesClusterSpecClassSelectorMatchExpressions(dict):
    """
...
@pulumi.output_type
class KubernetesClusterSpecResourceRef(dict):
    """
    A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class KubernetesClusterSpecWriteConnectionSecretToRef(dict):
    """
    WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
    """
    def __init__(__self__, *,
...
class KubernetesClusterStatus(dict):
    ...
    def __init__(__self__, *,
                 ...
                 conditions: Optional[Sequence['outputs.KubernetesClusterStatusConditions']] = None):
        """
        A ResourceClaimStatus represents the observed status of a resource claim.
        ...
        :param Sequence['KubernetesClusterStatusConditionsArgs'] conditions: Conditions of the resource.
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[Sequence['outputs.KubernetesClusterStatusConditions']]:
        """
...
@pulumi.output_type
class KubernetesClusterStatusConditions(dict):
    """
...
@pulumi.output_type
class MachineInstanceSpec(dict):
    """
    MachineInstanceSpec specifies the desired state of a MachineInstance.
    """
    def __init__(__self__, *,
                 class_ref: Optional['outputs.MachineInstanceSpecClassRef'] = None,
                 class_selector: Optional['outputs.MachineInstanceSpecClassSelector'] = None,
                 resource_ref: Optional['outputs.MachineInstanceSpecResourceRef'] = None,
                 write_connection_secret_to_ref: Optional['outputs.MachineInstanceSpecWriteConnectionSecretToRef'] = None):
        """
        MachineInstanceSpec specifies the desired state of a MachineInstance.
        :param 'MachineInstanceSpecClassRefArgs' class_ref: A ClassReference specifies a resource class that will be used to dynamically provision a managed resource when the resource claim is created.
        :param 'MachineInstanceSpecClassSelectorArgs' class_selector: A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param 'MachineInstanceSpecResourceRefArgs' resource_ref: A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
        :param 'MachineInstanceSpecWriteConnectionSecretToRefArgs' write_connection_secret_to_ref: WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
        """
        if class_ref is not None:
            pulumi.set(__self__, "class_ref", class_ref)
        if class_selector is not None:
    ...
    @property
    @pulumi.getter(name="classRef")
    def class_ref(self) -> Optional['outputs.MachineInstanceSpecClassRef']:
        """
        A ClassReference specifies a resource class that will be used to dynamically provision a managed resource when the resource claim is created.
        """
        return pulumi.get(self, "class_ref")
    ...
    @property
    @pulumi.getter(name="classSelector")
    def class_selector(self) -> Optional['outputs.MachineInstanceSpecClassSelector']:
        """
        A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        """
        return pulumi.get(self, "class_selector")
    ...
    @property
    @pulumi.getter(name="resourceRef")
    def resource_ref(self) -> Optional['outputs.MachineInstanceSpecResourceRef']:
        """
        A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
        """
        return pulumi.get(self, "resource_ref")
    ...
    @property
    @pulumi.getter(name="writeConnectionSecretToRef")
    def write_connection_secret_to_ref(self) -> Optional['outputs.MachineInstanceSpecWriteConnectionSecretToRef']:
        """
        WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
        """
        return pulumi.get(self, "write_connection_secret_to_ref")
...
@pulumi.output_type
class MachineInstanceSpecClassRef(dict):
    """
    A ClassReference specifies a resource class that will be used to dynamically provision a managed resource when the resource claim is created.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class MachineInstanceSpecClassSelector(dict):
    """
    A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
    """
    def __init__(__self__, *,
                 match_expressions: Optional[Sequence['outputs.MachineInstanceSpecClassSelectorMatchExpressions']] = None,
                 match_labels: Optional[Mapping[str, str]] = None):
        """
        A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param Sequence['MachineInstanceSpecClassSelectorMatchExpressionsArgs'] match_expressions: matchExpressions is a list of label selector requirements. The requirements are ANDed.
        :param Mapping[str, str] match_labels: matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
        """
        if match_expressions is not None:
            pulumi.set(__self__, "match_expressions", match_expressions)
    ...
    @property
    @pulumi.getter(name="matchExpressions")
    def match_expressions(self) -> Optional[Sequence['outputs.MachineInstanceSpecClassSelectorMatchExpressions']]:
        """
        matchExpressions is a list of label selector requirements. The requirements are ANDed.
        """
        return pulumi.get(self, "match_expressions")
...
@pulumi.output_type
class MachineInstanceSpecClassSelectorMatchExpressions(dict):
    """
    A label selector requirement is a selector that contains values, a key, and an operator that relates the key and values.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class MachineInstanceSpecResourceRef(dict):
    """
    A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class MachineInstanceSpecWriteConnectionSecretToRef(dict):
    """
    WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class MachineInstanceStatus(dict):
    """
    A ResourceClaimStatus represents the observed status of a resource claim.
    """
    def __init__(__self__, *,
                 binding_phase: Optional[str] = None,
                 conditions: Optional[Sequence['outputs.MachineInstanceStatusConditions']] = None):
        """
        A ResourceClaimStatus represents the observed status of a resource claim.
        :param str binding_phase: Phase represents the binding phase of a managed resource or claim. Unbindable resources cannot be bound, typically because they are currently unavailable, or still being created. Unbound resource are available for binding, and Bound resources have successfully bound to another resource.
        :param Sequence['MachineInstanceStatusConditionsArgs'] conditions: Conditions of the resource.
        """
        if binding_phase is not None:
            pulumi.set(__self__, "binding_phase", binding_phase)
        if conditions is not None:
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[Sequence['outputs.MachineInstanceStatusConditions']]:
        """
        Conditions of the resource.
        """
        return pulumi.get(self, "conditions")
...
@pulumi.output_type
class MachineInstanceStatusConditions(dict):
    """
    A Condition that may apply to a resource.
    """
    def __init__(__self__, *,
