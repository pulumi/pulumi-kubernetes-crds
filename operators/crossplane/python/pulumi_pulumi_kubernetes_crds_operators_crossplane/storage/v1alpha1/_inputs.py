...
@pulumi.input_type
class BucketSpecArgs:
    def __init__(__self__, *,
                 class_ref: Optional[pulumi.Input['BucketSpecClassRefArgs']] = None,
                 class_selector: Optional[pulumi.Input['BucketSpecClassSelectorArgs']] = None,
                 local_permission: Optional[pulumi.Input[str]] = None,
                 predefined_acl: Optional[pulumi.Input[str]] = None,
                 resource_ref: Optional[pulumi.Input['BucketSpecResourceRefArgs']] = None,
                 write_connection_secret_to_ref: Optional[pulumi.Input['BucketSpecWriteConnectionSecretToRefArgs']] = None):
        """
        BucketSpec specifies the desired state of a Bucket.
        :param pulumi.Input['BucketSpecClassRefArgs'] class_ref: A ClassReference specifies a resource class that will be used to dynamically provision a managed resource when the resource claim is created.
        :param pulumi.Input['BucketSpecClassSelectorArgs'] class_selector: A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param pulumi.Input[str] local_permission: LocalPermission specifies permissions granted to a provider specific service account for this bucket, e.g. Read, ReadWrite, or Write.
        :param pulumi.Input[str] predefined_acl: PredefinedACL specifies a predefined ACL (e.g. Private, ReadWrite, etc) to be applied to the bucket.
        :param pulumi.Input['BucketSpecResourceRefArgs'] resource_ref: A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
        :param pulumi.Input['BucketSpecWriteConnectionSecretToRefArgs'] write_connection_secret_to_ref: WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
        """
        ...
        if local_permission is not None:
            pulumi.set(__self__, "local_permission", local_permission)
    ...
    def class_ref(self) -> Optional[pulumi.Input['BucketSpecClassRefArgs']]:
        """
    ...
    @class_ref.setter
    def class_ref(self, value: Optional[pulumi.Input['BucketSpecClassRefArgs']]):
        pulumi.set(self, "class_ref", value)

    @property
    @pulumi.getter(name="classSelector")
    def class_selector(self) -> Optional[pulumi.Input['BucketSpecClassSelectorArgs']]:
        """
    ...
    def class_selector(self, value: Optional[pulumi.Input['BucketSpecClassSelectorArgs']]):
        pulumi.set(self, "class_selector", value)

    @property
    @pulumi.getter(name="localPermission")
    def local_permission(self) -> Optional[pulumi.Input[str]]:
        """
        ...
        """
        return pulumi.get(self, "local_permission")

    @local_permission.setter
    def local_permission(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "local_permission", value)
    ...
    def resource_ref(self) -> Optional[pulumi.Input['BucketSpecResourceRefArgs']]:
        """
    ...
    @resource_ref.setter
    def resource_ref(self, value: Optional[pulumi.Input['BucketSpecResourceRefArgs']]):
        pulumi.set(self, "resource_ref", value)

    @property
    @pulumi.getter(name="writeConnectionSecretToRef")
    def write_connection_secret_to_ref(self) -> Optional[pulumi.Input['BucketSpecWriteConnectionSecretToRefArgs']]:
        """
    ...
    def write_connection_secret_to_ref(self, value: Optional[pulumi.Input['BucketSpecWriteConnectionSecretToRefArgs']]):
        pulumi.set(self, "write_connection_secret_to_ref", value)


@pulumi.input_type
class BucketSpecClassRefArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class BucketSpecClassSelectorArgs:
    def __init__(__self__, *,
                 match_expressions: Optional[pulumi.Input[Sequence[pulumi.Input['BucketSpecClassSelectorMatchExpressionsArgs']]]] = None,
                 match_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None):
        """
        A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param pulumi.Input[Sequence[pulumi.Input['BucketSpecClassSelectorMatchExpressionsArgs']]] match_expressions: matchExpressions is a list of label selector requirements. The requirements are ANDed.
    ...
    def match_expressions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BucketSpecClassSelectorMatchExpressionsArgs']]]]:
        """
    ...
    def match_expressions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BucketSpecClassSelectorMatchExpressionsArgs']]]]):
...
@pulumi.input_type
class BucketSpecClassSelectorMatchExpressionsArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class BucketSpecResourceRefArgs:
    def __init__(__self__, *,
                 api_version: Optional[pulumi.Input[str]] = None,
                 field_path: Optional[pulumi.Input[str]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
...
@pulumi.input_type
class BucketSpecWriteConnectionSecretToRefArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class BucketStatusArgs:
    def __init__(__self__, *,
                 binding_phase: Optional[pulumi.Input[str]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input['BucketStatusConditionsArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BucketStatusConditionsArgs']]] conditions: Conditions of the resource.
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BucketStatusConditionsArgs']]]]:
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BucketStatusConditionsArgs']]]]):
        pulumi.set(self, "conditions", value)


@pulumi.input_type
class BucketStatusConditionsArgs:
    def __init__(__self__, *,
