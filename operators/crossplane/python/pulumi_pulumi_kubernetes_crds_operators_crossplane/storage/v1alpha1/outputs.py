...
__all__ = [
    'BucketSpec',
    'BucketSpecClassRef',
    'BucketSpecClassSelector',
    'BucketSpecClassSelectorMatchExpressions',
    'BucketSpecResourceRef',
    'BucketSpecWriteConnectionSecretToRef',
    'BucketStatus',
    'BucketStatusConditions',
]

@pulumi.output_type
class BucketSpec(dict):
    """
    BucketSpec specifies the desired state of a Bucket.
    """
    def __init__(__self__, *,
                 class_ref: Optional['outputs.BucketSpecClassRef'] = None,
                 class_selector: Optional['outputs.BucketSpecClassSelector'] = None,
                 local_permission: Optional[str] = None,
                 predefined_acl: Optional[str] = None,
                 resource_ref: Optional['outputs.BucketSpecResourceRef'] = None,
                 write_connection_secret_to_ref: Optional['outputs.BucketSpecWriteConnectionSecretToRef'] = None):
        """
        BucketSpec specifies the desired state of a Bucket.
        :param 'BucketSpecClassRefArgs' class_ref: A ClassReference specifies a resource class that will be used to dynamically provision a managed resource when the resource claim is created.
        :param 'BucketSpecClassSelectorArgs' class_selector: A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param str local_permission: LocalPermission specifies permissions granted to a provider specific service account for this bucket, e.g. Read, ReadWrite, or Write.
        :param str predefined_acl: PredefinedACL specifies a predefined ACL (e.g. Private, ReadWrite, etc) to be applied to the bucket.
        :param 'BucketSpecResourceRefArgs' resource_ref: A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
        :param 'BucketSpecWriteConnectionSecretToRefArgs' write_connection_secret_to_ref: WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
        """
    ...
    def class_ref(self) -> Optional['outputs.BucketSpecClassRef']:
        """
    ...
    def class_selector(self) -> Optional['outputs.BucketSpecClassSelector']:
        """
    ...
    def local_permission(self) -> Optional[str]:
        """
    ...
    def resource_ref(self) -> Optional['outputs.BucketSpecResourceRef']:
        """
    ...
    def write_connection_secret_to_ref(self) -> Optional['outputs.BucketSpecWriteConnectionSecretToRef']:
        """
...
@pulumi.output_type
class BucketSpecClassSelector(dict):
    """
    A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
    """
    def __init__(__self__, *,
                 match_expressions: Optional[Sequence['outputs.BucketSpecClassSelectorMatchExpressions']] = None,
                 match_labels: Optional[Mapping[str, str]] = None):
        """
        A ClassSelector specifies labels that will be used to select a resource class for this claim. If multiple classes match the labels one will be chosen at random.
        :param Sequence['BucketSpecClassSelectorMatchExpressionsArgs'] match_expressions: matchExpressions is a list of label selector requirements. The requirements are ANDed.
    ...
    def match_expressions(self) -> Optional[Sequence['outputs.BucketSpecClassSelectorMatchExpressions']]:
        """
...
@pulumi.output_type
class BucketSpecClassSelectorMatchExpressions(dict):
    """
...
@pulumi.output_type
class BucketSpecResourceRef(dict):
    """
    A ResourceReference specifies an existing managed resource, in any namespace, to which this resource claim should attempt to bind. Omit the resource reference to enable dynamic provisioning using a resource class; the resource reference will be automatically populated by Crossplane.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class BucketSpecWriteConnectionSecretToRef(dict):
    """
    WriteConnectionSecretToReference specifies the name of a Secret, in the same namespace as this resource claim, to which any connection details for this resource claim should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource bound to this resource claim.
    """
    def __init__(__self__, *,
...
class BucketStatus(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['BucketStatusConditionsArgs'] conditions: Conditions of the resource.
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[Sequence['outputs.BucketStatusConditions']]:
        """
...
@pulumi.output_type
class BucketStatusConditions(dict):
    """
