...
class RedisCluster(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['RedisClusterSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['RedisClusterStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['RedisClusterSpecArgs']] spec: RedisClusterSpec specifies the desired state of a RedisCluster.
        :param pulumi.Input[pulumi.InputType['RedisClusterStatusArgs']] status: A ResourceClaimStatus represents the observed status of a resource claim.
        """
        ...
        if opts.id is None:
            ...
            __props__['api_version'] = 'cache.crossplane.io/v1alpha1'
            __props__['kind'] = 'RedisCluster'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(RedisCluster, __self__).__init__(
            'kubernetes:cache.crossplane.io/v1alpha1:RedisCluster',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RedisCluster':
        """
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.RedisClusterSpec']]:
        """
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.RedisClusterStatus']]:
        """
