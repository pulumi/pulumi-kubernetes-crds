...
class Provider(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['ProviderSpecArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['ProviderSpecArgs']] spec: A ProviderSpec defines the desired state of a Provider.
        """
        ...
        if opts.id is None:
            ...
            __props__['api_version'] = 'kubernetes.crossplane.io/v1alpha1'
            __props__['kind'] = 'Provider'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
        super(Provider, __self__).__init__(
            'kubernetes:kubernetes.crossplane.io/v1alpha1:Provider',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.ProviderSpec']]:
        """
