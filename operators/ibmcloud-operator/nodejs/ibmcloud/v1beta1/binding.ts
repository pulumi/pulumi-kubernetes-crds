...
export class Binding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:ibmcloud.ibm.com/v1beta1:Binding';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.ibmcloud.v1beta1.BindingSpec | undefined>;
    /**
     * BindingStatus defines the observed state of Binding
     */
    public readonly status!: pulumi.Output<outputs.ibmcloud.v1beta1.BindingStatus | undefined>;
...
export interface BindingArgs {
     ...
     * BindingSpec defines the desired state of Binding
     */
    readonly spec?: pulumi.Input<inputs.ibmcloud.v1beta1.BindingSpec>;
    /**
     * BindingStatus defines the observed state of Binding
     */
    readonly status?: pulumi.Input<inputs.ibmcloud.v1beta1.BindingStatus>;
}
