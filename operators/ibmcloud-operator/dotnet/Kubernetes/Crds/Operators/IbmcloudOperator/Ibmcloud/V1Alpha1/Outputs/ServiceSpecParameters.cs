...
namespace Pulumi.Kubernetes.Types.Outputs.Ibmcloud.V1Alpha1
{
    ...
    [OutputType]
    public sealed class ServiceSpecParameters
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Ibmcloud.V1Alpha1.ServiceSpecParametersValueFrom ValueFrom;

        [OutputConstructor]
        private ServiceSpecParameters(
            ...
            Pulumi.Kubernetes.Types.Outputs.Ibmcloud.V1Alpha1.ServiceSpecParametersValueFrom valueFrom)
        {
