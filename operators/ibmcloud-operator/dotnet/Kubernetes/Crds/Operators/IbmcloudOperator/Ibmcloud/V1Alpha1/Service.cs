...
namespace Pulumi.Pulumi.Kubernetes.Crds.Operators.IbmcloudOperator.Ibmcloud.V1Alpha1
{
    public partial class Service : KubernetesResource
    {
        ...
        public Service(string name, Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Alpha1.ServiceArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:ibmcloud.ibm.com/v1alpha1:Service", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal Service(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:ibmcloud.ibm.com/v1alpha1:Service", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:ibmcloud.ibm.com/v1alpha1:Service", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Alpha1.ServiceArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Alpha1.ServiceArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Alpha1.ServiceArgs();
