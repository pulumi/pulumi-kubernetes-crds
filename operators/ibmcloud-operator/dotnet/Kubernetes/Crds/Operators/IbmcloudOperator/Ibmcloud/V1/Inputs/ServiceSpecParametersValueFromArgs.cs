...
namespace Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1
{
    ...
    public class ServiceSpecParametersValueFromArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1.ServiceSpecParametersValueFromConfigMapKeyRefArgs>? ConfigMapKeyRef { get; set; }

        /// <summary>
        /// Selects a key of a secret in the resource namespace
        /// </summary>
        [Input("secretKeyRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1.ServiceSpecParametersValueFromSecretKeyRefArgs>? SecretKeyRef { get; set; }
