...
namespace Pulumi.Pulumi.Kubernetes.Crds.Operators.IbmcloudOperator.Ibmcloud.V1Alpha1
{
    ...
    public partial class Binding : KubernetesResource
    {
        ...
        public Binding(string name, Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Alpha1.BindingArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:ibmcloud.ibm.com/v1alpha1:Binding", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal Binding(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:ibmcloud.ibm.com/v1alpha1:Binding", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Binding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:ibmcloud.ibm.com/v1alpha1:Binding", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Alpha1.BindingArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Alpha1.BindingArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Alpha1.BindingArgs();
