...
namespace Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Beta1
{
    ...
    public class ServiceStatusArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("context")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Beta1.ServiceStatusContextArgs>? Context { get; set; }
        ...
        [Input("parameters")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Beta1.ServiceStatusParametersArgs>? _parameters;

        /// <summary>
        /// Parameters pass configuration to the service during creation
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Beta1.ServiceStatusParametersArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Beta1.ServiceStatusParametersArgs>());
