...
namespace Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Alpha1
{
    ...
    public class ServiceStatusParametersArgs : Pulumi.ResourceArgs
    {
        [Input("attributes")]
        ...
        /// </summary>
        [Input("valueFrom")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Ibmcloud.V1Alpha1.ServiceStatusParametersValueFromArgs>? ValueFrom { get; set; }

        public ServiceStatusParametersArgs()
        {
        }
    }
}
