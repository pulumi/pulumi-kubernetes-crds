...
func NewService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:ibmcloud.ibm.com/v1:Service", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetService(ctx *pulumi.Context,
	...
	var resource Service
	err := ctx.ReadResource("kubernetes:ibmcloud.ibm.com/v1:Service", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
