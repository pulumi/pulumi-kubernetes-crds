...
func NewBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:ibmcloud.ibm.com/v1alpha1:Binding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBinding(ctx *pulumi.Context,
	...
	var resource Binding
	err := ctx.ReadResource("kubernetes:ibmcloud.ibm.com/v1alpha1:Binding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
