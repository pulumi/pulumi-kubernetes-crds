...
class BindingSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] service_name: ServiceClass is the name of the service resource to bind
        :param pulumi.Input[str] alias: Alias is the name for the credentials to be aliased
        :param pulumi.Input[Sequence[pulumi.Input['BindingSpecParametersArgs']]] parameters: Parameters pass configuration to the service during creation
        :param pulumi.Input[str] role: Role is the role for the credentials
        :param pulumi.Input[str] secret_name: SecretName is the name of the secret where credentials will be stored
        :param pulumi.Input[str] service_namespace: ServiceNamespace is the namespace of the service resource to bind
        """
...
class BindingStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] instance_id: InstanceID is the instance ID for the service
        :param pulumi.Input[str] key_instance_id: KeyInstanceID is the key instance ID for the credentials
        :param pulumi.Input[str] message: Message is a detailed message on current status
        :param pulumi.Input[str] secret_name: SecretName is the name of the generated secret with service credentials
        :param pulumi.Input[str] state: State is a short name for the current status
        """
...
class ServiceSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] plan: Plan for the service from the IBM Cloud Catalog
        :param pulumi.Input[str] service_class: ServiceClass is the name of the service from the IBM Cloud Catalog
        :param pulumi.Input['ServiceSpecContextArgs'] context: ResourceContext defines the CloudFoundry context and resource group
        :param pulumi.Input[str] external_name: ExternalName is the name for the service as it appears on IBM Cloud
        :param pulumi.Input[Sequence[pulumi.Input['ServiceSpecParametersArgs']]] parameters: Parameters pass configuration to the service during creation
        :param pulumi.Input[str] service_class_type: ServiceClassType is set to CF if the service is CloundFoundry
        """
...
class ServiceStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] dashboard_url: DashboardURL is the dashboard URL for the service
        :param pulumi.Input[str] external_name: ExternalName is the name for the service as it appears on IBM Cloud
        :param pulumi.Input[str] instance_id: InstanceID is the instance ID for the service
        :param pulumi.Input[str] message: Message is a detailed message on current status
        :param pulumi.Input[Sequence[pulumi.Input['ServiceStatusParametersArgs']]] parameters: Parameters pass configuration to the service during creation
        :param pulumi.Input[str] state: State is a short name for the current status
        """
        pulumi.set(__self__, "plan", plan)
        pulumi.set(__self__, "service_class", service_class)
