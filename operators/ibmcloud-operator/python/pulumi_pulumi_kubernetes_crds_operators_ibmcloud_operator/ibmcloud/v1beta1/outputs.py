...
class BindingSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        BindingSpec defines the desired state of Binding
        :param str service_name: ServiceClass is the name of the service resource to bind
        :param str alias: Alias is the name for the credentials to be aliased
        :param Sequence['BindingSpecParametersArgs'] parameters: Parameters pass configuration to the service during creation
        :param str role: Role is the role for the credentials
        :param str secret_name: SecretName is the name of the secret where credentials will be stored
        :param str service_namespace: ServiceNamespace is the namespace of the service resource to bind
        """
...
class BindingStatus(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        BindingStatus defines the observed state of Binding
        :param str instance_id: InstanceID is the instance ID for the service
        :param str key_instance_id: KeyInstanceID is the key instance ID for the credentials
        :param str message: Message is a detailed message on current status
        :param str secret_name: SecretName is the name of the generated secret with service credentials
        :param str state: State is a short name for the current status
        """
...
class ServiceSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ServiceSpec defines the desired state of Service
        :param str plan: Plan for the service from the IBM Cloud Catalog
        :param str service_class: ServiceClass is the name of the service from the IBM Cloud Catalog
        :param 'ServiceSpecContextArgs' context: ResourceContext defines the CloudFoundry context and resource group
        :param str external_name: ExternalName is the name for the service as it appears on IBM Cloud
        :param Sequence['ServiceSpecParametersArgs'] parameters: Parameters pass configuration to the service during creation
        :param str service_class_type: ServiceClassType is set to CF if the service is CloundFoundry
        """
...
class ServiceStatus(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str dashboard_url: DashboardURL is the dashboard URL for the service
        :param str external_name: ExternalName is the name for the service as it appears on IBM Cloud
        :param str instance_id: InstanceID is the instance ID for the service
        :param str message: Message is a detailed message on current status
        :param Sequence['ServiceStatusParametersArgs'] parameters: Parameters pass configuration to the service during creation
        :param str state: State is a short name for the current status
        """
        pulumi.set(__self__, "plan", plan)
        pulumi.set(__self__, "service_class", service_class)
