...
namespace Pulumi.Kubernetes.Types.Inputs.Camel.V1Alpha1
{
    ...
    /// </summary>
    public class KameletBindingSpecSinkArgs : Pulumi.ResourceArgs
    {
        [Input("properties")]
        ...
        /// </summary>
        [Input("ref")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Camel.V1Alpha1.KameletBindingSpecSinkRefArgs>? Ref { get; set; }
        ...
        public KameletBindingSpecSinkArgs()
        {
        }
    }
}
