...
export namespace redhatcop {
    export namespace v1alpha1 {
        ...
        export interface GlobalDNSRecordSpec {
             ...
             */
            endpoints?: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecEndpoints[];
            /**
             * GlobalZoneRef represents the global zone that will be used to host this record
             */
            globalZoneRef: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecGlobalZoneRef;
            /**
             ...
             */
            healthCheck?: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecHealthCheck;
            /**
        ...
        export interface GlobalDNSRecordSpecEndpoints {
             ...
             */
            clusterCredentialRef: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecEndpointsClusterCredentialRef;
            /**
             ...
             */
            loadBalancerServiceRef: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecEndpointsLoadBalancerServiceRef;
        }
        ...
        export interface GlobalDNSRecordSpecHealthCheck {
             ...
             */
            exec?: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecHealthCheckExec;
            /**
             ...
             */
            httpGet?: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecHealthCheckHttpGet;
            /**
             ...
             */
            tcpSocket?: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecHealthCheckTcpSocket;
            /**
        ...
        export interface GlobalDNSRecordSpecHealthCheckHttpGet {
             ...
             */
            httpHeaders?: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecHealthCheckHttpGetHttpHeaders[];
            /**
             ...
             */
            port: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecHealthCheckHttpGetPort;
            /**
        ...
        export interface GlobalDNSRecordSpecHealthCheckTcpSocket {
             ...
             */
            port: outputs.redhatcop.v1alpha1.GlobalDNSRecordSpecHealthCheckTcpSocketPort;
        }
        ...
        export interface GlobalDNSRecordStatus {
             ...
             */
            conditions?: outputs.redhatcop.v1alpha1.GlobalDNSRecordStatusConditions[];
            /**
             ...
             */
            endpointStatuses?: {[key: string]: outputs.redhatcop.v1alpha1.GlobalDNSRecordStatusEndpointStatuses[]};
            /**
             * MonitoredServiceStatuses contains the reconcile status of each of the monitored services in the remote clusters
             */
            monitoredServiceStatuses?: {[key: string]: outputs.redhatcop.v1alpha1.GlobalDNSRecordStatusMonitoredServiceStatuses[]};
            /**
             * ProviderStatus contains provider specific status information
             */
            providerStatus?: outputs.redhatcop.v1alpha1.GlobalDNSRecordStatusProviderStatus;
        }
        ...
        export interface GlobalDNSRecordStatusProviderStatus {
            route53?: outputs.redhatcop.v1alpha1.GlobalDNSRecordStatusProviderStatusRoute53;
        }
        ...
        export interface GlobalDNSRecordStatusProviderStatusRoute53 {
             ...
             */
            healthCheckID?: {[key: string]: string};
            /**
        ...
        export interface GlobalDNSZoneSpec {
             ...
             */
            provider: outputs.redhatcop.v1alpha1.GlobalDNSZoneSpecProvider;
        }
        ...
        export interface GlobalDNSZoneSpecProvider {
             ...
             */
            externalDNS?: outputs.redhatcop.v1alpha1.GlobalDNSZoneSpecProviderExternalDNS;
            /**
             * Route53ProviderConfig contains configuration on how to access the route53 API
             */
            route53?: outputs.redhatcop.v1alpha1.GlobalDNSZoneSpecProviderRoute53;
        }
        ...
        export interface GlobalDNSZoneSpecProviderRoute53 {
             ...
             */
            credentialsSecretRef: outputs.redhatcop.v1alpha1.GlobalDNSZoneSpecProviderRoute53CredentialsSecretRef;
            /**
        ...
        export interface GlobalDNSZoneStatus {
             ...
             */
            conditions?: outputs.redhatcop.v1alpha1.GlobalDNSZoneStatusConditions[];
        }
        ...
        export interface GlobalRouteDiscoverySpec {
             ...
             */
            clusters?: outputs.redhatcop.v1alpha1.GlobalRouteDiscoverySpecClusters[];
            /**
             ...
             * GlobalZoneRef represents the global zone that will be used to host this record
             */
            globalZoneRef: outputs.redhatcop.v1alpha1.GlobalRouteDiscoverySpecGlobalZoneRef;
            /**
             * RouteSelector is the selector that selects the global routes, this allows you to define also local routes.
             */
            routeSelector?: outputs.redhatcop.v1alpha1.GlobalRouteDiscoverySpecRouteSelector;
        }
        ...
        export interface GlobalRouteDiscoverySpecClusters {
             ...
             * CredentialsSecretRef is a reference to a secret containing the credentials to access the cluster a key called "kubeconfig" containing a valid kubeconfig file for connecting to the cluster must exist in this secret.
             */
            clusterCredentialRef: outputs.redhatcop.v1alpha1.GlobalRouteDiscoverySpecClustersClusterCredentialRef;
            /**
             * ClusterName name of the cluster to connect to.
             */
            clusterName: string;
        ...
        export interface GlobalRouteDiscoverySpecRouteSelector {
             ...
             */
            matchExpressions?: outputs.redhatcop.v1alpha1.GlobalRouteDiscoverySpecRouteSelectorMatchExpressions[];
            /**
        ...
        export interface GlobalRouteDiscoveryStatus {
             ...
             */
            clusterReferenceStatuses?: {[key: string]: outputs.redhatcop.v1alpha1.GlobalRouteDiscoveryStatusClusterReferenceStatuses[]};
            /**
             * ReconcileStatus this is the general status of the main reconciler
             */
            conditions?: outputs.redhatcop.v1alpha1.GlobalRouteDiscoveryStatusConditions[];
        }
