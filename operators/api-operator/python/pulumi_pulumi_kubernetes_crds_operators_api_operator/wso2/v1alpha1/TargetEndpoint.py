...
class TargetEndpoint(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['TargetEndpointSpecArgs']]] = None,
        ...
        if opts.id is None:
            ...
            __props__['api_version'] = 'wso2.com/v1alpha1'
            __props__['kind'] = 'TargetEndpoint'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(TargetEndpoint, __self__).__init__(
            'kubernetes:wso2.com/v1alpha1:TargetEndpoint',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TargetEndpoint':
        """
        ...
        return TargetEndpoint(resource_name, opts=opts, __props__=__props__)
