...
class Security(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['SecuritySpecArgs']]] = None,
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'Security'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(Security, __self__).__init__(
            'kubernetes:wso2.com/v1alpha1:Security',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Security':
        """
