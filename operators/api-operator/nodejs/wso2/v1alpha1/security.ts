...
export class Security extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Security {
        return new Security(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:wso2.com/v1alpha1:Security';
    ...
    constructor(name: string, args?: SecurityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Security.__pulumiType, name, inputs, opts);
    }
}
