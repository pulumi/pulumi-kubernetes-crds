...
export class TargetEndpoint extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TargetEndpoint {
        return new TargetEndpoint(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:wso2.com/v1alpha1:TargetEndpoint';

    /**
     * Returns true if the given object is an instance of TargetEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TargetEndpoint {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TargetEndpoint.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: TargetEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            inputs["apiVersion"] = "wso2.com/v1alpha1";
            inputs["kind"] = "TargetEndpoint";
        ...
        super(TargetEndpoint.__pulumiType, name, inputs, opts);
    }
}
