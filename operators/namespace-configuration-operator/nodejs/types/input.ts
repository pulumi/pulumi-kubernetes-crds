...
export namespace redhatcop {
    export namespace v1alpha1 {
        ...
        export interface GroupConfigSpec {
             ...
             */
            annotationSelector?: pulumi.Input<inputs.redhatcop.v1alpha1.GroupConfigSpecAnnotationSelector>;
            /**
             * LabelSelector selects Groups by label.
             */
            labelSelector?: pulumi.Input<inputs.redhatcop.v1alpha1.GroupConfigSpecLabelSelector>;
            templates?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.GroupConfigSpecTemplates>[]>;
        }
        ...
        export interface GroupConfigSpecAnnotationSelector {
             ...
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.GroupConfigSpecAnnotationSelectorMatchExpressions>[]>;
            /**
        ...
        export interface GroupConfigSpecLabelSelector {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.GroupConfigSpecLabelSelectorMatchExpressions>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
             */
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        ...
        export interface GroupConfigSpecTemplates {
             ...
             */
            objectTemplate: pulumi.Input<string>;
        }
        ...
        export interface GroupConfigStatus {
             ...
             */
            conditions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.GroupConfigStatusConditions>[]>;
            /**
             * LockedResourceStatuses contains the reconcile status for each of the managed resources
             */
            lockedResourceStatuses?: pulumi.Input<{[key: string]: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.GroupConfigStatusLockedResourceStatuses>[]>}>;
        }
        ...
        export interface NamespaceConfigSpec {
             ...
             */
            annotationSelector?: pulumi.Input<inputs.redhatcop.v1alpha1.NamespaceConfigSpecAnnotationSelector>;
            /**
             * LabelSelector selects Namespaces by label.
             */
            labelSelector?: pulumi.Input<inputs.redhatcop.v1alpha1.NamespaceConfigSpecLabelSelector>;
            templates?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.NamespaceConfigSpecTemplates>[]>;
        }
        ...
        export interface NamespaceConfigSpecAnnotationSelector {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.NamespaceConfigSpecAnnotationSelectorMatchExpressions>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
             */
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        ...
        export interface NamespaceConfigSpecLabelSelector {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.NamespaceConfigSpecLabelSelectorMatchExpressions>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
             */
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        ...
        export interface NamespaceConfigStatus {
             ...
             * ReconcileStatus this is the general status of the main reconciler
             */
            conditions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.NamespaceConfigStatusConditions>[]>;
            /**
             * LockedResourceStatuses contains the reconcile status for each of the managed resources
             */
            lockedResourceStatuses?: pulumi.Input<{[key: string]: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.NamespaceConfigStatusLockedResourceStatuses>[]>}>;
        }
        ...
        export interface UserConfigSpec {
             ...
             */
            annotationSelector?: pulumi.Input<inputs.redhatcop.v1alpha1.UserConfigSpecAnnotationSelector>;
            /**
             ...
             */
            identityExtraFieldSelector?: pulumi.Input<inputs.redhatcop.v1alpha1.UserConfigSpecIdentityExtraFieldSelector>;
            /**
             * LabelSelector selects Users by label.
             */
            labelSelector?: pulumi.Input<inputs.redhatcop.v1alpha1.UserConfigSpecLabelSelector>;
            /**
            ...
            templates?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.UserConfigSpecTemplates>[]>;
        }
        ...
        export interface UserConfigSpecAnnotationSelector {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.UserConfigSpecAnnotationSelectorMatchExpressions>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
             */
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        ...
        export interface UserConfigSpecIdentityExtraFieldSelector {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.UserConfigSpecIdentityExtraFieldSelectorMatchExpressions>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
             */
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        ...
        export interface UserConfigSpecLabelSelector {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.UserConfigSpecLabelSelectorMatchExpressions>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
             */
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        ...
        export interface UserConfigStatus {
             ...
             * ReconcileStatus this is the general status of the main reconciler
             */
            conditions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.UserConfigStatusConditions>[]>;
            /**
             * LockedResourceStatuses contains the reconcile status for each of the managed resources
             */
            lockedResourceStatuses?: pulumi.Input<{[key: string]: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.UserConfigStatusLockedResourceStatuses>[]>}>;
        }
