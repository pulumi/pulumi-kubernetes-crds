...
class UserConfig(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['UserConfigSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['UserConfigStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'UserConfig'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(UserConfig, __self__).__init__(
            'kubernetes:redhatcop.redhat.io/v1alpha1:UserConfig',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'UserConfig':
        """
        ...
        return UserConfig(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.UserConfigSpec']]:
        """
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.UserConfigStatus']]:
        """
