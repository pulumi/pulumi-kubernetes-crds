...
func NewAPI(ctx *pulumi.Context,
	...
	var resource API
	err := ctx.RegisterResource("kubernetes:capabilities.3scale.net/v1alpha1:API", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAPI(ctx *pulumi.Context,
	...
	var resource API
	err := ctx.ReadResource("kubernetes:capabilities.3scale.net/v1alpha1:API", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
