...
namespace Pulumi.Kubernetes.Types.Outputs.Capabilities.V1Alpha1
{
    ...
    [OutputType]
    public sealed class APISpecIntegrationMethodCodePluginAuthenticationSettingsCredentialsApiKey
    {
        public readonly string AuthParameterName;
        public readonly string CredentialsLocation;

        [OutputConstructor]
        private APISpecIntegrationMethodCodePluginAuthenticationSettingsCredentialsApiKey(
