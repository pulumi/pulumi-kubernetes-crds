...
namespace Pulumi.Kubernetes.Types.Inputs.Capabilities.V1Beta1
{
    ...
    /// </summary>
    public class ProductSpecDeploymentApicastHostedAuthenticationUserkeyArgs : Pulumi.ResourceArgs
    {
        [Input("authUserKey")]
        ...
        /// </summary>
        [Input("security")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Capabilities.V1Beta1.ProductSpecDeploymentApicastHostedAuthenticationUserkeySecurityArgs>? Security { get; set; }

        public ProductSpecDeploymentApicastHostedAuthenticationUserkeyArgs()
        {
        }
    }
}
