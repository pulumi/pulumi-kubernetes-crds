...
namespace Pulumi.Kubernetes.Types.Inputs.Capabilities.V1Alpha1
{
    ...
    public class APISpecIntegrationMethodApicastHostedPoliciesSelectorArgs : Pulumi.ResourceArgs
    {
        ...
        public APISpecIntegrationMethodApicastHostedPoliciesSelectorArgs()
        {
        }
    }
}
