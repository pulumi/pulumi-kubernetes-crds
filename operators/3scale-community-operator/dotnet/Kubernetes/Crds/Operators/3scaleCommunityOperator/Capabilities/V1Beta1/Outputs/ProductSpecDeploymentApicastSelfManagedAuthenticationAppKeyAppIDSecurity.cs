...
namespace Pulumi.Kubernetes.Types.Outputs.Capabilities.V1Beta1
{
    ...
    [OutputType]
    public sealed class ProductSpecDeploymentApicastSelfManagedAuthenticationAppKeyAppIDSecurity
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ProductSpecDeploymentApicastSelfManagedAuthenticationAppKeyAppIDSecurity(
            string hostHeader,
