...
namespace Pulumi.Kubernetes.Types.Outputs.Capabilities.V1Beta1
{
    ...
    [OutputType]
    public sealed class ProductSpecDeploymentApicastSelfManagedAuthenticationUserkeySecurity
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ProductSpecDeploymentApicastSelfManagedAuthenticationUserkeySecurity(
            string hostHeader,
