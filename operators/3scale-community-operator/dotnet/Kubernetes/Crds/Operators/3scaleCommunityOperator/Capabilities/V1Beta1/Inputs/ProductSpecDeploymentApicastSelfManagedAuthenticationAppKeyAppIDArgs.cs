...
namespace Pulumi.Kubernetes.Types.Inputs.Capabilities.V1Beta1
{
    ...
    /// </summary>
    public class ProductSpecDeploymentApicastSelfManagedAuthenticationAppKeyAppIDArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("security")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Capabilities.V1Beta1.ProductSpecDeploymentApicastSelfManagedAuthenticationAppKeyAppIDSecurityArgs>? Security { get; set; }

        public ProductSpecDeploymentApicastSelfManagedAuthenticationAppKeyAppIDArgs()
        {
        }
    }
}
