...
namespace Pulumi.Kubernetes.Types.Outputs.Capabilities.V1Beta1
{
    ...
    [OutputType]
    public sealed class ProductSpecDeploymentApicastHostedAuthenticationAppKeyAppID
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Capabilities.V1Beta1.ProductSpecDeploymentApicastHostedAuthenticationAppKeyAppIDSecurity Security;

        [OutputConstructor]
        private ProductSpecDeploymentApicastHostedAuthenticationAppKeyAppID(
            string appID,
            ...
            Pulumi.Kubernetes.Types.Outputs.Capabilities.V1Beta1.ProductSpecDeploymentApicastHostedAuthenticationAppKeyAppIDSecurity security)
        {
            AppID = appID;
            AppKey = appKey;
