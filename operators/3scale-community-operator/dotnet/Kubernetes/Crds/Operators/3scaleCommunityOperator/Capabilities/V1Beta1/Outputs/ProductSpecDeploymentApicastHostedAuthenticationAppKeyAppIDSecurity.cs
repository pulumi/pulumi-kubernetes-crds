...
namespace Pulumi.Kubernetes.Types.Outputs.Capabilities.V1Beta1
{
    ...
    [OutputType]
    public sealed class ProductSpecDeploymentApicastHostedAuthenticationAppKeyAppIDSecurity
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ProductSpecDeploymentApicastHostedAuthenticationAppKeyAppIDSecurity(
            string hostHeader,
