...
export class APIManager extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): APIManager {
        return new APIManager(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:apps.3scale.net/v1alpha1:APIManager';

    /**
     * Returns true if the given object is an instance of APIManager.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is APIManager {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === APIManager.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: APIManagerArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            inputs["apiVersion"] = "apps.3scale.net/v1alpha1";
            inputs["kind"] = "APIManager";
        ...
        super(APIManager.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface APIManagerArgs {
