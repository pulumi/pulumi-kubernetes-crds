...
export class API extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:capabilities.3scale.net/v1alpha1:API';
    ...
    public readonly spec!: pulumi.Output<outputs.capabilities.v1alpha1.APISpec | undefined>;
...
export interface APIArgs {
    ...
    readonly spec?: pulumi.Input<inputs.capabilities.v1alpha1.APISpec>;
