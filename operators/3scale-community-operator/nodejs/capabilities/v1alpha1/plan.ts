...
export class Plan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:capabilities.3scale.net/v1alpha1:Plan';
    ...
    public readonly spec!: pulumi.Output<outputs.capabilities.v1alpha1.PlanSpec | undefined>;
...
export interface PlanArgs {
    ...
    readonly kind?: pulumi.Input<"Plan">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    readonly spec?: pulumi.Input<inputs.capabilities.v1alpha1.PlanSpec>;
