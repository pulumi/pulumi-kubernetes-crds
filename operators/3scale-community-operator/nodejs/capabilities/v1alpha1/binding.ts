...
export class Binding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:capabilities.3scale.net/v1alpha1:Binding';
    ...
    public readonly spec!: pulumi.Output<outputs.capabilities.v1alpha1.BindingSpec | undefined>;
    public readonly status!: pulumi.Output<outputs.capabilities.v1alpha1.BindingStatus | undefined>;
...
export interface BindingArgs {
    ...
    readonly spec?: pulumi.Input<inputs.capabilities.v1alpha1.BindingSpec>;
    readonly status?: pulumi.Input<inputs.capabilities.v1alpha1.BindingStatus>;
}
