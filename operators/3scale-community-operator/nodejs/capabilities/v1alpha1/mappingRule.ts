...
export class MappingRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:capabilities.3scale.net/v1alpha1:MappingRule';
    ...
    public readonly kind!: pulumi.Output<"MappingRule" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    public readonly spec!: pulumi.Output<outputs.capabilities.v1alpha1.MappingRuleSpec | undefined>;
    ...
    constructor(name: string, args?: MappingRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MappingRule.__pulumiType, name, inputs, opts);
    }
}
...
export interface MappingRuleArgs {
    ...
    readonly kind?: pulumi.Input<"MappingRule">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    readonly spec?: pulumi.Input<inputs.capabilities.v1alpha1.MappingRuleSpec>;
