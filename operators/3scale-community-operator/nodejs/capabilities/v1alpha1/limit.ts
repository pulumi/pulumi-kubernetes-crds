...
export class Limit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:capabilities.3scale.net/v1alpha1:Limit';
    ...
    public readonly kind!: pulumi.Output<"Limit" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    public readonly spec!: pulumi.Output<outputs.capabilities.v1alpha1.LimitSpec | undefined>;
    ...
    constructor(name: string, args?: LimitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Limit.__pulumiType, name, inputs, opts);
    }
}
...
export interface LimitArgs {
    ...
    readonly kind?: pulumi.Input<"Limit">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    readonly spec?: pulumi.Input<inputs.capabilities.v1alpha1.LimitSpec>;
