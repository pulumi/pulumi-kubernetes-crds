...
class APIManager(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['APIManagerSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['APIManagerStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'APIManager'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(APIManager, __self__).__init__(
            'kubernetes:apps.3scale.net/v1alpha1:APIManager',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'APIManager':
        """
        ...
        return APIManager(resource_name, opts=opts, __props__=__props__)
