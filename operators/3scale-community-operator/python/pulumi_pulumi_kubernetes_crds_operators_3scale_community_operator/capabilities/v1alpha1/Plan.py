...
class Plan(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['PlanSpecArgs']]] = None,
        ...
        super(Plan, __self__).__init__(
            'kubernetes:capabilities.3scale.net/v1alpha1:Plan',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.PlanSpec']]:
