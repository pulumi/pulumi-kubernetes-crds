...
class Metric(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['MetricSpecArgs']]] = None,
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'Metric'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(Metric, __self__).__init__(
            'kubernetes:capabilities.3scale.net/v1alpha1:Metric',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.MetricSpec']]:
