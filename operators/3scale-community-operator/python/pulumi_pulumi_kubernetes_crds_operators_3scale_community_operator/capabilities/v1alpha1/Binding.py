...
class Binding(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['BindingSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['BindingStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        super(Binding, __self__).__init__(
            'kubernetes:capabilities.3scale.net/v1alpha1:Binding',
            resource_name,
            __props__,
            opts)
