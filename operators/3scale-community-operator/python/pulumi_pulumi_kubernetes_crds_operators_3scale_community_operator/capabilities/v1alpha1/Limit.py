...
class Limit(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['LimitSpecArgs']]] = None,
                 status: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        Create a Limit resource with the given unique name, props, and options.
        ...
        if opts.id is None:
            ...
            __props__['api_version'] = 'capabilities.3scale.net/v1alpha1'
            __props__['kind'] = 'Limit'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(Limit, __self__).__init__(
            'kubernetes:capabilities.3scale.net/v1alpha1:Limit',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.LimitSpec']]:
