...
class ClusterManagerSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] registration_image_pull_spec: RegistrationImagePullSpec represents the desired image of registration controller/webhook installed on hub.
        :param pulumi.Input[str] work_image_pull_spec: WorkImagePullSpec represents the desired image configuration of work controller/webhook installed on hub.
        """
...
class ClusterManagerStatusArgs:
    def __init__(__self__, *,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusConditionsArgs']]]] = None,
                 generations: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusGenerationsArgs']]]] = None,
                 observed_generation: Optional[pulumi.Input[int]] = None,
                 related_resources: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusRelatedResourcesArgs']]]] = None):
        """
        Status represents the current status of controllers that govern the lifecycle of managed clusters.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusConditionsArgs']]] conditions: Conditions contain the different condition statuses for this ClusterManager. Valid condition types are: Applied: components in hub are applied. Available: components in hub are available and ready to serve. Progressing: components in hub are in a transitioning state. Degraded: components in hub do not match the desired configuration and only provide degraded service.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusGenerationsArgs']]] generations: Generations are used to determine when an item needs to be reconciled or has changed in a way that needs a reaction.
        :param pulumi.Input[int] observed_generation: ObservedGeneration is the last generation change you've dealt with
        :param pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusRelatedResourcesArgs']]] related_resources: RelatedResources are used to track the resources that are related to this ClusterManager
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusConditionsArgs']]]]:
        """
        Conditions contain the different condition statuses for this ClusterManager. Valid condition types are: Applied: components in hub are applied. Available: components in hub are available and ready to serve. Progressing: components in hub are in a transitioning state. Degraded: components in hub do not match the desired configuration and only provide degraded service.
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusConditionsArgs']]]]):
        pulumi.set(self, "conditions", value)

    @property
    @pulumi.getter
    def generations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusGenerationsArgs']]]]:
        """
    ...
    @generations.setter
    def generations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusGenerationsArgs']]]]):
    ...
    def related_resources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusRelatedResourcesArgs']]]]:
        """
    ...
    def related_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterManagerStatusRelatedResourcesArgs']]]]):
