...
namespace Pulumi.Kubernetes.Types.Inputs.Keycloak.V1Alpha1
{
    ...
    /// </summary>
    public class KeycloakClientSpecClientArgs : Pulumi.ResourceArgs
    {
        [Input("access")]
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Keycloak.V1Alpha1.KeycloakClientSpecClientProtocolMappersArgs>? _protocolMappers;

        /// <summary>
        /// Protocol Mappers.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Keycloak.V1Alpha1.KeycloakClientSpecClientProtocolMappersArgs> ProtocolMappers
        {
            get => _protocolMappers ?? (_protocolMappers = new InputList<Pulumi.Kubernetes.Types.Inputs.Keycloak.V1Alpha1.KeycloakClientSpecClientProtocolMappersArgs>());
        ...
        public KeycloakClientSpecClientArgs()
        {
        }
    }
}
