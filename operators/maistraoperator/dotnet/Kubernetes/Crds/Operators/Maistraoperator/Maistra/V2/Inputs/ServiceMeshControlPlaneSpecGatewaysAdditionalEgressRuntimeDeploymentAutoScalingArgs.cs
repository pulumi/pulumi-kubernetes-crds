...
namespace Pulumi.Kubernetes.Types.Inputs.Maistra.V2
{
    ...
    public class ServiceMeshControlPlaneSpecGatewaysAdditionalEgressRuntimeDeploymentAutoScalingArgs : Pulumi.ResourceArgs
    {
        [Input("enabled")]
        ...
        public ServiceMeshControlPlaneSpecGatewaysAdditionalEgressRuntimeDeploymentAutoScalingArgs()
        {
        }
    }
}
