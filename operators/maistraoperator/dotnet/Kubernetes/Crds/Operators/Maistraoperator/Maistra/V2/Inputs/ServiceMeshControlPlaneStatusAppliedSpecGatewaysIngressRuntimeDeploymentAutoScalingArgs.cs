...
namespace Pulumi.Kubernetes.Types.Inputs.Maistra.V2
{
    ...
    public class ServiceMeshControlPlaneStatusAppliedSpecGatewaysIngressRuntimeDeploymentAutoScalingArgs : Pulumi.ResourceArgs
    {
        [Input("enabled")]
        ...
        public ServiceMeshControlPlaneStatusAppliedSpecGatewaysIngressRuntimeDeploymentAutoScalingArgs()
        {
        }
    }
}
