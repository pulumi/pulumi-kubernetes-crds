...
namespace Pulumi.Kubernetes.Types.Inputs.Maistra.V2
{
    ...
    public class ServiceMeshControlPlaneStatusAppliedSpecGatewaysEgressServiceArgs : Pulumi.ResourceArgs
    {
        [Input("clusterIP")]
        ...
        [Input("metadata")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysEgressServiceMetadataArgs>? Metadata { get; set; }

        [Input("ports")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysEgressServicePortsArgs>? _ports;
        public InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysEgressServicePortsArgs> Ports
        {
            get => _ports ?? (_ports = new InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysEgressServicePortsArgs>());
            set => _ports = value;
        }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysEgressServiceSessionAffinityConfigArgs>? SessionAffinityConfig { get; set; }
        ...
        public ServiceMeshControlPlaneStatusAppliedSpecGatewaysEgressServiceArgs()
        {
        }
    }
}
