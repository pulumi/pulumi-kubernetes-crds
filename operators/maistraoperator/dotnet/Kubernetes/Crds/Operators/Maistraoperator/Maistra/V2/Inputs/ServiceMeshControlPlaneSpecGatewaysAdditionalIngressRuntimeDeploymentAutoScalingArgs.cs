...
namespace Pulumi.Kubernetes.Types.Inputs.Maistra.V2
{
    ...
    public class ServiceMeshControlPlaneSpecGatewaysAdditionalIngressRuntimeDeploymentAutoScalingArgs : Pulumi.ResourceArgs
    {
        [Input("enabled")]
        ...
        public ServiceMeshControlPlaneSpecGatewaysAdditionalIngressRuntimeDeploymentAutoScalingArgs()
        {
        }
    }
}
