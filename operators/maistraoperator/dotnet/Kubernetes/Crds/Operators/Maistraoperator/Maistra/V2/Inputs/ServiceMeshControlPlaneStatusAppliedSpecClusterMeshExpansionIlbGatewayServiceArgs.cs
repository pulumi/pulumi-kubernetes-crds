...
namespace Pulumi.Kubernetes.Types.Inputs.Maistra.V2
{
    ...
    public class ServiceMeshControlPlaneStatusAppliedSpecClusterMeshExpansionIlbGatewayServiceArgs : Pulumi.ResourceArgs
    {
        [Input("clusterIP")]
        ...
        [Input("metadata")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecClusterMeshExpansionIlbGatewayServiceMetadataArgs>? Metadata { get; set; }

        [Input("ports")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecClusterMeshExpansionIlbGatewayServicePortsArgs>? _ports;
        public InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecClusterMeshExpansionIlbGatewayServicePortsArgs> Ports
        {
            get => _ports ?? (_ports = new InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecClusterMeshExpansionIlbGatewayServicePortsArgs>());
            set => _ports = value;
        }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecClusterMeshExpansionIlbGatewayServiceSessionAffinityConfigArgs>? SessionAffinityConfig { get; set; }
        ...
        public ServiceMeshControlPlaneStatusAppliedSpecClusterMeshExpansionIlbGatewayServiceArgs()
        {
        }
    }
}
