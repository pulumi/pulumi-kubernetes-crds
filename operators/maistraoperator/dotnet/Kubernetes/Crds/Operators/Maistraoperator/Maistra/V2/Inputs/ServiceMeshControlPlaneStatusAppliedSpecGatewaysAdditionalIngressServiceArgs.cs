...
namespace Pulumi.Kubernetes.Types.Inputs.Maistra.V2
{
    ...
    public class ServiceMeshControlPlaneStatusAppliedSpecGatewaysAdditionalIngressServiceArgs : Pulumi.ResourceArgs
    {
        [Input("clusterIP")]
        ...
        [Input("metadata")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysAdditionalIngressServiceMetadataArgs>? Metadata { get; set; }

        [Input("ports")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysAdditionalIngressServicePortsArgs>? _ports;
        public InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysAdditionalIngressServicePortsArgs> Ports
        {
            get => _ports ?? (_ports = new InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysAdditionalIngressServicePortsArgs>());
            set => _ports = value;
        }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysAdditionalIngressServiceSessionAffinityConfigArgs>? SessionAffinityConfig { get; set; }
        ...
        public ServiceMeshControlPlaneStatusAppliedSpecGatewaysAdditionalIngressServiceArgs()
        {
        }
    }
}
