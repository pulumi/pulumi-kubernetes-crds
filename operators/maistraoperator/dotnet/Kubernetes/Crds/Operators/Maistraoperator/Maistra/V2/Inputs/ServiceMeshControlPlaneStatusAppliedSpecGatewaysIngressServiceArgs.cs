...
namespace Pulumi.Kubernetes.Types.Inputs.Maistra.V2
{
    ...
    public class ServiceMeshControlPlaneStatusAppliedSpecGatewaysIngressServiceArgs : Pulumi.ResourceArgs
    {
        [Input("clusterIP")]
        ...
        [Input("metadata")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysIngressServiceMetadataArgs>? Metadata { get; set; }

        [Input("ports")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysIngressServicePortsArgs>? _ports;
        public InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysIngressServicePortsArgs> Ports
        {
            get => _ports ?? (_ports = new InputList<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysIngressServicePortsArgs>());
            set => _ports = value;
        }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Maistra.V2.ServiceMeshControlPlaneStatusAppliedSpecGatewaysIngressServiceSessionAffinityConfigArgs>? SessionAffinityConfig { get; set; }
        ...
        public ServiceMeshControlPlaneStatusAppliedSpecGatewaysIngressServiceArgs()
        {
        }
    }
}
