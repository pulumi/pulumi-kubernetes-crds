...
namespace Pulumi.Kubernetes.Types.Outputs.Maistra.V2
{
    ...
    [OutputType]
    public sealed class ServiceMeshControlPlaneSpecGatewaysAdditionalEgressRuntimeDeploymentAutoScaling
    {
        ...
        [OutputConstructor]
        private ServiceMeshControlPlaneSpecGatewaysAdditionalEgressRuntimeDeploymentAutoScaling(
            bool enabled,
