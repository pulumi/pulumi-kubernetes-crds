...
namespace Pulumi.Kubernetes.Types.Outputs.Maistra.V2
{
    ...
    [OutputType]
    public sealed class ServiceMeshControlPlaneStatusAppliedSpecGatewaysEgressRuntimeDeploymentAutoScaling
    {
        ...
        [OutputConstructor]
        private ServiceMeshControlPlaneStatusAppliedSpecGatewaysEgressRuntimeDeploymentAutoScaling(
            bool enabled,
