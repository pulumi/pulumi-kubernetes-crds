...
namespace Pulumi.Kubernetes.Types.Outputs.Maistra.V2
{
    ...
    [OutputType]
    public sealed class ServiceMeshControlPlaneSpecGatewaysAdditionalIngressRuntimeDeploymentAutoScaling
    {
        ...
        [OutputConstructor]
        private ServiceMeshControlPlaneSpecGatewaysAdditionalIngressRuntimeDeploymentAutoScaling(
            bool enabled,
