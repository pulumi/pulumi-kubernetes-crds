...
namespace Pulumi.Kubernetes.Types.Inputs.Maistra.V2
{
    ...
    public class ServiceMeshControlPlaneSpecRuntimeComponentsDeploymentAutoScalingArgs : Pulumi.ResourceArgs
    {
        [Input("enabled")]
        ...
        public ServiceMeshControlPlaneSpecRuntimeComponentsDeploymentAutoScalingArgs()
        {
        }
    }
}
