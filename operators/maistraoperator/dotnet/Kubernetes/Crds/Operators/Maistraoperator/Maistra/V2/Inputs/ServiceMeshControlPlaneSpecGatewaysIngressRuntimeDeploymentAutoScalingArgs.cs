...
namespace Pulumi.Kubernetes.Types.Inputs.Maistra.V2
{
    ...
    public class ServiceMeshControlPlaneSpecGatewaysIngressRuntimeDeploymentAutoScalingArgs : Pulumi.ResourceArgs
    {
        [Input("enabled")]
        ...
        public ServiceMeshControlPlaneSpecGatewaysIngressRuntimeDeploymentAutoScalingArgs()
        {
        }
    }
}
