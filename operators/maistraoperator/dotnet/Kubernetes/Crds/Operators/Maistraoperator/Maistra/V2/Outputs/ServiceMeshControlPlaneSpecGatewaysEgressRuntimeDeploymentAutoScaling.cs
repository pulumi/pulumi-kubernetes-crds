...
namespace Pulumi.Kubernetes.Types.Outputs.Maistra.V2
{
    ...
    [OutputType]
    public sealed class ServiceMeshControlPlaneSpecGatewaysEgressRuntimeDeploymentAutoScaling
    {
        ...
        [OutputConstructor]
        private ServiceMeshControlPlaneSpecGatewaysEgressRuntimeDeploymentAutoScaling(
            bool enabled,
