...
namespace Pulumi.Kubernetes.Types.Outputs.Ibmcloud.V1Alpha1
{
    ...
    [OutputType]
    public sealed class TopicSpecConfigs
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Ibmcloud.V1Alpha1.TopicSpecConfigsValueFrom ValueFrom;

        [OutputConstructor]
        private TopicSpecConfigs(
            ...
            Pulumi.Kubernetes.Types.Outputs.Ibmcloud.V1Alpha1.TopicSpecConfigsValueFrom valueFrom)
        {
