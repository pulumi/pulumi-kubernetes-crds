...
class Topic(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['TopicSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['TopicStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'Topic'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(Topic, __self__).__init__(
            'kubernetes:ibmcloud.ibm.com/v1alpha1:Topic',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.TopicSpec']]:
        return pulumi.get(self, "spec")

    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.TopicStatus']]:
