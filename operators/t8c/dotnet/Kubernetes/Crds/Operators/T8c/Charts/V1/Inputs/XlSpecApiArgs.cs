...
namespace Pulumi.Kubernetes.Types.Inputs.Charts.V1
{
    ...
    public class XlSpecApiArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        /// </summary>
        [Input("image")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Charts.V1.XlSpecApiImageArgs>? Image { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Charts.V1.XlSpecApiResourcesArgs>? Resources { get; set; }

        public XlSpecApiArgs()
        {
        }
    }
}
