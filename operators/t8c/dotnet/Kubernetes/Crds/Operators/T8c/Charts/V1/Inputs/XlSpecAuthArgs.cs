...
namespace Pulumi.Kubernetes.Types.Inputs.Charts.V1
{
    ...
    public class XlSpecAuthArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        /// </summary>
        [Input("image")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Charts.V1.XlSpecAuthImageArgs>? Image { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Charts.V1.XlSpecAuthResourcesArgs>? Resources { get; set; }

        public XlSpecAuthArgs()
        {
        }
    }
}
