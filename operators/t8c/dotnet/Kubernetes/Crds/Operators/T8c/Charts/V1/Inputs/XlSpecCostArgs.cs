...
namespace Pulumi.Kubernetes.Types.Inputs.Charts.V1
{
    ...
    public class XlSpecCostArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        /// </summary>
        [Input("image")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Charts.V1.XlSpecCostImageArgs>? Image { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Charts.V1.XlSpecCostResourcesArgs>? Resources { get; set; }

        public XlSpecCostArgs()
        {
        }
    }
}
