...
namespace Pulumi.Kubernetes.Types.Inputs.Charts.V1
{
    ...
    public class XlSpecMarketArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        /// </summary>
        [Input("image")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Charts.V1.XlSpecMarketImageArgs>? Image { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Charts.V1.XlSpecMarketResourcesArgs>? Resources { get; set; }

        public XlSpecMarketArgs()
        {
        }
    }
}
