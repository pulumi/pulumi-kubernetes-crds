...
namespace Pulumi.Kubernetes.Types.Inputs.Charts.V1
{
    ...
    public class XlSpecGroupArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        /// </summary>
        [Input("image")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Charts.V1.XlSpecGroupImageArgs>? Image { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Charts.V1.XlSpecGroupResourcesArgs>? Resources { get; set; }

        public XlSpecGroupArgs()
        {
        }
    }
}
