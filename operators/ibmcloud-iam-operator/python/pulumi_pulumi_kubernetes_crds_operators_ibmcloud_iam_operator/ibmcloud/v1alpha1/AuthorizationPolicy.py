...
class AuthorizationPolicy(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['AuthorizationPolicySpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['AuthorizationPolicyStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['AuthorizationPolicySpecArgs']] spec: AuthorizationPolicySpec defines the desired state of AuthorizationPolicy
        :param pulumi.Input[pulumi.InputType['AuthorizationPolicyStatusArgs']] status: AuthorizationPolicyStatus defines the observed state of AuthorizationPolicy
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'AuthorizationPolicy'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(AuthorizationPolicy, __self__).__init__(
            'kubernetes:ibmcloud.ibm.com/v1alpha1:AuthorizationPolicy',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.AuthorizationPolicySpec']]:
        """
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.AuthorizationPolicyStatus']]:
        """
