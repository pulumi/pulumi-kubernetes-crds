...
export class AccessGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccessGroup {
        return new AccessGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:ibmcloud.ibm.com/v1alpha1:AccessGroup';
    ...
    public readonly kind!: pulumi.Output<"AccessGroup" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * AccessGroupSpec defines the desired state of AccessGroup
     */
    public readonly spec!: pulumi.Output<outputs.ibmcloud.v1alpha1.AccessGroupSpec | undefined>;
    /**
     * AccessGroupStatus defines the observed state of AccessGroup
     */
    public readonly status!: pulumi.Output<outputs.ibmcloud.v1alpha1.AccessGroupStatus | undefined>;
...
export interface AccessGroupArgs {
    ...
    readonly kind?: pulumi.Input<"AccessGroup">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * AccessGroupSpec defines the desired state of AccessGroup
     */
    readonly spec?: pulumi.Input<inputs.ibmcloud.v1alpha1.AccessGroupSpec>;
    /**
     * AccessGroupStatus defines the observed state of AccessGroup
     */
    readonly status?: pulumi.Input<inputs.ibmcloud.v1alpha1.AccessGroupStatus>;
}
