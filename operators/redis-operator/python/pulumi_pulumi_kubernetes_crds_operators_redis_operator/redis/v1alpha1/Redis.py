...
class Redis(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[Mapping[str, Any]] spec: RedisSpec defines the desired state of Redis
        :param pulumi.Input[Mapping[str, Any]] status: RedisStatus defines the observed state of Redis
        """
        ...
        if opts.id is None:
            ...
            __props__['api_version'] = 'redis.opstreelabs.in/v1alpha1'
            __props__['kind'] = 'Redis'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(Redis, __self__).__init__(
            'kubernetes:redis.opstreelabs.in/v1alpha1:Redis',
            resource_name,
            __props__,
            opts)
