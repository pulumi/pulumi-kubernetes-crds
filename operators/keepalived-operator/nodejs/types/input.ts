...
export namespace redhatcop {
    export namespace v1alpha1 {
        ...
        export interface KeepalivedGroupSpec {
            ...
            verbatimConfig?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }
        ...
        export interface KeepalivedGroupStatus {
             ...
             */
            conditions?: pulumi.Input<pulumi.Input<inputs.redhatcop.v1alpha1.KeepalivedGroupStatusConditions>[]>;
            routerIDs?: pulumi.Input<{[key: string]: pulumi.Input<number>}>;
        }
