...
__all__ = [
    ...
    'CSIScaleOperatorSpecTolerations',
...
class CSIScaleOperatorSpec(dict):
    def __init__(__self__, *,
                 ...
                 attacher_node_selector: Optional[Sequence['outputs.CSIScaleOperatorSpecAttacherNodeSelector']] = None,
                 clusters: Optional[Sequence['outputs.CSIScaleOperatorSpecClusters']] = None,
                 driver_registrar: Optional[str] = None,
                 image_pull_secrets: Optional[Sequence[str]] = None,
                 node_mapping: Optional[Sequence['outputs.CSIScaleOperatorSpecNodeMapping']] = None,
                 plugin_node_selector: Optional[Sequence['outputs.CSIScaleOperatorSpecPluginNodeSelector']] = None,
                 provisioner: Optional[str] = None,
                 provisioner_node_selector: Optional[Sequence['outputs.CSIScaleOperatorSpecProvisionerNodeSelector']] = None,
                 secret_counter: Optional[int] = None,
                 spectrum_scale: Optional[str] = None,
                 tolerations: Optional[Sequence['outputs.CSIScaleOperatorSpecTolerations']] = None,
        ...
        :param Sequence['CSIScaleOperatorSpecAttacherNodeSelectorArgs'] attacher_node_selector: Node selector for attacher sidecar.
        :param Sequence['CSIScaleOperatorSpecClustersArgs'] clusters: A collection of gpfs cluster properties for the csi driver to mount.
        :param str driver_registrar: Sidecar container image for the csi spectrum scale plugin pods.
        :param Sequence[str] image_pull_secrets: A passthrough option that distributes an imagePullSecrets array to the containers generated by the csi scale operator. Please refer to official k8s documentation for your environment for more details.
        :param Sequence['CSIScaleOperatorSpecNodeMappingArgs'] node_mapping: Mapping of K8s node with SpectrumScale node.
        :param Sequence['CSIScaleOperatorSpecPluginNodeSelectorArgs'] plugin_node_selector: Node selector for SpectrumScale CSI Plugin.
        :param str provisioner: Provisioner image for csi (actually issues provision requests).
        :param Sequence['CSIScaleOperatorSpecProvisionerNodeSelectorArgs'] provisioner_node_selector: Node selector for provisioner sidecar.
        :param int secret_counter: An internal counter used by the operator to trigger reloads on secret change.
        :param str spectrum_scale: Image name for the csi spectrum scale plugin container.
        :param Sequence['CSIScaleOperatorSpecTolerationsArgs'] tolerations: Array of tolerations that will be distribued to CSI pods. Please refer to official k8s documentation for your environment for more details.
    ...
    def attacher_node_selector(self) -> Optional[Sequence['outputs.CSIScaleOperatorSpecAttacherNodeSelector']]:
        """
    ...
    @property
    @pulumi.getter
    def clusters(self) -> Optional[Sequence['outputs.CSIScaleOperatorSpecClusters']]:
        """
    ...
    def node_mapping(self) -> Optional[Sequence['outputs.CSIScaleOperatorSpecNodeMapping']]:
        """
    ...
    def plugin_node_selector(self) -> Optional[Sequence['outputs.CSIScaleOperatorSpecPluginNodeSelector']]:
        """
    ...
    def provisioner_node_selector(self) -> Optional[Sequence['outputs.CSIScaleOperatorSpecProvisionerNodeSelector']]:
        """
    ...
    def secret_counter(self) -> Optional[int]:
        """
    ...
    @property
    @pulumi.getter
    def tolerations(self) -> Optional[Sequence['outputs.CSIScaleOperatorSpecTolerations']]:
        """
...
class CSIScaleOperatorSpecClusters(dict):
    def __init__(__self__, *,
                 ...
                 rest_api: Optional[Sequence['outputs.CSIScaleOperatorSpecClustersRestApi']] = None,
        ...
        :param Sequence['CSIScaleOperatorSpecClustersRestApiArgs'] rest_api: A collection of targets for REST calls.
    ...
    def rest_api(self) -> Optional[Sequence['outputs.CSIScaleOperatorSpecClustersRestApi']]:
        """
...
class CSIScaleOperatorSpecClustersRestApi(dict):
    def __init__(__self__, *,
        ...
        :param int gui_port: The port number running the REST server.
        """
    ...
    def gui_port(self) -> Optional[int]:
        """
...
@pulumi.output_type
class CSIScaleOperatorSpecTolerations(dict):
    def __init__(__self__, *,
                 effect: str,
                 key: str,
                 operator: str,
                 ...
                 value: Optional[str] = None):
        """
        :param str effect: Valid values are "NoSchedule", "PreferNoSchedule" and "NoExecute". An empty effect matches all effects with given key.
        :param str key: Node taint key name
        :param str operator: Valid values are "Exists" and "Equal".
        :param int toleration_seconds: Used only when effect is "NoExecute". It determines how long the pod will stay bound to the node after the taint is added.
        :param str value: Required if operator is "Equal"
        """
...
class CSIScaleOperatorStatus(dict):
    def __init__(__self__, *,
                 conditions: Optional[Sequence['outputs.CSIScaleOperatorStatusConditions']] = None):
        """
        :param Sequence['CSIScaleOperatorStatusConditionsArgs'] conditions: The active status of the operator
        """
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[Sequence['outputs.CSIScaleOperatorStatusConditions']]:
        """
