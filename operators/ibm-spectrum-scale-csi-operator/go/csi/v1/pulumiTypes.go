...
type CSIScaleOperatorSpec struct {
	...
	Tolerations []CSIScaleOperatorSpecTolerations `pulumi:"tolerations"`
...
type CSIScaleOperatorSpecArgs struct {
	...
	// Array of tolerations that will be distribued to CSI pods. Please refer to official k8s documentation for your environment for more details.
	Tolerations CSIScaleOperatorSpecTolerationsArrayInput `pulumi:"tolerations"`
	// A generic trigger to be used in kickin off the ansible operator.
...
// A passthrough option that distributes an imagePullSecrets array to the containers generated by the csi scale operator. Please refer to official k8s documentation for your environment for more details.
func (o CSIScaleOperatorSpecOutput) ImagePullSecrets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v CSIScaleOperatorSpec) []string { return v.ImagePullSecrets }).(pulumi.StringArrayOutput)
}
...
// Array of tolerations that will be distribued to CSI pods. Please refer to official k8s documentation for your environment for more details.
func (o CSIScaleOperatorSpecOutput) Tolerations() CSIScaleOperatorSpecTolerationsArrayOutput {
	return o.ApplyT(func(v CSIScaleOperatorSpec) []CSIScaleOperatorSpecTolerations { return v.Tolerations }).(CSIScaleOperatorSpecTolerationsArrayOutput)
}
...
// A passthrough option that distributes an imagePullSecrets array to the containers generated by the csi scale operator. Please refer to official k8s documentation for your environment for more details.
func (o CSIScaleOperatorSpecPtrOutput) ImagePullSecrets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *CSIScaleOperatorSpec) []string {
		if v == nil {
			return nil
		}
...
// Array of tolerations that will be distribued to CSI pods. Please refer to official k8s documentation for your environment for more details.
func (o CSIScaleOperatorSpecPtrOutput) Tolerations() CSIScaleOperatorSpecTolerationsArrayOutput {
	return o.ApplyT(func(v *CSIScaleOperatorSpec) []CSIScaleOperatorSpecTolerations {
		if v == nil {
			return nil
		}
		return v.Tolerations
	}).(CSIScaleOperatorSpecTolerationsArrayOutput)
}
...
type CSIScaleOperatorSpecTolerations struct {
...
// CSIScaleOperatorSpecTolerationsInput is an input type that accepts CSIScaleOperatorSpecTolerationsArgs and CSIScaleOperatorSpecTolerationsOutput values.
// You can construct a concrete instance of `CSIScaleOperatorSpecTolerationsInput` via:
//
//          CSIScaleOperatorSpecTolerationsArgs{...}
type CSIScaleOperatorSpecTolerationsInput interface {
	pulumi.Input

	ToCSIScaleOperatorSpecTolerationsOutput() CSIScaleOperatorSpecTolerationsOutput
	ToCSIScaleOperatorSpecTolerationsOutputWithContext(context.Context) CSIScaleOperatorSpecTolerationsOutput
}

type CSIScaleOperatorSpecTolerationsArgs struct {
	// Valid values are "NoSchedule", "PreferNoSchedule" and "NoExecute". An empty effect matches all effects with given key.
...
func (CSIScaleOperatorSpecTolerationsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*CSIScaleOperatorSpecTolerations)(nil)).Elem()
}

func (i CSIScaleOperatorSpecTolerationsArgs) ToCSIScaleOperatorSpecTolerationsOutput() CSIScaleOperatorSpecTolerationsOutput {
	return i.ToCSIScaleOperatorSpecTolerationsOutputWithContext(context.Background())
}

func (i CSIScaleOperatorSpecTolerationsArgs) ToCSIScaleOperatorSpecTolerationsOutputWithContext(ctx context.Context) CSIScaleOperatorSpecTolerationsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CSIScaleOperatorSpecTolerationsOutput)
}

// CSIScaleOperatorSpecTolerationsArrayInput is an input type that accepts CSIScaleOperatorSpecTolerationsArray and CSIScaleOperatorSpecTolerationsArrayOutput values.
// You can construct a concrete instance of `CSIScaleOperatorSpecTolerationsArrayInput` via:
//
//          CSIScaleOperatorSpecTolerationsArray{ CSIScaleOperatorSpecTolerationsArgs{...} }
type CSIScaleOperatorSpecTolerationsArrayInput interface {
	pulumi.Input

	ToCSIScaleOperatorSpecTolerationsArrayOutput() CSIScaleOperatorSpecTolerationsArrayOutput
	ToCSIScaleOperatorSpecTolerationsArrayOutputWithContext(context.Context) CSIScaleOperatorSpecTolerationsArrayOutput
}

type CSIScaleOperatorSpecTolerationsArray []CSIScaleOperatorSpecTolerationsInput

func (CSIScaleOperatorSpecTolerationsArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]CSIScaleOperatorSpecTolerations)(nil)).Elem()
}

func (i CSIScaleOperatorSpecTolerationsArray) ToCSIScaleOperatorSpecTolerationsArrayOutput() CSIScaleOperatorSpecTolerationsArrayOutput {
	return i.ToCSIScaleOperatorSpecTolerationsArrayOutputWithContext(context.Background())
}

func (i CSIScaleOperatorSpecTolerationsArray) ToCSIScaleOperatorSpecTolerationsArrayOutputWithContext(ctx context.Context) CSIScaleOperatorSpecTolerationsArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CSIScaleOperatorSpecTolerationsArrayOutput)
}

type CSIScaleOperatorSpecTolerationsOutput struct{ *pulumi.OutputState }

func (CSIScaleOperatorSpecTolerationsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*CSIScaleOperatorSpecTolerations)(nil)).Elem()
}

func (o CSIScaleOperatorSpecTolerationsOutput) ToCSIScaleOperatorSpecTolerationsOutput() CSIScaleOperatorSpecTolerationsOutput {
	return o
}

func (o CSIScaleOperatorSpecTolerationsOutput) ToCSIScaleOperatorSpecTolerationsOutputWithContext(ctx context.Context) CSIScaleOperatorSpecTolerationsOutput {
	return o
}

// Valid values are "NoSchedule", "PreferNoSchedule" and "NoExecute". An empty effect matches all effects with given key.
func (o CSIScaleOperatorSpecTolerationsOutput) Effect() pulumi.StringOutput {
	return o.ApplyT(func(v CSIScaleOperatorSpecTolerations) string { return v.Effect }).(pulumi.StringOutput)
}

// Node taint key name
func (o CSIScaleOperatorSpecTolerationsOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v CSIScaleOperatorSpecTolerations) string { return v.Key }).(pulumi.StringOutput)
}

// Valid values are "Exists" and "Equal".
func (o CSIScaleOperatorSpecTolerationsOutput) Operator() pulumi.StringOutput {
	return o.ApplyT(func(v CSIScaleOperatorSpecTolerations) string { return v.Operator }).(pulumi.StringOutput)
}

// Used only when effect is "NoExecute". It determines how long the pod will stay bound to the node after the taint is added.
func (o CSIScaleOperatorSpecTolerationsOutput) TolerationSeconds() pulumi.IntPtrOutput {
	return o.ApplyT(func(v CSIScaleOperatorSpecTolerations) *int { return v.TolerationSeconds }).(pulumi.IntPtrOutput)
}

// Required if operator is "Equal"
func (o CSIScaleOperatorSpecTolerationsOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CSIScaleOperatorSpecTolerations) *string { return v.Value }).(pulumi.StringPtrOutput)
}

type CSIScaleOperatorSpecTolerationsArrayOutput struct{ *pulumi.OutputState }

func (CSIScaleOperatorSpecTolerationsArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]CSIScaleOperatorSpecTolerations)(nil)).Elem()
}

func (o CSIScaleOperatorSpecTolerationsArrayOutput) ToCSIScaleOperatorSpecTolerationsArrayOutput() CSIScaleOperatorSpecTolerationsArrayOutput {
	return o
}

func (o CSIScaleOperatorSpecTolerationsArrayOutput) ToCSIScaleOperatorSpecTolerationsArrayOutputWithContext(ctx context.Context) CSIScaleOperatorSpecTolerationsArrayOutput {
	return o
}

func (o CSIScaleOperatorSpecTolerationsArrayOutput) Index(i pulumi.IntInput) CSIScaleOperatorSpecTolerationsOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) CSIScaleOperatorSpecTolerations {
		return vs[0].([]CSIScaleOperatorSpecTolerations)[vs[1].(int)]
	}).(CSIScaleOperatorSpecTolerationsOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(CSIScaleOperatorSpecTolerationsOutput{})
	pulumi.RegisterOutputType(CSIScaleOperatorSpecTolerationsArrayOutput{})
