...
func NewHyperfoil(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:hyperfoil.io/v1alpha1:Hyperfoil", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHyperfoil(ctx *pulumi.Context,
	...
	var resource Hyperfoil
	err := ctx.ReadResource("kubernetes:hyperfoil.io/v1alpha1:Hyperfoil", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
