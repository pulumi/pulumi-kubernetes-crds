...
namespace Pulumi.Kubernetes.Types.Inputs.Admin.V1Beta1
{
    ...
    public class StandardInfraConfigSpecAdminPodTemplateSpecContainersArgs : Pulumi.ResourceArgs
    {
        [Input("resources")]
        ...
        public StandardInfraConfigSpecAdminPodTemplateSpecContainersArgs()
        {
        }
    }
}
