...
namespace Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2
{
    ...
    [OutputType]
    public sealed class SearchHeadClusterSpec
    {
        /// <summary>
        /// Kubernetes Affinity rules that control how pods are assigned to particular nodes.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecAffinity Affinity;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecIndexerClusterRef IndexerClusterRef;
        /// <summary>
        /// LicenseMasterRef refers to a Splunk Enterprise license master managed by the operator within Kubernetes
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecLicenseMasterRef LicenseMasterRef;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecResources Resources;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecServiceTemplate ServiceTemplate;
        /// <summary>
        /// Image to use for Spark pod containers (overrides RELATED_IMAGE_SPLUNK_SPARK environment variables)
        /// </summary>
        public readonly string SparkImage;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecSparkRef SparkRef;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecVolumes> Volumes;

        [OutputConstructor]
        private SearchHeadClusterSpec(
            Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecAffinity affinity,
            ...
            Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecIndexerClusterRef indexerClusterRef,

            Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecLicenseMasterRef licenseMasterRef,

            string licenseUrl,

            int replicas,

            Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecResources resources,

            string schedulerName,

            Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecServiceTemplate serviceTemplate,

            string sparkImage,

            Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecSparkRef sparkRef,

            string storageClassName,

            string varStorage,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Enterprise.V1Alpha2.SearchHeadClusterSpecVolumes> volumes)
        {
            Affinity = affinity;
            Defaults = defaults;
