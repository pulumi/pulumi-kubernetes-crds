...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class LicenseMasterSpecVolumesCephfsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.LicenseMasterSpecVolumesCephfsSecretRefArgs>? SecretRef { get; set; }
        ...
        public LicenseMasterSpecVolumesCephfsArgs()
        {
        }
    }
}
