...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class StandaloneSpecVolumesCsiArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.StandaloneSpecVolumesCsiNodePublishSecretRefArgs>? NodePublishSecretRef { get; set; }
        ...
        public StandaloneSpecVolumesCsiArgs()
        {
        }
    }
}
