...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class StandaloneSpecVolumesCephfsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.StandaloneSpecVolumesCephfsSecretRefArgs>? SecretRef { get; set; }
        ...
        public StandaloneSpecVolumesCephfsArgs()
        {
        }
    }
}
