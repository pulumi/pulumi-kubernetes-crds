...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class StandaloneSpecVolumesIscsiArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.StandaloneSpecVolumesIscsiSecretRefArgs>? SecretRef { get; set; }
        ...
        public StandaloneSpecVolumesIscsiArgs()
        {
        }
    }
}
