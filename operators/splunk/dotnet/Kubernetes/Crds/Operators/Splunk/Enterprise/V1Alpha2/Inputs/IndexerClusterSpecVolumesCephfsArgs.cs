...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class IndexerClusterSpecVolumesCephfsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecVolumesCephfsSecretRefArgs>? SecretRef { get; set; }
        ...
        public IndexerClusterSpecVolumesCephfsArgs()
        {
        }
    }
}
