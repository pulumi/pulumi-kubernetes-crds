...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class IndexerClusterSpecArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Kubernetes Affinity rules that control how pods are assigned to particular nodes.
        /// </summary>
        [Input("affinity")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecAffinityArgs>? Affinity { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecIndexerClusterRefArgs>? IndexerClusterRef { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecLicenseMasterRefArgs>? LicenseMasterRef { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecResourcesArgs>? Resources { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecServiceTemplateArgs>? ServiceTemplate { get; set; }
        ...
        [Input("volumes")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecVolumesArgs>? _volumes;

        /// <summary>
        /// List of one or more Kubernetes volumes. These will be mounted in all pod containers as as /mnt/&lt;name&gt;
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecVolumesArgs> Volumes
        {
            get => _volumes ?? (_volumes = new InputList<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecVolumesArgs>());
            set => _volumes = value;
        }

        public IndexerClusterSpecArgs()
        {
        }
    }
}
