...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class SearchHeadClusterSpecArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Kubernetes Affinity rules that control how pods are assigned to particular nodes.
        /// </summary>
        [Input("affinity")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.SearchHeadClusterSpecAffinityArgs>? Affinity { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.SearchHeadClusterSpecIndexerClusterRefArgs>? IndexerClusterRef { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.SearchHeadClusterSpecLicenseMasterRefArgs>? LicenseMasterRef { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.SearchHeadClusterSpecResourcesArgs>? Resources { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.SearchHeadClusterSpecServiceTemplateArgs>? ServiceTemplate { get; set; }
        ...
        /// </summary>
        [Input("sparkRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.SearchHeadClusterSpecSparkRefArgs>? SparkRef { get; set; }
        ...
        [Input("volumes")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.SearchHeadClusterSpecVolumesArgs>? _volumes;

        /// <summary>
        /// List of one or more Kubernetes volumes. These will be mounted in all pod containers as as /mnt/&lt;name&gt;
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.SearchHeadClusterSpecVolumesArgs> Volumes
        {
            get => _volumes ?? (_volumes = new InputList<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.SearchHeadClusterSpecVolumesArgs>());
            set => _volumes = value;
        }

        public SearchHeadClusterSpecArgs()
        {
        }
    }
}
