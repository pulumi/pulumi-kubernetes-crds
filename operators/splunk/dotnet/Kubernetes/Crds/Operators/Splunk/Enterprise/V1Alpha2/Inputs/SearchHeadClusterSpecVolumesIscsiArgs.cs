...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class SearchHeadClusterSpecVolumesIscsiArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.SearchHeadClusterSpecVolumesIscsiSecretRefArgs>? SecretRef { get; set; }
        ...
        public SearchHeadClusterSpecVolumesIscsiArgs()
        {
        }
    }
}
