...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class StandaloneSpecVolumesRbdArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.StandaloneSpecVolumesRbdSecretRefArgs>? SecretRef { get; set; }
        ...
        public StandaloneSpecVolumesRbdArgs()
        {
        }
    }
}
