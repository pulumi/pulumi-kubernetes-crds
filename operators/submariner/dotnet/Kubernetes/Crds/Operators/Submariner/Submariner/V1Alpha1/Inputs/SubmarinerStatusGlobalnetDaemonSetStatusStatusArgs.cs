...
namespace Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1
{
    ...
    /// </summary>
    public class SubmarinerStatusGlobalnetDaemonSetStatusStatusArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1.SubmarinerStatusGlobalnetDaemonSetStatusStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Represents the latest available observations of a DaemonSet's current state.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1.SubmarinerStatusGlobalnetDaemonSetStatusStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1.SubmarinerStatusGlobalnetDaemonSetStatusStatusConditionsArgs>());
        ...
        public SubmarinerStatusGlobalnetDaemonSetStatusStatusArgs()
        {
        }
    }
}
