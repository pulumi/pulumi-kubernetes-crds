...
namespace Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1
{
    ...
    public class SubmarinerStatusGlobalnetDaemonSetStatusArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1.SubmarinerStatusGlobalnetDaemonSetStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Represents the latest available observations of a DaemonSet's current state.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1.SubmarinerStatusGlobalnetDaemonSetStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1.SubmarinerStatusGlobalnetDaemonSetStatusConditionsArgs>());
