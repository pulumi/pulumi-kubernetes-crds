...
namespace Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1
{
    ...
    /// </summary>
    public class SubmarinerStatusEngineDaemonSetStatusStatusArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1.SubmarinerStatusEngineDaemonSetStatusStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Represents the latest available observations of a DaemonSet's current state.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1.SubmarinerStatusEngineDaemonSetStatusStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Submariner.V1Alpha1.SubmarinerStatusEngineDaemonSetStatusStatusConditionsArgs>());
        ...
        public SubmarinerStatusEngineDaemonSetStatusStatusArgs()
        {
        }
    }
}
