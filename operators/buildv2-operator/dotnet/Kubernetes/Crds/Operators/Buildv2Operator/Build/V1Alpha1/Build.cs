...
namespace Pulumi.Pulumi.Kubernetes.Crds.Operators.Buildv2Operator.Build.V1Alpha1
{
    ...
    public partial class Build : KubernetesResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Kubernetes.Types.Outputs.Build.V1Alpha1.BuildSpec> Spec { get; private set; } = null!;
        ...
        public Build(string name, Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1.BuildArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:build.dev/v1alpha1:Build", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal Build(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:build.dev/v1alpha1:Build", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Build(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:build.dev/v1alpha1:Build", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1.BuildArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1.BuildArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1.BuildArgs();
