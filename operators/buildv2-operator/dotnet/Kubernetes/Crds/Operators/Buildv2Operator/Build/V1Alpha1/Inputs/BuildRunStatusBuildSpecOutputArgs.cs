...
namespace Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1
{
    ...
    /// </summary>
    public class BuildRunStatusBuildSpecOutputArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// SecretRef is a reference to the Secret containing the credentials to push the image to the registry
        /// </summary>
        [Input("credentials")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1.BuildRunStatusBuildSpecOutputCredentialsArgs>? Credentials { get; set; }
        ...
        public BuildRunStatusBuildSpecOutputArgs()
        {
        }
    }
}
