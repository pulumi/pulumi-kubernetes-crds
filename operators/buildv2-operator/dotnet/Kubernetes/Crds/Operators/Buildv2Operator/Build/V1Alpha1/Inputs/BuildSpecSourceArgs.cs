...
namespace Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1
{
    ...
    /// </summary>
    public class BuildSpecSourceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("credentials")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1.BuildSpecSourceCredentialsArgs>? Credentials { get; set; }
