...
namespace Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1
{
    ...
    /// </summary>
    public class BuildSpecRuntimeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Base runtime base image.
        /// </summary>
        [Input("base")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1.BuildSpecRuntimeBaseArgs>? Base { get; set; }
        ...
        /// </summary>
        [Input("user")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Build.V1Alpha1.BuildSpecRuntimeUserArgs>? User { get; set; }
