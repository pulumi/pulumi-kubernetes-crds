...
class Subscription(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['SubscriptionSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['SubscriptionStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'Subscription'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(Subscription, __self__).__init__(
            'kubernetes:apps.open-cluster-management.io/v1:Subscription',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.SubscriptionSpec']]:
        """
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.SubscriptionStatus']]:
        """
