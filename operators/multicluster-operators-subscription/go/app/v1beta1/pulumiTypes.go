...
// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
type ApplicationSpecSelectorMatchLabels struct {
}

// ApplicationSpecSelectorMatchLabelsInput is an input type that accepts ApplicationSpecSelectorMatchLabelsArgs and ApplicationSpecSelectorMatchLabelsOutput values.
// You can construct a concrete instance of `ApplicationSpecSelectorMatchLabelsInput` via:
//
//          ApplicationSpecSelectorMatchLabelsArgs{...}
type ApplicationSpecSelectorMatchLabelsInput interface {
	pulumi.Input

	ToApplicationSpecSelectorMatchLabelsOutput() ApplicationSpecSelectorMatchLabelsOutput
	ToApplicationSpecSelectorMatchLabelsOutputWithContext(context.Context) ApplicationSpecSelectorMatchLabelsOutput
}

// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
type ApplicationSpecSelectorMatchLabelsArgs struct {
}

func (ApplicationSpecSelectorMatchLabelsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ApplicationSpecSelectorMatchLabels)(nil)).Elem()
}

func (i ApplicationSpecSelectorMatchLabelsArgs) ToApplicationSpecSelectorMatchLabelsOutput() ApplicationSpecSelectorMatchLabelsOutput {
	return i.ToApplicationSpecSelectorMatchLabelsOutputWithContext(context.Background())
}

func (i ApplicationSpecSelectorMatchLabelsArgs) ToApplicationSpecSelectorMatchLabelsOutputWithContext(ctx context.Context) ApplicationSpecSelectorMatchLabelsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ApplicationSpecSelectorMatchLabelsOutput)
}

// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
type ApplicationSpecSelectorMatchLabelsOutput struct{ *pulumi.OutputState }

func (ApplicationSpecSelectorMatchLabelsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ApplicationSpecSelectorMatchLabels)(nil)).Elem()
}

func (o ApplicationSpecSelectorMatchLabelsOutput) ToApplicationSpecSelectorMatchLabelsOutput() ApplicationSpecSelectorMatchLabelsOutput {
	return o
}

func (o ApplicationSpecSelectorMatchLabelsOutput) ToApplicationSpecSelectorMatchLabelsOutputWithContext(ctx context.Context) ApplicationSpecSelectorMatchLabelsOutput {
	return o
}
...
func init() {
	...
	pulumi.RegisterOutputType(ApplicationSpecSelectorMatchLabelsOutput{})
