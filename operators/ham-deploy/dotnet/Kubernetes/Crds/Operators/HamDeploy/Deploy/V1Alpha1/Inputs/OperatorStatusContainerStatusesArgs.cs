...
namespace Pulumi.Kubernetes.Types.Inputs.Deploy.V1Alpha1
{
    ...
    /// </summary>
    public class OperatorStatusContainerStatusesArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("lastState")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Deploy.V1Alpha1.OperatorStatusContainerStatusesLastStateArgs>? LastState { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Deploy.V1Alpha1.OperatorStatusContainerStatusesStateArgs>? State { get; set; }

        public OperatorStatusContainerStatusesArgs()
        {
        }
    }
}
