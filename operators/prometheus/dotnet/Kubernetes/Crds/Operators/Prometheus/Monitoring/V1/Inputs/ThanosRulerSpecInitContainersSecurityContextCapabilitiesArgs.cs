...
namespace Pulumi.Kubernetes.Types.Inputs.Monitoring.V1
{
    ...
    /// </summary>
    public class ThanosRulerSpecInitContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public ThanosRulerSpecInitContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
