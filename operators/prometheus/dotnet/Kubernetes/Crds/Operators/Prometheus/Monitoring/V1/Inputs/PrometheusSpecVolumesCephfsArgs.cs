...
namespace Pulumi.Kubernetes.Types.Inputs.Monitoring.V1
{
    ...
    /// </summary>
    public class PrometheusSpecVolumesCephfsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Monitoring.V1.PrometheusSpecVolumesCephfsSecretRefArgs>? SecretRef { get; set; }
        ...
        public PrometheusSpecVolumesCephfsArgs()
        {
        }
    }
}
