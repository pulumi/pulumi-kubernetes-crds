...
namespace Pulumi.Kubernetes.Types.Inputs.Monitoring.V1
{
    ...
    /// </summary>
    public class PrometheusSpecInitContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public PrometheusSpecInitContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
