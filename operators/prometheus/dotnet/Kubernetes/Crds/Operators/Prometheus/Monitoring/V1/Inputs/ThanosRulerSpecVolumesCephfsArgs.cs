...
namespace Pulumi.Kubernetes.Types.Inputs.Monitoring.V1
{
    ...
    /// </summary>
    public class ThanosRulerSpecVolumesCephfsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Monitoring.V1.ThanosRulerSpecVolumesCephfsSecretRefArgs>? SecretRef { get; set; }
        ...
        public ThanosRulerSpecVolumesCephfsArgs()
        {
        }
    }
}
