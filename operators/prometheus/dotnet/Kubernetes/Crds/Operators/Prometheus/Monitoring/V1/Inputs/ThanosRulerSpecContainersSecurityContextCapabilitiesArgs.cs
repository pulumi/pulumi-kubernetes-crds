...
namespace Pulumi.Kubernetes.Types.Inputs.Monitoring.V1
{
    ...
    /// </summary>
    public class ThanosRulerSpecContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public ThanosRulerSpecContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
