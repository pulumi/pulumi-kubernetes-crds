...
namespace Pulumi.Kubernetes.Types.Inputs.Monitoring.V1
{
    ...
    /// </summary>
    public class AlertmanagerSpecVolumesRbdArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Monitoring.V1.AlertmanagerSpecVolumesRbdSecretRefArgs>? SecretRef { get; set; }
        ...
        public AlertmanagerSpecVolumesRbdArgs()
        {
        }
    }
}
