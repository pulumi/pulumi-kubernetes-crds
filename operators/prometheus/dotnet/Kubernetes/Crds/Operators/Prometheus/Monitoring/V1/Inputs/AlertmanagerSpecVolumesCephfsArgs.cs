...
namespace Pulumi.Kubernetes.Types.Inputs.Monitoring.V1
{
    ...
    /// </summary>
    public class AlertmanagerSpecVolumesCephfsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Monitoring.V1.AlertmanagerSpecVolumesCephfsSecretRefArgs>? SecretRef { get; set; }
        ...
        public AlertmanagerSpecVolumesCephfsArgs()
        {
        }
    }
}
