...
namespace Pulumi.Kubernetes.Types.Inputs.Monitoring.V1
{
    ...
    /// </summary>
    public class AlertmanagerSpecContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public AlertmanagerSpecContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
