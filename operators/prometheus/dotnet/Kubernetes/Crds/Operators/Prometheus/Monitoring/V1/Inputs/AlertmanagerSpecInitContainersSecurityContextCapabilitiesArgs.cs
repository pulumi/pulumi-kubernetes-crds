...
namespace Pulumi.Kubernetes.Types.Inputs.Monitoring.V1
{
    ...
    /// </summary>
    public class AlertmanagerSpecInitContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public AlertmanagerSpecInitContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
