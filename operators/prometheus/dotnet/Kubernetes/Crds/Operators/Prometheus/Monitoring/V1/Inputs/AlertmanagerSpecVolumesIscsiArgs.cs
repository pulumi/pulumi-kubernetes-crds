...
namespace Pulumi.Kubernetes.Types.Inputs.Monitoring.V1
{
    ...
    /// </summary>
    public class AlertmanagerSpecVolumesIscsiArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Monitoring.V1.AlertmanagerSpecVolumesIscsiSecretRefArgs>? SecretRef { get; set; }
        ...
        public AlertmanagerSpecVolumesIscsiArgs()
        {
        }
    }
}
