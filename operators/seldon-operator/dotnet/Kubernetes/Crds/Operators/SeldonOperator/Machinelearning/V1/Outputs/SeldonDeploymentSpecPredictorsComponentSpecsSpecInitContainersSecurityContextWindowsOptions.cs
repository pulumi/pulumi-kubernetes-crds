...
namespace Pulumi.Kubernetes.Types.Outputs.Machinelearning.V1
{
    ...
    [OutputType]
    public sealed class SeldonDeploymentSpecPredictorsComponentSpecsSpecInitContainersSecurityContextWindowsOptions
    {
        /// <summary>
        ...
        [OutputConstructor]
        private SeldonDeploymentSpecPredictorsComponentSpecsSpecInitContainersSecurityContextWindowsOptions(
