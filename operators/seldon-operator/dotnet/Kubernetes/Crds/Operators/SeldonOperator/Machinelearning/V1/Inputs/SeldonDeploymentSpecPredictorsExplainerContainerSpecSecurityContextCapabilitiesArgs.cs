...
namespace Pulumi.Kubernetes.Types.Inputs.Machinelearning.V1
{
    ...
    /// </summary>
    public class SeldonDeploymentSpecPredictorsExplainerContainerSpecSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public SeldonDeploymentSpecPredictorsExplainerContainerSpecSecurityContextCapabilitiesArgs()
        {
        }
    }
}
