...
namespace Pulumi.Kubernetes.Types.Outputs.Machinelearning.V1
{
    ...
    [OutputType]
    public sealed class SeldonDeploymentSpecPredictorsComponentSpecsSpecInitContainersVolumeMounts
    {
        /// <summary>
        ...
        [OutputConstructor]
        private SeldonDeploymentSpecPredictorsComponentSpecsSpecInitContainersVolumeMounts(
            string mountPath,
