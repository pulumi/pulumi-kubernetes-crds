...
namespace Pulumi.Kubernetes.Types.Inputs.Machinelearning.V1
{
    ...
    /// </summary>
    public class SeldonDeploymentSpecPredictorsExplainerContainerSpecSecurityContextArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capabilities")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Machinelearning.V1.SeldonDeploymentSpecPredictorsExplainerContainerSpecSecurityContextCapabilitiesArgs>? Capabilities { get; set; }
