...
namespace Pulumi.Kubernetes.Types.Outputs.Machinelearning.V1
{
    ...
    [OutputType]
    public sealed class SeldonDeploymentSpecPredictorsExplainerContainerSpecVolumeMounts
    {
        /// <summary>
        ...
        [OutputConstructor]
        private SeldonDeploymentSpecPredictorsExplainerContainerSpecVolumeMounts(
            string mountPath,
