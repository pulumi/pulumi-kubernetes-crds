...
namespace Pulumi.Kubernetes.Types.Inputs.Machinelearning.V1
{
    ...
    /// </summary>
    public class SeldonDeploymentSpecPredictorsComponentSpecsSpecInitContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public SeldonDeploymentSpecPredictorsComponentSpecsSpecInitContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
