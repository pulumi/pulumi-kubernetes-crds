...
namespace Pulumi.Kubernetes.Types.Inputs.Machinelearning.V1
{
    ...
    public class SeldonDeploymentSpecPredictorsComponentSpecsSpecContainersArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("startupProbe")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Machinelearning.V1.SeldonDeploymentSpecPredictorsComponentSpecsSpecContainersStartupProbeArgs>? StartupProbe { get; set; }
