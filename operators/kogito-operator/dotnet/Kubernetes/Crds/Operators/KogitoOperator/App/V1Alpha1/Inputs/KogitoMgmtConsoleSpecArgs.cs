...
namespace Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1
{
    ...
    /// </summary>
    public class KogitoMgmtConsoleSpecArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("envs")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoMgmtConsoleSpecEnvsArgs>? _envs;

        /// <summary>
        /// Environment variables to be added to the runtime container. Keys must be a C_IDENTIFIER.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoMgmtConsoleSpecEnvsArgs> Envs
        {
            get => _envs ?? (_envs = new InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoMgmtConsoleSpecEnvsArgs>());
            set => _envs = value;
        }
        ...
        /// </summary>
        [Input("image")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoMgmtConsoleSpecImageArgs>? Image { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoMgmtConsoleSpecResourcesArgs>? Resources { get; set; }
        ...
        public KogitoMgmtConsoleSpecArgs()
        {
        }
    }
}
