...
namespace Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1
{
    ...
    /// </summary>
    public class KogitoDataIndexSpecInfinispanArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("credentials")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoDataIndexSpecInfinispanCredentialsArgs>? Credentials { get; set; }
        ...
        public KogitoDataIndexSpecInfinispanArgs()
        {
        }
    }
}
