...
namespace Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1
{
    ...
    /// </summary>
    public class KogitoJobsServiceSpecInfinispanArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("credentials")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoJobsServiceSpecInfinispanCredentialsArgs>? Credentials { get; set; }
        ...
        public KogitoJobsServiceSpecInfinispanArgs()
        {
        }
    }
}
