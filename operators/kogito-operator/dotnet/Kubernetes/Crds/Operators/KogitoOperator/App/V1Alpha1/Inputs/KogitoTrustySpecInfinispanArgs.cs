...
namespace Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1
{
    ...
    /// </summary>
    public class KogitoTrustySpecInfinispanArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("credentials")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoTrustySpecInfinispanCredentialsArgs>? Credentials { get; set; }
        ...
        public KogitoTrustySpecInfinispanArgs()
        {
        }
    }
}
