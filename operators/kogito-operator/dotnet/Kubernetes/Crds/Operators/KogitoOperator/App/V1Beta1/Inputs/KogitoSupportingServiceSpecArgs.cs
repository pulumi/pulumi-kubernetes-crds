...
namespace Pulumi.Kubernetes.Types.Inputs.App.V1Beta1
{
    ...
    /// </summary>
    public class KogitoSupportingServiceSpecArgs : Pulumi.ResourceArgs
    {
        [Input("config")]
        ...
        [Input("env")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Beta1.KogitoSupportingServiceSpecEnvArgs>? _env;

        /// <summary>
        /// Environment variables to be added to the runtime container. Keys must be a C_IDENTIFIER.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Beta1.KogitoSupportingServiceSpecEnvArgs> Env
        {
            get => _env ?? (_env = new InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Beta1.KogitoSupportingServiceSpecEnvArgs>());
            set => _env = value;
        }
        ...
        /// </summary>
        [Input("monitoring")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Beta1.KogitoSupportingServiceSpecMonitoringArgs>? Monitoring { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Beta1.KogitoSupportingServiceSpecResourcesArgs>? Resources { get; set; }
        ...
        public KogitoSupportingServiceSpecArgs()
        {
        }
    }
}
