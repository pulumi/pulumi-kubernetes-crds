...
func NewKogitoRuntime(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:app.kiegroup.org/v1alpha1:KogitoRuntime", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKogitoRuntime(ctx *pulumi.Context,
	...
	var resource KogitoRuntime
	err := ctx.ReadResource("kubernetes:app.kiegroup.org/v1alpha1:KogitoRuntime", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
