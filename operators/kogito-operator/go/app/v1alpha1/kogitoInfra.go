...
func NewKogitoInfra(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:app.kiegroup.org/v1alpha1:KogitoInfra", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKogitoInfra(ctx *pulumi.Context,
	...
	var resource KogitoInfra
	err := ctx.ReadResource("kubernetes:app.kiegroup.org/v1alpha1:KogitoInfra", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
