...
export class ServerStatusRequest extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: ServerStatusRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            inputs["kind"] = "ServerStatusRequest";
        ...
        super(ServerStatusRequest.__pulumiType, name, inputs, opts);
    }
}
...
export interface ServerStatusRequestArgs {
    ...
    readonly kind?: pulumi.Input<"ServerStatusRequest">;
     ...
     * ServerStatusRequestStatus is the current status of a ServerStatusRequest.
     */
    readonly status?: pulumi.Input<inputs.velero.v1.ServerStatusRequestStatus>;
}
