...
namespace Pulumi.Kubernetes.Types.Inputs.Velero.V1
{
    ...
    /// </summary>
    public class BackupSpecHooksResourcesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("labelSelector")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Velero.V1.BackupSpecHooksResourcesLabelSelectorArgs>? LabelSelector { get; set; }
        ...
        [Input("post")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Velero.V1.BackupSpecHooksResourcesPostArgs>? _post;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Velero.V1.BackupSpecHooksResourcesPostArgs> Post
        {
            get => _post ?? (_post = new InputList<Pulumi.Kubernetes.Types.Inputs.Velero.V1.BackupSpecHooksResourcesPostArgs>());
            set => _post = value;
        }

        [Input("pre")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Velero.V1.BackupSpecHooksResourcesPreArgs>? _pre;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Velero.V1.BackupSpecHooksResourcesPreArgs> Pre
        {
            get => _pre ?? (_pre = new InputList<Pulumi.Kubernetes.Types.Inputs.Velero.V1.BackupSpecHooksResourcesPreArgs>());
            set => _pre = value;
        }

        public BackupSpecHooksResourcesArgs()
        {
        }
    }
}
