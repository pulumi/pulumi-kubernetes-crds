...
func NewBackup(ctx *pulumi.Context,
	...
	var resource Backup
	err := ctx.RegisterResource("kubernetes:velero.io/v1:Backup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackup(ctx *pulumi.Context,
	...
	var resource Backup
	err := ctx.ReadResource("kubernetes:velero.io/v1:Backup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
