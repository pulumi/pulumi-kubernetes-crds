...
class ClusterPool(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['ClusterPoolSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['ClusterPoolStatusArgs']]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['ClusterPoolSpecArgs']] spec: ClusterPoolSpec defines the desired state of the ClusterPool.
        :param pulumi.Input[pulumi.InputType['ClusterPoolStatusArgs']] status: ClusterPoolStatus defines the observed state of ClusterPool
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'ClusterPool'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(ClusterPool, __self__).__init__(
            'kubernetes:hive.openshift.io/v1:ClusterPool',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.ClusterPoolSpec']:
        """
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.ClusterPoolStatus']]:
        """
