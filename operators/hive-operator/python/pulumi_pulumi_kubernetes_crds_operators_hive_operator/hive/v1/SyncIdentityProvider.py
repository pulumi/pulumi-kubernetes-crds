...
class SyncIdentityProvider(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['SyncIdentityProviderSpecArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SyncIdentityProviderSpecArgs']] spec: SyncIdentityProviderSpec defines the SyncIdentityProviderCommonSpec identity providers to sync along with ClusterDeploymentRefs indicating which clusters the SyncIdentityProvider applies to in the SyncIdentityProvider's namespace.
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'SyncIdentityProvider'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(SyncIdentityProvider, __self__).__init__(
            'kubernetes:hive.openshift.io/v1:SyncIdentityProvider',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.SyncIdentityProviderSpec']]:
        """
