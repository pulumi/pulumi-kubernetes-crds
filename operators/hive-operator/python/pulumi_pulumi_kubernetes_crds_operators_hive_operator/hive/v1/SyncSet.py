...
class SyncSet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['SyncSetSpecArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SyncSetSpecArgs']] spec: SyncSetSpec defines the SyncSetCommonSpec resources and patches to sync along with ClusterDeploymentRefs indicating which clusters the SyncSet applies to in the SyncSet's namespace.
        :param pulumi.Input[Mapping[str, Any]] status: SyncSetStatus defines the observed state of a SyncSet
        """
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'SyncSet'
            __props__['metadata'] = metadata
            __props__['spec'] = spec
            __props__['status'] = status
        super(SyncSet, __self__).__init__(
            'kubernetes:hive.openshift.io/v1:SyncSet',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.SyncSetSpec']]:
        """
