...
export class ClusterSync extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterSync {
        return new ClusterSync(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:hiveinternal.openshift.io/v1alpha1:ClusterSync';
    ...
    public readonly kind!: pulumi.Output<"ClusterSync" | undefined>;
     ...
     */
    public readonly status!: pulumi.Output<outputs.hiveinternal.v1alpha1.ClusterSyncStatus | undefined>;
...
export interface ClusterSyncArgs {
    ...
    readonly kind?: pulumi.Input<"ClusterSync">;
     ...
     * ClusterSyncStatus defines the observed state of ClusterSync
     */
    readonly status?: pulumi.Input<inputs.hiveinternal.v1alpha1.ClusterSyncStatus>;
}
