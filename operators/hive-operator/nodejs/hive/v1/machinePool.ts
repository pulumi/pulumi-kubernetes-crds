...
export class MachinePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:hive.openshift.io/v1:MachinePool';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.hive.v1.MachinePoolSpec | undefined>;
    /**
     * MachinePoolStatus defines the observed state of MachinePool
     */
    public readonly status!: pulumi.Output<outputs.hive.v1.MachinePoolStatus | undefined>;
    ...
    constructor(name: string, args?: MachinePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MachinePool.__pulumiType, name, inputs, opts);
    }
}
...
export interface MachinePoolArgs {
    ...
    readonly kind?: pulumi.Input<"MachinePool">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * MachinePoolSpec defines the desired state of MachinePool
     */
    readonly spec?: pulumi.Input<inputs.hive.v1.MachinePoolSpec>;
    /**
     * MachinePoolStatus defines the observed state of MachinePool
     */
    readonly status?: pulumi.Input<inputs.hive.v1.MachinePoolStatus>;
}
