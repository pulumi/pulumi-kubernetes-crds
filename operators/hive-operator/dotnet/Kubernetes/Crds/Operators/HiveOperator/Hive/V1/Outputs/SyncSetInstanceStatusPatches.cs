...
namespace Pulumi.Kubernetes.Types.Outputs.Hive.V1
{
    ...
    [OutputType]
    public sealed class SyncSetInstanceStatusPatches
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Hive.V1.SyncSetInstanceStatusPatchesConditions> Conditions;
        /// <summary>
        ...
        [OutputConstructor]
        private SyncSetInstanceStatusPatches(
            string apiVersion,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Hive.V1.SyncSetInstanceStatusPatchesConditions> conditions,
