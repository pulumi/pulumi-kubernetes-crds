...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SelectorSyncIdentityProviderSpecIdentityProvidersKeystoneArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("ca")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersKeystoneCaArgs>? Ca { get; set; }
        ...
        /// </summary>
        [Input("tlsClientCert")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersKeystoneTlsClientCertArgs>? TlsClientCert { get; set; }
        ...
        /// </summary>
        [Input("tlsClientKey")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersKeystoneTlsClientKeyArgs>? TlsClientKey { get; set; }
        ...
        public SelectorSyncIdentityProviderSpecIdentityProvidersKeystoneArgs()
        {
        }
    }
}
