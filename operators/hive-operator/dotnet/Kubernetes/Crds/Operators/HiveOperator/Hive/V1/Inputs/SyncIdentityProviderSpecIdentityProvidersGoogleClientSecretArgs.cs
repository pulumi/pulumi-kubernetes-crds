...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SyncIdentityProviderSpecIdentityProvidersGoogleClientSecretArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public SyncIdentityProviderSpecIdentityProvidersGoogleClientSecretArgs()
        {
        }
    }
}
