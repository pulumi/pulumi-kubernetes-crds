...
namespace Pulumi.Kubernetes.Types.Outputs.Hive.V1
{
    ...
    [OutputType]
    public sealed class ClusterProvisionSpecPodSpecVolumesEphemeralVolumeClaimTemplateSpecResources
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterProvisionSpecPodSpecVolumesEphemeralVolumeClaimTemplateSpecResources(
