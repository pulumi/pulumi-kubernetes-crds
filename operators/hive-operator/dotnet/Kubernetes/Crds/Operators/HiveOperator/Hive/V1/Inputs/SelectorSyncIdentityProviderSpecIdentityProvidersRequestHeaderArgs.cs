...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SelectorSyncIdentityProviderSpecIdentityProvidersRequestHeaderArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("ca")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersRequestHeaderCaArgs>? Ca { get; set; }
        ...
        public SelectorSyncIdentityProviderSpecIdentityProvidersRequestHeaderArgs()
        {
        }
    }
}
