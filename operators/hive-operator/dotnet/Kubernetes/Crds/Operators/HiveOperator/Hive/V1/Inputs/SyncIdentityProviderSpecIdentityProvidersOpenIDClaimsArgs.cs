...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// claims mappings
    /// </summary>
    public class SyncIdentityProviderSpecIdentityProvidersOpenIDClaimsArgs : Pulumi.ResourceArgs
    {
        [Input("email")]
        ...
        public SyncIdentityProviderSpecIdentityProvidersOpenIDClaimsArgs()
        {
        }
    }
}
