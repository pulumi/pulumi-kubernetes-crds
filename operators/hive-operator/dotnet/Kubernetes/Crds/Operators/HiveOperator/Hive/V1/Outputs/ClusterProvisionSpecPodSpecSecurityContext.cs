...
namespace Pulumi.Kubernetes.Types.Outputs.Hive.V1
{
    ...
    [OutputType]
    public sealed class ClusterProvisionSpecPodSpecSecurityContext
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Hive.V1.ClusterProvisionSpecPodSpecSecurityContextSysctls> Sysctls;
        /// <summary>
        /// The Windows specific settings applied to all containers. If unspecified, the options within a container's SecurityContext will be used. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Hive.V1.ClusterProvisionSpecPodSpecSecurityContextWindowsOptions WindowsOptions;

        [OutputConstructor]
        private ClusterProvisionSpecPodSpecSecurityContext(
            int fsGroup,
            ...
            Pulumi.Kubernetes.Types.Outputs.Hive.V1.ClusterProvisionSpecPodSpecSecurityContextWindowsOptions windowsOptions)
        {
            FsGroup = fsGroup;
