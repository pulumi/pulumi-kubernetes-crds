...
namespace Pulumi.Kubernetes.Types.Outputs.Hive.V1
{
    ...
    [OutputType]
    public sealed class ClusterProvisionSpecPodSpecEphemeralContainersSecurityContextCapabilities
    {
        /// <summary>
        /// Added capabilities
        /// </summary>
        ...
        [OutputConstructor]
        private ClusterProvisionSpecPodSpecEphemeralContainersSecurityContextCapabilities(
