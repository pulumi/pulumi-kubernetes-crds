...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SelectorSyncIdentityProviderSpecIdentityProvidersLdapAttributesArgs : Pulumi.ResourceArgs
    {
        [Input("email")]
        ...
        public SelectorSyncIdentityProviderSpecIdentityProvidersLdapAttributesArgs()
        {
        }
    }
}
