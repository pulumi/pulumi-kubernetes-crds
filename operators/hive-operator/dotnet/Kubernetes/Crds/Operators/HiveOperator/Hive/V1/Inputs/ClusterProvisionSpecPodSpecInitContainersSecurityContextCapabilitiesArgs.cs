...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class ClusterProvisionSpecPodSpecInitContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public ClusterProvisionSpecPodSpecInitContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
