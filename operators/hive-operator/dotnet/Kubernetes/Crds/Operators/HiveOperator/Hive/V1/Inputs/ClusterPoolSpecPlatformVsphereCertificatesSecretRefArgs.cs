...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class ClusterPoolSpecPlatformVsphereCertificatesSecretRefArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public ClusterPoolSpecPlatformVsphereCertificatesSecretRefArgs()
        {
        }
    }
}
