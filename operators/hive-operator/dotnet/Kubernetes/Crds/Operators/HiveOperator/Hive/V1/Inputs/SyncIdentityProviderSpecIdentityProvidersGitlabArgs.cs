...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SyncIdentityProviderSpecIdentityProvidersGitlabArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("ca")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncIdentityProviderSpecIdentityProvidersGitlabCaArgs>? Ca { get; set; }
        ...
        /// </summary>
        [Input("clientSecret")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncIdentityProviderSpecIdentityProvidersGitlabClientSecretArgs>? ClientSecret { get; set; }
        ...
        public SyncIdentityProviderSpecIdentityProvidersGitlabArgs()
        {
        }
    }
}
