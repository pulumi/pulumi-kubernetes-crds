...
namespace Pulumi.Kubernetes.Types.Outputs.Hive.V1
{
    ...
    [OutputType]
    public sealed class ClusterProvisionSpecPodSpecInitContainersSecurityContextCapabilities
    {
        /// <summary>
        /// Added capabilities
        /// </summary>
        ...
        [OutputConstructor]
        private ClusterProvisionSpecPodSpecInitContainersSecurityContextCapabilities(
