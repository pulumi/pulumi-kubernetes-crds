...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SelectorSyncSetSpecSecretMappingsArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// SourceRef specifies the name and namespace of a secret on the management cluster
        /// </summary>
        [Input("sourceRef", required: true)]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncSetSpecSecretMappingsSourceRefArgs> SourceRef { get; set; } = null!;

        /// <summary>
        /// TargetRef specifies the target name and namespace of the secret on the target cluster
        /// </summary>
        [Input("targetRef", required: true)]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncSetSpecSecretMappingsTargetRefArgs> TargetRef { get; set; } = null!;

        public SelectorSyncSetSpecSecretMappingsArgs()
        {
        }
    }
}
