...
namespace Pulumi.Kubernetes.Types.Outputs.Hive.V1
{
    ...
    [OutputType]
    public sealed class SelectorSyncIdentityProviderSpecIdentityProvidersOpenIDClaims
    {
        /// <summary>
        ...
        [OutputConstructor]
        private SelectorSyncIdentityProviderSpecIdentityProvidersOpenIDClaims(
