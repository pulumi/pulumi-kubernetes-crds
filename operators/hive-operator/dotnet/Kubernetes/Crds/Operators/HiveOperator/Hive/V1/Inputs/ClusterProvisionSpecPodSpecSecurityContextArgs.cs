...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class ClusterProvisionSpecPodSpecSecurityContextArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("sysctls")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Hive.V1.ClusterProvisionSpecPodSpecSecurityContextSysctlsArgs>? _sysctls;

        /// <summary>
        /// Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported sysctls (by the container runtime) might fail to launch.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Hive.V1.ClusterProvisionSpecPodSpecSecurityContextSysctlsArgs> Sysctls
        {
            get => _sysctls ?? (_sysctls = new InputList<Pulumi.Kubernetes.Types.Inputs.Hive.V1.ClusterProvisionSpecPodSpecSecurityContextSysctlsArgs>());
            set => _sysctls = value;
        }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.ClusterProvisionSpecPodSpecSecurityContextWindowsOptionsArgs>? WindowsOptions { get; set; }

        public ClusterProvisionSpecPodSpecSecurityContextArgs()
        {
        }
    }
}
