...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class ClusterProvisionSpecPodSpecVolumesEphemeralArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.ClusterProvisionSpecPodSpecVolumesEphemeralVolumeClaimTemplateArgs>? VolumeClaimTemplate { get; set; }

        public ClusterProvisionSpecPodSpecVolumesEphemeralArgs()
        {
        }
    }
}
