...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SyncIdentityProviderSpecIdentityProvidersBasicAuthTlsClientKeyArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public SyncIdentityProviderSpecIdentityProvidersBasicAuthTlsClientKeyArgs()
        {
        }
    }
}
