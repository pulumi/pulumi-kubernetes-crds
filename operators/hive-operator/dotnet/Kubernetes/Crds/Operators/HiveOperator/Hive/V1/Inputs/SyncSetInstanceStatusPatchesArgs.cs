...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SyncSetInstanceStatusPatchesArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncSetInstanceStatusPatchesConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncSetInstanceStatusPatchesConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncSetInstanceStatusPatchesConditionsArgs>());
        ...
        public SyncSetInstanceStatusPatchesArgs()
        {
        }
    }
}
