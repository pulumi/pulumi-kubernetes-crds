...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SyncIdentityProviderSpecIdentityProvidersGitlabClientSecretArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public SyncIdentityProviderSpecIdentityProvidersGitlabClientSecretArgs()
        {
        }
    }
}
