...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class ClusterProvisionSpecPodSpecEphemeralContainersResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public ClusterProvisionSpecPodSpecEphemeralContainersResourcesArgs()
        {
        }
    }
}
