...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SyncIdentityProviderSpecIdentityProvidersKeystoneArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("ca")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncIdentityProviderSpecIdentityProvidersKeystoneCaArgs>? Ca { get; set; }
        ...
        /// </summary>
        [Input("tlsClientCert")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncIdentityProviderSpecIdentityProvidersKeystoneTlsClientCertArgs>? TlsClientCert { get; set; }
        ...
        /// </summary>
        [Input("tlsClientKey")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncIdentityProviderSpecIdentityProvidersKeystoneTlsClientKeyArgs>? TlsClientKey { get; set; }
        ...
        public SyncIdentityProviderSpecIdentityProvidersKeystoneArgs()
        {
        }
    }
}
