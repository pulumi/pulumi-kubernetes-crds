...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SelectorSyncIdentityProviderSpecIdentityProvidersLdapArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// attributes maps LDAP attributes to identities
        /// </summary>
        [Input("attributes")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersLdapAttributesArgs>? Attributes { get; set; }
        ...
        /// </summary>
        [Input("bindPassword")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersLdapBindPasswordArgs>? BindPassword { get; set; }
        ...
        /// </summary>
        [Input("ca")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersLdapCaArgs>? Ca { get; set; }
        ...
        public SelectorSyncIdentityProviderSpecIdentityProvidersLdapArgs()
        {
        }
    }
}
