...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class ClusterProvisionSpecPodSpecVolumesEphemeralVolumeClaimTemplateSpecResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public ClusterProvisionSpecPodSpecVolumesEphemeralVolumeClaimTemplateSpecResourcesArgs()
        {
        }
    }
}
