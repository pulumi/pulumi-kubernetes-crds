...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SelectorSyncIdentityProviderSpecIdentityProvidersGithubCaArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public SelectorSyncIdentityProviderSpecIdentityProvidersGithubCaArgs()
        {
        }
    }
}
