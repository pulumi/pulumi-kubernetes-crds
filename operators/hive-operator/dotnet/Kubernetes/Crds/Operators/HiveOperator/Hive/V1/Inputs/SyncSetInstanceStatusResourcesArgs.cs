...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SyncSetInstanceStatusResourcesArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncSetInstanceStatusResourcesConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncSetInstanceStatusResourcesConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SyncSetInstanceStatusResourcesConditionsArgs>());
        ...
        public SyncSetInstanceStatusResourcesArgs()
        {
        }
    }
}
