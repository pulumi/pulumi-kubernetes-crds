...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class ClusterPoolSpecPlatformGcpArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.ClusterPoolSpecPlatformGcpCredentialsSecretRefArgs> CredentialsSecretRef { get; set; } = null!;
        ...
        public ClusterPoolSpecPlatformGcpArgs()
        {
        }
    }
}
