...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SelectorSyncIdentityProviderSpecIdentityProvidersBasicAuthArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("ca")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersBasicAuthCaArgs>? Ca { get; set; }
        ...
        /// </summary>
        [Input("tlsClientCert")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersBasicAuthTlsClientCertArgs>? TlsClientCert { get; set; }
        ...
        /// </summary>
        [Input("tlsClientKey")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersBasicAuthTlsClientKeyArgs>? TlsClientKey { get; set; }
        ...
        public SelectorSyncIdentityProviderSpecIdentityProvidersBasicAuthArgs()
        {
        }
    }
}
