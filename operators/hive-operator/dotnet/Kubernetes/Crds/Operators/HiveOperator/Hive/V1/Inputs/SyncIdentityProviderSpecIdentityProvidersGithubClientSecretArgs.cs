...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SyncIdentityProviderSpecIdentityProvidersGithubClientSecretArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public SyncIdentityProviderSpecIdentityProvidersGithubClientSecretArgs()
        {
        }
    }
}
