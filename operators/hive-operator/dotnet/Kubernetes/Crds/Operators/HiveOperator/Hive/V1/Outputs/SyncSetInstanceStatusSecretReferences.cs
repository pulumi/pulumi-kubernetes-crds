...
namespace Pulumi.Kubernetes.Types.Outputs.Hive.V1
{
    ...
    [OutputType]
    public sealed class SyncSetInstanceStatusSecretReferences
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Hive.V1.SyncSetInstanceStatusSecretReferencesConditions> Conditions;
        /// <summary>
        ...
        [OutputConstructor]
        private SyncSetInstanceStatusSecretReferences(
            string apiVersion,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Hive.V1.SyncSetInstanceStatusSecretReferencesConditions> conditions,
