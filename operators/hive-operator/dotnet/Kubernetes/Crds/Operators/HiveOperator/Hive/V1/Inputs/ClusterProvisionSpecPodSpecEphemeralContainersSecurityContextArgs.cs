...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class ClusterProvisionSpecPodSpecEphemeralContainersSecurityContextArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capabilities")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.ClusterProvisionSpecPodSpecEphemeralContainersSecurityContextCapabilitiesArgs>? Capabilities { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.ClusterProvisionSpecPodSpecEphemeralContainersSecurityContextWindowsOptionsArgs>? WindowsOptions { get; set; }

        public ClusterProvisionSpecPodSpecEphemeralContainersSecurityContextArgs()
        {
        }
    }
}
