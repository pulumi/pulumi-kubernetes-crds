...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SelectorSyncIdentityProviderSpecIdentityProvidersGoogleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("clientSecret")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Hive.V1.SelectorSyncIdentityProviderSpecIdentityProvidersGoogleClientSecretArgs>? ClientSecret { get; set; }
        ...
        public SelectorSyncIdentityProviderSpecIdentityProvidersGoogleArgs()
        {
        }
    }
}
