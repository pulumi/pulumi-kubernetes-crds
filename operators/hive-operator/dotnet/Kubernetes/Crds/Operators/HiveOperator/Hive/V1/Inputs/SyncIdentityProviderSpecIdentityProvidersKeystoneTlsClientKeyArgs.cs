...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class SyncIdentityProviderSpecIdentityProvidersKeystoneTlsClientKeyArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public SyncIdentityProviderSpecIdentityProvidersKeystoneTlsClientKeyArgs()
        {
        }
    }
}
