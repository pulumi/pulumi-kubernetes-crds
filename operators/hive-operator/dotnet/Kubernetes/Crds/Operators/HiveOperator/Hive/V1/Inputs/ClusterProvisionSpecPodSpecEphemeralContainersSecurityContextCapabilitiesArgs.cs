...
namespace Pulumi.Kubernetes.Types.Inputs.Hive.V1
{
    ...
    /// </summary>
    public class ClusterProvisionSpecPodSpecEphemeralContainersSecurityContextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public ClusterProvisionSpecPodSpecEphemeralContainersSecurityContextCapabilitiesArgs()
        {
        }
    }
}
