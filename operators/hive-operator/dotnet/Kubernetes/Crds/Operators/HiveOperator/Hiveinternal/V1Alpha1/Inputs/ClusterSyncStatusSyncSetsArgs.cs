...
namespace Pulumi.Kubernetes.Types.Inputs.Hiveinternal.V1Alpha1
{
    ...
    /// </summary>
    public class ClusterSyncStatusSyncSetsArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Hiveinternal.V1Alpha1.ClusterSyncStatusSyncSetsResourcesToDeleteArgs>? _resourcesToDelete;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Hiveinternal.V1Alpha1.ClusterSyncStatusSyncSetsResourcesToDeleteArgs> ResourcesToDelete
        {
            get => _resourcesToDelete ?? (_resourcesToDelete = new InputList<Pulumi.Kubernetes.Types.Inputs.Hiveinternal.V1Alpha1.ClusterSyncStatusSyncSetsResourcesToDeleteArgs>());
        ...
        public ClusterSyncStatusSyncSetsArgs()
        {
        }
    }
}
