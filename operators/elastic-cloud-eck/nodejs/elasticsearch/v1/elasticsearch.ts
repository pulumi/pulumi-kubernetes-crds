...
export class Elasticsearch extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: ElasticsearchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            inputs["apiVersion"] = "elasticsearch.k8s.elastic.co/v1";
            inputs["kind"] = "Elasticsearch";
        ...
        super(Elasticsearch.__pulumiType, name, inputs, opts);
    }
}
...
export interface ElasticsearchArgs {
    readonly apiVersion?: pulumi.Input<"elasticsearch.k8s.elastic.co/v1">;
    readonly kind?: pulumi.Input<"Elasticsearch">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * ElasticsearchSpec holds the specification of an Elasticsearch cluster.
     */
    readonly spec?: pulumi.Input<inputs.elasticsearch.v1.ElasticsearchSpec>;
    /**
     * ElasticsearchStatus defines the observed state of Elasticsearch
     */
    readonly status?: pulumi.Input<inputs.elasticsearch.v1.ElasticsearchStatus>;
}
