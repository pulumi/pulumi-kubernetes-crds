...
class ApmServerSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secure_settings: Optional[Sequence['outputs.ApmServerSpecSecureSettings']] = None,
        ...
        :param int count: Count of APM Server instances to deploy.
        ...
        :param Sequence['ApmServerSpecSecureSettingsArgs'] secure_settings: SecureSettings is a list of references to Kubernetes secrets containing sensitive configuration options for APM Server.
    ...
    def secure_settings(self) -> Optional[Sequence['outputs.ApmServerSpecSecureSettings']]:
        """
...
class ApmServerSpecHttpServiceSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ports: Optional[Sequence['outputs.ApmServerSpecHttpServiceSpecPorts']] = None,
        ...
        :param Sequence['ApmServerSpecHttpServiceSpecPortsArgs'] ports: The list of ports that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies
    ...
    @property
    @pulumi.getter
    def ports(self) -> Optional[Sequence['outputs.ApmServerSpecHttpServiceSpecPorts']]:
        """
...
class ApmServerSpecHttpTlsSelfSignedCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subject_alt_names: Optional[Sequence['outputs.ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNames']] = None):
        """
        SelfSignedCertificate allows configuring the self-signed certificate generated by the operator.
        :param bool disabled: Disabled indicates that the provisioning of the self-signed certifcate should be disabled.
        :param Sequence['ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNamesArgs'] subject_alt_names: SubjectAlternativeNames is a list of SANs to include in the generated HTTP TLS certificate.
        """
    ...
    def subject_alt_names(self) -> Optional[Sequence['outputs.ApmServerSpecHttpTlsSelfSignedCertificateSubjectAltNames']]:
        """
...
class ApmServerSpecSecureSettings(dict):
    ...
    def __init__(__self__, *,
                 secret_name: str,
                 entries: Optional[Sequence['outputs.ApmServerSpecSecureSettingsEntries']] = None):
        """
        SecretSource defines a data source based on a Kubernetes Secret.
        :param str secret_name: SecretName is the name of the secret.
        :param Sequence['ApmServerSpecSecureSettingsEntriesArgs'] entries: Entries define how to project each key-value pair in the secret to filesystem paths. If not defined, all keys will be projected to similarly named paths in the filesystem. If defined, only the specified keys will be projected to the corresponding paths.
        """
        pulumi.set(__self__, "secret_name", secret_name)
    ...
    @property
    @pulumi.getter
    def entries(self) -> Optional[Sequence['outputs.ApmServerSpecSecureSettingsEntries']]:
        """
