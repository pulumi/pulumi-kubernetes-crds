...
__all__ = [
    ...
    'StorageClusterSpecSecurity',
    'StorageClusterSpecSecurityAuth',
    'StorageClusterSpecSecurityAuthSelfSigned',
...
class StorageClusterSpec(dict):
    ...
    def __init__(__self__, *,
                 auto_update_components: Optional[str] = None,
                 ...
                 security: Optional['outputs.StorageClusterSpecSecurity'] = None,
        ...
        """
        The desired behavior of the storage cluster.
        :param str auto_update_components: A strategy to determine how component versions are to be updated automatically.
        ...
        :param 'StorageClusterSpecSecurityArgs' security: Contains security configuration for the storage cluster.
    ...
    def auto_update_components(self) -> Optional[str]:
        """
    ...
    @property
    @pulumi.getter
    def security(self) -> Optional['outputs.StorageClusterSpecSecurity']:
        """
...
@pulumi.output_type
class StorageClusterSpecSecurity(dict):
    """
    Contains security configuration for the storage cluster.
    """
    def __init__(__self__, *,
                 auth: Optional['outputs.StorageClusterSpecSecurityAuth'] = None,
                 enabled: Optional[bool] = None):
        """
        Contains security configuration for the storage cluster.
        :param 'StorageClusterSpecSecurityAuthArgs' auth: Authorization configurations for a RBAC enabled storage cluster
        :param bool enabled: Flag indicating whether security features need to be enabled for the storage cluster.
        """
        if auth is not None:
    ...
    @property
    @pulumi.getter
    def auth(self) -> Optional['outputs.StorageClusterSpecSecurityAuth']:
        """
...
@pulumi.output_type
class StorageClusterSpecSecurityAuth(dict):
    """
    Authorization configurations for a RBAC enabled storage cluster
    """
    def __init__(__self__, *,
                 guest_access: Optional[str] = None,
                 self_signed: Optional['outputs.StorageClusterSpecSecurityAuthSelfSigned'] = None):
        """
        Authorization configurations for a RBAC enabled storage cluster
        :param str guest_access: Defines the access mode of a guest user
        :param 'StorageClusterSpecSecurityAuthSelfSignedArgs' self_signed: Configuration for self signed authentication
        """
    ...
    def guest_access(self) -> Optional[str]:
        """
    ...
    def self_signed(self) -> Optional['outputs.StorageClusterSpecSecurityAuthSelfSigned']:
        """
...
@pulumi.output_type
class StorageClusterSpecSecurityAuthSelfSigned(dict):
    """
    Configuration for self signed authentication
    """
    def __init__(__self__, *,
        ...
        """
        Configuration for self signed authentication
        :param str issuer: Token issuer for the tokens used to connect with storage cluster.
        :param str shared_secret: Shared secret is the name of the Kubernetes secret containing the shared key used for signing RBAC tokens. The secret has to be present in the StorageCluster namespace.
        :param str token_lifetime: Lifetime of auto-generated RBAC tokens to access the storage cluster.
        """
...
class StorageClusterSpecStork(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool host_network: Flag indicating if Stork pods should run in host network.
...
class StorageNodeStatus(dict):
    ...
    def __init__(__self__, *,
                 ...
                 phase: Optional[str] = None,
                 storage: Optional['outputs.StorageNodeStatusStorage'] = None):
        """
        Most recently observed status of the storage node. The data may not be up to date.
        ...
        :param 'StorageNodeStatusNetworkArgs' network: Contains network information used by the storage node
        ...
        :param 'StorageNodeStatusStorageArgs' storage: Contains details of the status of storage for the node
        """
        if conditions is not None:
            pulumi.set(__self__, "conditions", conditions)
    ...
    @property
    @pulumi.getter
    def storage(self) -> Optional['outputs.StorageNodeStatusStorage']:
        """
...
@pulumi.output_type
class StorageNodeStatusStorage(dict):
    """
    Contains details of the status of storage for the node
    """
    def __init__(__self__, *,
        ...
        """
        Contains details of the status of storage for the node
        :param str total_size: Cumulative total size of all storage pools on the node
        :param str used_size: Cumulative used size of all storage pools on the node
        """
    ...
    def used_size(self) -> Optional[str]:
        """
