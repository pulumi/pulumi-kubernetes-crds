...
func NewStorageCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:core.libopenstorage.org/v1:StorageCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageCluster(ctx *pulumi.Context,
	...
	var resource StorageCluster
	err := ctx.ReadResource("kubernetes:core.libopenstorage.org/v1:StorageCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
