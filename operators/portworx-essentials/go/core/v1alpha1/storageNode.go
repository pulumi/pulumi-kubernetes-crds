...
func NewStorageNode(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:core.libopenstorage.org/v1alpha1:StorageNode", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageNode(ctx *pulumi.Context,
	...
	var resource StorageNode
	err := ctx.ReadResource("kubernetes:core.libopenstorage.org/v1alpha1:StorageNode", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
