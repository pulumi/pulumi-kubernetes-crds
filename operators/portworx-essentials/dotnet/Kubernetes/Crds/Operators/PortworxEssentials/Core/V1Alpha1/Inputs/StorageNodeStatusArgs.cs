...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1
{
    ...
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageNodeStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Contains details for the current condition of this storage node.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageNodeStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageNodeStatusConditionsArgs>());
        ...
        /// </summary>
        [Input("geography")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageNodeStatusGeographyArgs>? Geography { get; set; }

        [Input("network")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageNodeStatusNetworkArgs>? Network { get; set; }
