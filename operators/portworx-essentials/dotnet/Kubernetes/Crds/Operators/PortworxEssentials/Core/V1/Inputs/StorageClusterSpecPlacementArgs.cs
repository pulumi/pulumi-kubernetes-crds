...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1
{
    ...
    public class StorageClusterSpecPlacementArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("nodeAffinity")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1.StorageClusterSpecPlacementNodeAffinityArgs>? NodeAffinity { get; set; }

        [Input("tolerations")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.StorageClusterSpecPlacementTolerationsArgs>? _tolerations;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.StorageClusterSpecPlacementTolerationsArgs> Tolerations
        {
            get => _tolerations ?? (_tolerations = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.StorageClusterSpecPlacementTolerationsArgs>());
