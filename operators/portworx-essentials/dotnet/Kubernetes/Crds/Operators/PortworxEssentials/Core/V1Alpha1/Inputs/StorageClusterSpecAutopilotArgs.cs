...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1
{
    ...
    public class StorageClusterSpecAutopilotArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("env")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecAutopilotEnvArgs>? _env;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecAutopilotEnvArgs> Env
        {
            get => _env ?? (_env = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecAutopilotEnvArgs>());
            set => _env = value;
        }
        ...
        [Input("providers")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecAutopilotProvidersArgs>? _providers;

        /// <summary>
        /// List of input data providers to autopilot.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecAutopilotProvidersArgs> Providers
        {
            get => _providers ?? (_providers = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecAutopilotProvidersArgs>());
