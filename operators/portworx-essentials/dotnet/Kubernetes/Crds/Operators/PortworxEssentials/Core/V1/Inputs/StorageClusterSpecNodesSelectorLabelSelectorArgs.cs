...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1
{
    ...
    public class StorageClusterSpecNodesSelectorLabelSelectorArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.StorageClusterSpecNodesSelectorLabelSelectorMatchExpressionsArgs>? _matchExpressions;

        /// <summary>
        /// It is a list of label selector requirements. The requirements are ANDed.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.StorageClusterSpecNodesSelectorLabelSelectorMatchExpressionsArgs> MatchExpressions
        {
            get => _matchExpressions ?? (_matchExpressions = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.StorageClusterSpecNodesSelectorLabelSelectorMatchExpressionsArgs>());
