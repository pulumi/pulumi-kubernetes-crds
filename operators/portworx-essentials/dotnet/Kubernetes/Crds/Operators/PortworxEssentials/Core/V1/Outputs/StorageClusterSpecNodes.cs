...
namespace Pulumi.Kubernetes.Types.Outputs.Core.V1
{
    ...
    public sealed class StorageClusterSpecNodes
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecNodesEnv> Env;
        /// <summary>
        /// Contains network information that is needed by the storage driver.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecNodesNetwork Network;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecNodesSelector Selector;
        /// <summary>
        /// Details of the storage used by the storage driver.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecNodesStorage Storage;

        [OutputConstructor]
        private StorageClusterSpecNodes(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecNodesEnv> env,

            Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecNodesNetwork network,

            ImmutableDictionary<string, object> runtimeOptions,

            Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecNodesSelector selector,

            Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecNodesStorage storage)
        {
            Env = env;
            Network = network;
