...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1
{
    ...
    public class StorageClusterSpecArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autopilot")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecAutopilotArgs>? Autopilot { get; set; }

        /// <summary>
        /// Details of storage used in cloud environment.
        /// </summary>
        [Input("cloudStorage")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecCloudStorageArgs>? CloudStorage { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecDeleteStrategyArgs>? DeleteStrategy { get; set; }

        [Input("env")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecEnvArgs>? _env;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecEnvArgs> Env
        {
            get => _env ?? (_env = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecEnvArgs>());
            set => _env = value;
        }
        ...
        /// </summary>
        [Input("kvdb")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecKvdbArgs>? Kvdb { get; set; }

        /// <summary>
        /// Contains monitoring configuration for the storage cluster.
        /// </summary>
        [Input("monitoring")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecMonitoringArgs>? Monitoring { get; set; }

        /// <summary>
        /// Contains network information that is needed by the storage driver.
        /// </summary>
        [Input("network")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecNetworkArgs>? Network { get; set; }

        [Input("nodes")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecNodesArgs>? _nodes;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecNodesArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecNodesArgs>());
            set => _nodes = value;
        }
        ...
        /// </summary>
        [Input("placement")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecPlacementArgs>? Placement { get; set; }
        ...
        /// </summary>
        [Input("storage")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecStorageArgs>? Storage { get; set; }

        /// <summary>
        /// Contains STORK related spec.
        /// </summary>
        [Input("stork")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecStorkArgs>? Stork { get; set; }

        /// <summary>
        /// An update strategy to replace existing StorageCluster pods with new pods.
        /// </summary>
        [Input("updateStrategy")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecUpdateStrategyArgs>? UpdateStrategy { get; set; }

        /// <summary>
        /// Contains spec of a user interface for the storage driver.
        /// </summary>
        [Input("userInterface")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecUserInterfaceArgs>? UserInterface { get; set; }
