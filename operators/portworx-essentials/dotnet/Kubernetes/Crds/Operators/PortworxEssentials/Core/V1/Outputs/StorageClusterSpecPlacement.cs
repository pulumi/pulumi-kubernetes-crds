...
namespace Pulumi.Kubernetes.Types.Outputs.Core.V1
{
    ...
    public sealed class StorageClusterSpecPlacement
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecPlacementNodeAffinity NodeAffinity;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecPlacementTolerations> Tolerations;

        [OutputConstructor]
        private StorageClusterSpecPlacement(
            Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecPlacementNodeAffinity nodeAffinity,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Core.V1.StorageClusterSpecPlacementTolerations> tolerations)
        {
