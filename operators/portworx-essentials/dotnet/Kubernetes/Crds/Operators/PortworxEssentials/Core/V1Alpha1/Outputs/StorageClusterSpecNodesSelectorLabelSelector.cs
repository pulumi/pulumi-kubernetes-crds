...
namespace Pulumi.Kubernetes.Types.Outputs.Core.V1Alpha1
{
    ...
    public sealed class StorageClusterSpecNodesSelectorLabelSelector
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Core.V1Alpha1.StorageClusterSpecNodesSelectorLabelSelectorMatchExpressions> MatchExpressions;
        /// <summary>
        ...
        private StorageClusterSpecNodesSelectorLabelSelector(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Core.V1Alpha1.StorageClusterSpecNodesSelectorLabelSelectorMatchExpressions> matchExpressions,
