...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1
{
    ...
    public class StorageClusterSpecUserInterfaceArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("env")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.StorageClusterSpecUserInterfaceEnvArgs>? _env;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.StorageClusterSpecUserInterfaceEnvArgs> Env
        {
            get => _env ?? (_env = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.StorageClusterSpecUserInterfaceEnvArgs>());
            set => _env = value;
        }
