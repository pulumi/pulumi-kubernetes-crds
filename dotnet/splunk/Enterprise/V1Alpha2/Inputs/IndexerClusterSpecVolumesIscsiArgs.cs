...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class IndexerClusterSpecVolumesIscsiArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecVolumesIscsiSecretRefArgs>? SecretRef { get; set; }
        ...
        public IndexerClusterSpecVolumesIscsiArgs()
        {
        }
    }
}
