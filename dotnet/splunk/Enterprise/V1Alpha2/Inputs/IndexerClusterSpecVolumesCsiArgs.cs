...
namespace Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2
{
    ...
    /// </summary>
    public class IndexerClusterSpecVolumesCsiArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Enterprise.V1Alpha2.IndexerClusterSpecVolumesCsiNodePublishSecretRefArgs>? NodePublishSecretRef { get; set; }
        ...
        public IndexerClusterSpecVolumesCsiArgs()
        {
        }
    }
}
