...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1
{
    ...
    {
        [Input("env")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecNodesEnvArgs>? _env;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecNodesEnvArgs> Env
        {
            get => _env ?? (_env = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecNodesEnvArgs>());
            set => _env = value;
        }
        ...
        /// </summary>
        [Input("network")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecNodesNetworkArgs>? Network { get; set; }
        ...
        /// </summary>
        [Input("selector")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecNodesSelectorArgs>? Selector { get; set; }

        /// <summary>
        /// Details of the storage used by the storage driver.
        /// </summary>
        [Input("storage")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1Alpha1.StorageClusterSpecNodesStorageArgs>? Storage { get; set; }
