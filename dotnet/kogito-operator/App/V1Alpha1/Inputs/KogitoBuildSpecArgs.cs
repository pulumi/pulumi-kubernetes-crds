...
namespace Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1
{
    ...
    public class KogitoBuildSpecArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("artifact")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecArtifactArgs>? Artifact { get; set; }
        ...
        /// </summary>
        [Input("buildImage")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecBuildImageArgs>? BuildImage { get; set; }
        ...
        [Input("envs")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecEnvsArgs>? _envs;

        /// <summary>
        /// Environment variables used during build time.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecEnvsArgs> Envs
        {
            get => _envs ?? (_envs = new InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecEnvsArgs>());
            set => _envs = value;
        }
        ...
        /// </summary>
        [Input("gitSource")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecGitSourceArgs>? GitSource { get; set; }
        ...
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecResourcesArgs>? Resources { get; set; }
        ...
        /// </summary>
        [Input("runtimeImage")]
        public Input<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecRuntimeImageArgs>? RuntimeImage { get; set; }
        ...
        [Input("webHooks")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecWebHooksArgs>? _webHooks;

        /// <summary>
        /// WebHooks secrets for source to image builds based on Git repositories (Remote Sources).
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecWebHooksArgs> WebHooks
        {
            get => _webHooks ?? (_webHooks = new InputList<Pulumi.Kubernetes.Types.Inputs.App.V1Alpha1.KogitoBuildSpecWebHooksArgs>());
            set => _webHooks = value;
        }
