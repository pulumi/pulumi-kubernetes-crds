...
namespace Pulumi.Kubernetes.Types.Inputs.Camel.V1
{
    ...
    /// </summary>
    public class BuildSpecTasksImageVolumesRbdArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Camel.V1.BuildSpecTasksImageVolumesRbdSecretRefArgs>? SecretRef { get; set; }
        ...
        public BuildSpecTasksImageVolumesRbdArgs()
        {
        }
    }
}
