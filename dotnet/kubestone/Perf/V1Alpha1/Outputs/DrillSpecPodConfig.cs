...
namespace Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1
{
    ...
    [OutputType]
    public sealed class DrillSpecPodConfig
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.DrillSpecPodConfigPodScheduling PodScheduling;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.DrillSpecPodConfigResources Resources;

        [OutputConstructor]
        private DrillSpecPodConfig(
            ImmutableDictionary<string, string> podLabels,

            Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.DrillSpecPodConfigPodScheduling podScheduling,

            Pulumi.Kubernetes.Types.Outputs.Perf.V1Alpha1.DrillSpecPodConfigResources resources)
        {
            PodLabels = podLabels;
