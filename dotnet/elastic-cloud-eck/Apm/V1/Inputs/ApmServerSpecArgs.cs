...
namespace Pulumi.Kubernetes.Types.Inputs.Apm.V1
{
    ...
    public class ApmServerSpecArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Apm.V1.ApmServerSpecElasticsearchRefArgs>? ElasticsearchRef { get; set; }

        /// <summary>
        /// HTTP holds the HTTP layer configuration for the APM Server resource.
        /// </summary>
        [Input("http")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Apm.V1.ApmServerSpecHttpArgs>? Http { get; set; }
        ...
        /// </summary>
        [Input("kibanaRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Apm.V1.ApmServerSpecKibanaRefArgs>? KibanaRef { get; set; }
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Apm.V1.ApmServerSpecSecureSettingsArgs>? _secureSettings;

        /// <summary>
        /// SecureSettings is a list of references to Kubernetes secrets containing sensitive configuration options for APM Server.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Apm.V1.ApmServerSpecSecureSettingsArgs> SecureSettings
        {
            get => _secureSettings ?? (_secureSettings = new InputList<Pulumi.Kubernetes.Types.Inputs.Apm.V1.ApmServerSpecSecureSettingsArgs>());
