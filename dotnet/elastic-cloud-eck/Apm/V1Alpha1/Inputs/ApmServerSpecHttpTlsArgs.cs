...
namespace Pulumi.Kubernetes.Types.Inputs.Apm.V1Alpha1
{
    ...
    public class ApmServerSpecHttpTlsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("certificate")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Apm.V1Alpha1.ApmServerSpecHttpTlsCertificateArgs>? Certificate { get; set; }

        /// <summary>
        /// SelfSignedCertificate allows configuring the self-signed certificate generated by the operator.
        /// </summary>
        [Input("selfSignedCertificate")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Apm.V1Alpha1.ApmServerSpecHttpTlsSelfSignedCertificateArgs>? SelfSignedCertificate { get; set; }
