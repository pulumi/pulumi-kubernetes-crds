...
namespace Pulumi.Kubernetes.Types.Outputs.Apm.V1Alpha1
{
    ...
    public sealed class ApmServerSpec
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Apm.V1Alpha1.ApmServerSpecElasticsearchRef ElasticsearchRef;
        /// <summary>
        /// HTTP holds the HTTP layer configuration for the APM Server resource.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Apm.V1Alpha1.ApmServerSpecHttp Http;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Apm.V1Alpha1.ApmServerSpecKibanaRef KibanaRef;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Apm.V1Alpha1.ApmServerSpecSecureSettings> SecureSettings;
        /// <summary>
        ...
        private ApmServerSpec(
            ...
            Pulumi.Kubernetes.Types.Outputs.Apm.V1Alpha1.ApmServerSpecElasticsearchRef elasticsearchRef,

            Pulumi.Kubernetes.Types.Outputs.Apm.V1Alpha1.ApmServerSpecHttp http,

            string image,

            Pulumi.Kubernetes.Types.Outputs.Apm.V1Alpha1.ApmServerSpecKibanaRef kibanaRef,

            ImmutableDictionary<string, object> podTemplate,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Apm.V1Alpha1.ApmServerSpecSecureSettings> secureSettings,
